    ...
    public function homework_docs($id)
    {
        ...
        if (!empty($docs->data)) {
            ...
            foreach ($docs->data as $key => $value) {
                ...
                if (!empty($value->docs)) {
                    $doc = '<a class="btn btn-default btn-xs" href="' . base_url() . 'homework/assigmnetDownload/' . $value->docs . '"   data-bs-toggle="tooltip" data-original-title=' . $this->lang->line("download") . '>
