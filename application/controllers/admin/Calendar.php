...
class Calendar extends Admin_Controller
{
    ...
    public function saveevent()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $start_date = date('Y-m-d H:i:s', $this->customlib->dateTimeformatTwentyfourhour($this->input->post("event_from") ." ".$this->input->post("start_time")));
            $end_date = date('Y-m-d H:i:s', $this->customlib->dateTimeformatTwentyfourhour($this->input->post("event_to") ." ".$this->input->post("end_time")));
