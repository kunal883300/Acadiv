...
class Reference extends Admin_Controller
{
    ...
    public function delete($id)
    {
        ...
        $this->session->set_flashdata('msg', '<div class="alert alert-delete alert-icon alert-dismissible"><em class="icon ni ni-check-circle"></em>  '.$this->lang->line('delete_message').'<button class="close" data-bs-dismiss="alert"></button></div>');
