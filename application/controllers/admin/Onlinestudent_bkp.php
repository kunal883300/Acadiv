    ...
    public function edit($id)
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            if ($response) {
                ...
                $this->session->set_flashdata('msg', '<div class="alert alert-success text-left alert-icon alert-dismissible"><em class="icon ni ni-check-circle"></em>' . $this->lang->line('please_check_student_admission_no') . '</div>');
