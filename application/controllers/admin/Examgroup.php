        ...
        if (isset($rows) && !empty($rows)) {
            foreach ($rows as $row_key => $row_value) {
                if (trim($this->input->post('subject_' . $row_value))    == "" ||
                    ...
                    trim($this->input->post('subject_type' . $row_value))  == "" ||
                ...
                if ($update_id == 0) {
                    ...
                    if ($this->input->post('exam_group_class_batch_exam_id') != "" && $this->input->post('subject_' . $row_value) != "" && $this->input->post('date_from_' . $row_value) != "" && $this->input->post('time_from' . $row_value) != "" && $this->input->post('subject_type' . $row_value) != "" && $this->input->post('duration' . $row_value) != "" && $this->input->post('max_marks_' . $row_value) != "" && $this->input->post('min_marks_' . $row_value) != "") {
                        ...
                        $insert_array[] = array(
                            ...
                            'subject_type'                      => $this->input->post('subject_type' . $row_value),
        ...
        if (!empty($students)) {
            ...
            foreach ($students as $student_key => $student_value) {
                $update_array = array(
                    ...
                    'work_ex' => $this->input->post('work_' . $student_value),
                    'physical' => $this->input->post('physical_' . $student_value),
                    'attendance' => $this->input->post('attendance_' . $student_value),
                );
