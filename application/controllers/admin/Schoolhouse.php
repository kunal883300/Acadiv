...
class Schoolhouse extends Admin_Controller
{
    ...
    public function create()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->session->set_flashdata('msg', '<div class="alert alert-success alert-icon alert-dismissible"><em class="icon ni ni-check-circle"></em>  '.$this->lang->line('success_message').'<button class="close" data-bs-dismiss="alert"></button></div>');            redirect('admin/schoolhouse/index');
        }
    }
    ...
    public function delete($id)
    {
        ...
        if (!empty($id)) {
            ...
            $this->session->set_flashdata('msg', '<div class="alert alert-success alert-icon alert-dismissible"><em class="icon ni ni-check-circle"></em>  '.$this->lang->line('delete_message').'<button class="close" data-bs-dismiss="alert"></button></div>');
        }
        redirect('admin/schoolhouse/');
    }
