        ...
        if (!empty($this->input->post('submitbtn'))) {
            ...
            if ($this->input->post('online_admission_payment') == 'yes') {
                ...
                if ($this->form_validation->run() == true) {
                    ...
                    $this->session->set_flashdata('msg', '<div class="alert alert-success text-left alert-icon alert-dismissible"><em class="icon ni ni-check-circle"></em>'. $this->lang->line('record_updated_successfully') . '<button class="close" data-bs-dismiss="alert"></button></div>');
