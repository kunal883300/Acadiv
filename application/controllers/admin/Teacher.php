...
class Teacher extends Admin_Controller
{
    ...
    public function viewassignteacher()
    {
        ...
        if ($this->input->server('REQUEST_METHOD') == "POST") {
            ...
            $class_section_id = $dt['id'];
            $this->teachersubject_model->deleteBatch($ids, $class_section_id);
            $this->session->set_flashdata('msg', '<div class="alert alert-success">' . $this->lang->line('success_message') . '<button class="close" data-bs-dismiss="alert"></button></div>');
            redirect('admin/teacher/assignteacher');
        }
    }
    ...
    public function edit($id)
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->session->set_flashdata('msg', '<div class="alert alert-success text-center">' . $this->lang->line('success_message') . '<button class="close" data-bs-dismiss="alert"></button></div>');
            redirect('admin/teacher/index');
        }
    }
    ...
    public function update_class_teacher($class_id, $section_id)
    {
        ...
        if ($this->form_validation->run() == false) {
			...
			$this->session->set_flashdata('msg', '<div class="alert alert-success text-left alert-icon alert-dismissible"><em class="icon ni ni-check-circle"></em>' . $this->lang->line('update_message') . '<button class="close" data-bs-dismiss="alert"></button></div>');
            redirect('admin/teacher/assign_class_teacher');
        }
    ...
    public function classteacherdelete($class_id, $section_id)
    {
        if ((!empty($class_id)) && (!empty($section_id))) {
			...
			$this->session->set_flashdata('msg', '<div class="alert alert-success text-left alert-icon alert-dismissible"><em class="icon ni ni-check-circle"></em>' . $this->lang->line('delete_message') . '<button class="close" data-bs-dismiss="alert"></button></div>');
            redirect("admin/teacher/assign_class_teacher");
        }
    }
