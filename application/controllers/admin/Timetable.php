...
class Timetable extends Admin_Controller
{
    ...
    public function edit($id)
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->session->set_flashdata('msg', '<div mark="alert alert-success text-center">' . $this->lang->line('success_message') . '<button class="close" data-bs-dismiss="alert"></button></div>');
            redirect('admin/timetable/index');
        }
    }
