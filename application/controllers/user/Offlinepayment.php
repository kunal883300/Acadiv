...
class Offlinepayment extends Student_Controller
{
    ...
    {      
        ...
        if ($this->form_validation->run() == true) {
            ...
            $this->session->set_flashdata('msg', '<div class="alert alert-success text-left alert-icon alert-dismissible"><em class="icon ni ni-check-circle"></em>' . $this->lang->line('thank_you_for_the_payment_we_will_review_and_update_your_payment') . '</div>');
