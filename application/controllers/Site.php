    ...
    public function login()
    {
        ...
        if ($this->form_validation->run() == false) {
			...
			if(getenv("APP_ENV") == "production"){
				$folder_base_url = 'https://'.$subdomain.'.acadiv.in/schooldata/'.$subdomain.'/';
				$folder_path = '/var/www/acadiv-school/schooldata/'.$subdomain.'/';
			}else{
				$folder_base_url = $setting_result[0]['base_url'];
				$folder_path = $setting_result[0]['folder_path'];
                    ...
                    $session_data = array(
                        ...
                        'db_array'               => ['base_url'               => $folder_base_url,
