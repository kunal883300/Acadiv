    ...
    public function getcourselist()
    {
        ...
        if (!empty($m->data)) {
            foreach ($m->data as $key => $value) {
                ...
                $course_detail = '';
                if ($this->rbac->hasPrivilege('online_course', 'can_view')) {
                    $course_detail = "<button type='button' onclick='loadcoursedetail(" . '"' . $value->id . '"' . "  )' class='btn btn-default btn-xs btn-add ' data-id=" . $value->id . " data-placement='top' data-bs-toggle='modal' data-bs-target='#course_detail_modal' title=" . $this->lang->line('manage_course') . "><em class='icon ni ni-edit'></em></button>";
                }
