        ...
        if (!empty($students->data)) {
            foreach ($students->data as $student_key => $student) {
                if($this->rbac->hasPrivilege('behaviour_records_assign_incident', 'can_add')){
                    $viewbtn = "<a href='#' data-placement='left' data-student-id=".$student->id."  data-bs-backdrop='static' class='btn btn-default btn-xs assignstudent'  data-bs-toggle='modal' title='".$this->lang->line('assign_incident')."'><i class='fa fa-plus'></i></a>";
                }
                if($this->rbac->hasPrivilege('behaviour_records_assign_incident', 'can_view')){
                    $assignedview = "<a href='#' data-placement='left' data-student-id=".$student->id." data-bs-toggle='modal' data-backdrop='static' class='btn btn-default btn-xs viewassignedincidents'  data-bs-toggle='tooltip' title='".$this->lang->line('view_assigned_incidents')."'><i class='fa fa-reorder'></i></a>";
                }
