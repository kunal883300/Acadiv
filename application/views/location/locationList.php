...
{    
    .no-print, .no-print *
    {
        ...
        <div class="row">
            <?php
            if ($this->rbac->hasPrivilege('location', 'can_add')) {
                ?>
                <div class="col-md-4">
                <div class="card card-bordered h-90 " >
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h5 class="box-title"><?php echo $this->lang->line('add_location'); ?></h5>
                            <hr>
                        </div> 
                        <form action="<?php echo site_url('locations/index') ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    <label for="exampleInputEmail1"><?php echo $this->lang->line('location_name'); ?> </label><small class="text-danger"> *</small>
                                    <input autofocus="" id="location" name="location" placeholder="" type="text" class="form-control"  value="<?php echo set_value('location'); ?>" />
