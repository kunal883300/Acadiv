            ...
            <div class="col-md-12">
                <div class="box removeboxmius">
                    ...
                    <div class="box-header with-border">
                        <h3 class="box-title"><i class=""></i> <?php echo $this->lang->line('student_course_purchase_report'); ?></h3>
                    </div>
                    <form id="form1" action="<?php echo base_url(); ?>onlinecourse/checkvalidation"  method="post">
                        ...
                        <?php echo $this->customlib->getCSRF(); ?>
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                       <label><?php echo $this->lang->line('payment_type'); ?><small class="text-danger"> *</small></label>
