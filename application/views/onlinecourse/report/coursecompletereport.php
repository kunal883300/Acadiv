...
<div class="nk-content">
    <div class="container-fluid">
        ...
        <!-- left column -->
            <div class="col-md-12">
                <div class="box removeboxmius">
                    ...
                    <div class="box-header with-border">
                        <h5 class="box-title"><i class="fa fa-search"></i> <?php echo $this->lang->line('course_complete_report'); ?></h5>
                        <hr>
                    </div>
                    ...
                    <form id="form1" action="<?php echo base_url(); ?>onlinecourse/coursereport/validation"  method="post">
                        ...
                        <?php echo $this->customlib->getCSRF(); ?>
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                       <label><?php echo $this->lang->line('users_type'); ?></label><small class="text-danger"> *</small>
                            ...
                            <div id="show_class_section" style="display: none;">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label><?php echo $this->lang->line('course'); ?></label><small class="text-danger"> *</small>
            ...
            <div class="box-body my-3 mx-3">
                <div class="row">
                    <div class="download_label"><?php echo $this->lang->line('course_complete_report'); ?> </div>
                        <table class="table  table-hover all-list" cellspacing="0" data-export-title="<?php echo $this->lang->line('course_complete_report'); ?>">
                            <thead>
                                <tr>
