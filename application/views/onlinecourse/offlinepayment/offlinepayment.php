			...
			<div class="col-md-12">
				<div class="box box-primary">
					<div class="box-header with-border">
						<h5 class="box-title"><?php echo $this->lang->line('offline_payment'); ?></h5>
                        <hr>
					</div>
					...
					<form id="form1" action="<?php echo base_url(); ?>onlinecourse/offlinepayment/search"  method="post">
						...
						<?php echo $this->customlib->getCSRF(); ?>
							<div class="row">
								...
								<div class="form-group">
									<div class="col-sm-12">
										<button type="submit" name="search" value="search_filter" class="btn btn-primary btn-sm pull-right my-2"><i class="fa fa-search"></i> <?php echo $this->lang->line('search'); ?></button>
									</div>
								</div>							
							</div>
						</div> 
            ...
            <div class="box-body">
                <div class="row">
                        <div class="table-responsive">
    						<table class=" nowrap table all-list table-col-nth" cellspacing="0" data-export-title="">
