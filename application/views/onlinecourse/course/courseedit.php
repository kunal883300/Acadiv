    ...
    foreach ($outcomes as $key => $outcomevalue) {
        ?>
                    ...
                    <?php $i++;}} else {?>
                        ...
                        <div class="form-group">
                        <label><?php echo $this->lang->line('description'); ?></label><small class="text-danger"> *</small>
...
if (!empty($allTeacherList)) {
    ...
    ?>
			...
			<?php if ($roleid == 7) { ?>
			<div class="form-group">
                    <label><?php echo $this->lang->line('created_by'); ?><small class="text-danger"> *</small></label>
    ...
    foreach ($course_provider as $key => $course_provider_value) {?>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        <label><?php echo $this->lang->line('price'); ?> (<?php echo $currency_symbol; ?>)</label><small class="text-danger"> *</small>
