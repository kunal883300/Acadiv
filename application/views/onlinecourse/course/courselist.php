		...
		<div class="nk-content-inner">
			<div class="nk-content-body">
				<div class="card card-bordered">
					<div class="card-inner p-2 pt-0">
						<div class="nk-block-head">
							<div class="nk-block-between">
								<div class="nk-block-head-content">
									<h4 class="nk-block-title"><em class="icon ni ni-user-add"></em><span><?php echo $this->lang->line('course_list'); ?></span></h4>
								</div>
								<div class="pull-right">
									<ul class="nav nav-tabs">
										<li class="nav-item">
											<a class="nav-link active" data-bs-toggle="tab" href="#tab_2"><em class="icon ni ni-grid-box-fill"></em><span><?php echo $this->lang->line('card_view'); ?></span></a>
										</li>
										<li class="nav-item">
											<a class="nav-link" data-bs-toggle="tab" href="#tab_1"><em class="icon ni ni-lock-alt"></em><span><?php echo $this->lang->line('list_view'); ?></span></a>
										</li>
										<?php if($this->rbac->hasPrivilege('online_course', 'can_add')) { ?> 
										<li><button type="button" data-placement="bottom" class="btn btn-sm btn-primary mt-2 add_course_modal"><em class="icon ni ni-plus-round"></em> <span><?php echo $this->lang->line('add_course'); ?></span></button></li>
										<?php } ?>
									</ul>
						...
						<div class="tab-content">
							<div class="tab-pane" id="tab_1">
								...
								<table class="nowrap table course-list course-table" style="width:100%;" data-export-title="<?php echo $this->lang->line('course_list'); ?>">
									<thead>
										<tr>
										...
										<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
											<div class="coursebox">
												...
												<div class="coursebtn">
													...
													<a href="#" class="btn btn-sm btn-add course_detail_id" data-id="<?php echo $new_courselist_value['id']; ?>" data-bs-backdrop="static" data-bs-keyboard="false" data-bs-toggle="modal" data-bs-target="#course_detail_modal"><?php echo $this->lang->line('manage_course'); ?></a>
													<?php } ?>					 
													<a href="#" class="btn btn-sm btn-buygreen course_preview_id pull-right" data-id="<?php echo $new_courselist_value['id']; ?>" data-bs-backdrop="static" data-bs-keyboard="false" data-bs-toggle="modal" data-bs-target="#course_preview_modal"><?php echo $this->lang->line('course_preview'); ?></a>
												</div>
											</div>
										</div>
										<!--./col-lg-3-->
...
<div class="modal" id="course_detail_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	<div class="modal-dialog modal-xl course_modal p-1" role="document">
...
<div class="modal fade zoom lg" id="add_course_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	<div class="modal-dialog modal-xl course_modal" role="document">
		<div class="modal-content modal-media-content">
			<div class="modal-header modal-media-header p5 ">
						...
						<div class="row">
							<div class="col-lg-7 col-md-7 col-sm-7 ">
								<div class="form-group">
									<label><?php echo $this->lang->line('title'); ?><small class="text-danger"> *</small></label>
								...
								<div class="form-group">
									<label><?php echo $this->lang->line('description'); ?><small class="text-danger"> *</small></label>
							...
							<div class="col-lg-4 col-md-4 col-sm-4">
								<div class="form-group">
									<label><?php echo $this->lang->line('inline_preview_image'); ?> (700px X 400px) <small class="text-danger"> *</small></label>
								...
								<?php
									...
									if ($roleid != "2") {
									    ...
									    ?>
								<div class="form-group">
									<label><?php echo $this->lang->line('assign_teacher'); ?><small class="text-danger"> *</small></label>
								...
								<div class="row">
									<div class="col-md-4">
										<div class="form-group">
											<label><?php echo $this->lang->line('price'); ?> (<?php echo $currency_symbol; ?>)<small class="text-danger"> *</small></label>
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											<label><?php echo $this->lang->line('course_category'); ?><small class="text-danger"> *</small></label>
...
<div class="modal " id="edit_course_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
...
<div class="modal " id="add_section_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
					...
					<div class="row">
						<div class="col-lg-12 col-md-12 col-sm-12">
							...
							<div class="row">
								<div class="col-sm-12">
									<div class="form-group">
										<label for="pwd"><?php echo $this->lang->line('title'); ?></label><small class="text-danger"> *</small>
...
<div class="modal " id="order_section_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content modal-media-content">
			<div class="modal-header modal-media-header">
...
<div class="modal " id="edit_section_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content modal-media-content">
			<div class="modal-header modal-media-header">
				<button type="button" class="close" data-dismiss="modal">&times;</button>
...
<div class="modal " id="add_lesson_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content modal-media-content">
			<div class="modal-header modal-media-header">
				<button type="button" class="close" data-dismiss="modal">&times;</button>
						...
						<div class="row">
							<div class="col-lg-12 col-md-12 col-sm-12">
								...
								<div class="row">
									...
									<div class="col-sm-12">
										<div class="form-group">
											<label for="pwd"><?php echo $this->lang->line('lesson_type'); ?></label><small class="text-danger"> *</small>
											...
											<div id="video_detail" class="displaynone">
												<br>
												<div class="form-group">
												...
												<div class="form-group" id="lesson_url_div">
													<label><?php echo $this->lang->line('video_url'); ?></label><small class="text-danger"> *</small>
												...
												<div class="form-group relative">
													<label><?php echo $this->lang->line('duration'); ?></label><small class="text-danger"> *</small>
									...
									<div class="col-sm-12">
										<div class="form-group">
											<label for="pwd"><?php echo $this->lang->line('inline_preview_image'); ?> (700px X 400px)</label><small class="text-danger"> *</small>
...
<div class="modal " id="edit_lesson_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content modal-media-content">
			<div class="modal-header modal-media-header">
				<button type="button" class="close" data-dismiss="modal">&times;</button>
...
<div class="modal" id="add_quiz_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content modal-media-content">
			<div class="modal-header modal-media-header">
				<button type="button" class="close" data-dismiss="modal">&times;</button>
					...
					<div class="row">
						<div class="col-lg-12 col-md-12 col-sm-12">
							...
							<div class="row">
								<div class="col-sm-12">
									<div class="form-group">
										<label for="pwd"><?php echo $this->lang->line('quiz_title'); ?></label><small class="text-danger"> *</small>
...
<div class="modal " id="edit_quiz_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content modal-media-content">
			<div class="modal-header modal-media-header">
				<button type="button" class="close" data-dismiss="modal">&times;</button>
...
<div class="modal " id="question_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content modal-media-content">
			<div class="modal-header modal-media-header">
						...
						<div class="col-lg-12 col-md-12 col-sm-12">
							<form id="add_new_question_form_ID" method="post">
								...
								<table id="table_id" class="table tableinput">
									<tbody>
										<tr id="rowID0">
											<td class="border0 pl0" width="75"><?php echo $this->lang->line('question'); ?><small class="text-danger"> *</small></td>
											...
											<td colspan="2" class="border0">
												<div class="quizopationpad-left">
													<table width="100%" align="right">
														<tr>
															<td width="30">A <small class="text-danger"> *</small></td>
															<td>
														...
														<tr>
															<td>B <small class="text-danger"> *</small></td>
															<td>
																<div class="input-group input-group-full-width">
...
<div class="modal " id="edit_question_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content modal-media-content">
			<div class="modal-header modal-media-header">
				<div class="quizplusrighttop">
...
<div id="course_preview_modal" class="modal " role="dialog">
	<div class="modal-dialog modalwrapwidth modal-xl">
...
<script>
	...
	$(".add_course_modal").click(function () {
...
<script>
	...
	function add_outcomerow()
	{
	  ...
	  var div = "<td><div class='form-group my-2'><input type='text' name='outcomes[]' class='form-control'></div></td>";
	  var row = table.insertRow(table_len).outerHTML = "<tr id='outcomerow" + id + "'>" + div + "<td valign='top'><button type='button' onclick='delete_outcomerow(" + id + ")' class='addclose my-2'><i class='fa fa-remove'></i></button></td></tr>";
	}
