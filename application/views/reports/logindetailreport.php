                                    ...
                                    <div class="box removeboxmius">
                                        ...
                                        <div class="">
                                            <div class="box-header ptbnull">
                                                <h5 class="box-title titlefix"><i class=""></i> <?php echo $this->lang->line('student_login_credential_report'); ?></h5>
                                                <hr>
                                            </div>
                                            ...
                                            <table class="table table-hover student-list" data-export-title="<?php echo $this->lang->line('student_login_credential_report'); ?>">
                                                    <thead>
                                                        <tr>
