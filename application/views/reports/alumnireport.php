                                    ...
                                    <form role="form" action="<?php echo site_url('report/alumnireport') ?>" method="post" class="">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group"> 
                                                <label><?php echo $this->lang->line('pass_out_session'); ?></label> <small class="text-danger"> *</small> 
                    ...
                    if (isset($resultlist)) {
                        ...
                        <div class="nav-tabs-custom border0 navnoshadow">
                            <div class="box-header ptbnull">
                                <h5 class="box-title titlefix"><i class="fa fa-users"></i> <?php echo $title; ?></h5>
                            </div> 

                            <div class="tab-content">
                                <div class="download_label"><?php echo $title; ?></div>
                                <div class="tab-pane active table-responsive no-padding" >
                                    <table class="table  table-hover example" cellspacing="0" width="100%">
                                        <thead>
                                            <tr>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="pwd"><?php echo $this->lang->line('current_phone'); ?></label><small class="text-danger"> *</small>
