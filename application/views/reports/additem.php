                ...
                <div class="box removeboxmius">
                    ...
                    <div class="">
                        ...
                        <div class="box-header ptbnull">
                            <h5 class="box-title titlefix"><i class="fa fa-money"></i> <?php echo $this->lang->line('add_item_report'); ?></h5>
                        </div>
                        <hr>
                        <div class="box-body">
                            <div class="download_label"> <?php echo $this->lang->line('add_item_report').' '. "<br>";  $this->customlib->get_postmessage();  ?></div>
                            <div class="table-responsive">                 
                                  <table class="table  table-hover item-list" data-export-title="<?php echo $this->lang->line('add_item_report'); ?>">
                                    <thead>
                                        <tr>
