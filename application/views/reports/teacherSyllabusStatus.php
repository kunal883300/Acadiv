...
<div class="nk-content">
    <div class="container-fluid">
        ...
        <div class="box removeboxmius">
            ...
            <form class="assign_teacher_form" action="<?php echo base_url(); ?>report/teachersyllabusstatus/" method="post" enctype="multipart/form-data">
                <div class="box-body">
                    ...
                    <button  type="submit" id="search_filter" name="search" value="search_filter" class="btn btn-primary btn-sm checkbox-toggle pull-right my-2"><i class="fa fa-search"></i> <?php echo $this->lang->line('search'); ?></button>
                </div>
            </form>
        </div>
        ...
        <?php if (!empty($subjects_data) && $subject_name != '') {
            ...
            <div class="box-body" id="transfee">                
                <div class="box-header ptbnull">
                    <h5 class="box-title titlefix"><i class="fa fa-money"></i>  <?php
    ...
    <div class="box-body">
            ...
            <div class="download_label"> <?php echo $this->lang->line('subject_lesson_plan_report'); ?></div>
                ...
                <table class="table nowrap table-hover example" cellspacing="0" width="100%">
                    <thead>
                        <tr>
