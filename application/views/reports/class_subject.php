                                ...
                                <div class="col-md-12">
                                    <div class="box removeboxmius">
                                        ...
                                        <div class="box-header with-border">
                                            <br>
                                            <h5 class="box-title"><i class="
                                            "></i> <?php echo $this->lang->line('select_criteria'); ?></h5>
                                            <hr>
                                        </div>
                                        ...
                                        <div class="">
                                            ...
                                            <div class="box-header ptbnull">
                                                <h5 class="box-title titlefix"><i class="
                                                "></i> <?php echo form_error('student'); ?> <?php echo $this->lang->line('class_subject_report'); ?></h5>
                                        <hr>
                                            </div>
