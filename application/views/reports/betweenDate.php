...
<div class="col-sm-6 col-md-3">
    <div class="form-group">
        ...
        <input name="date_from" id="date_from" placeholder="" type="text" class="form-control date-picker" value="<?php echo $date_from; ?>"  />
...
<div class="col-sm-6 col-md-3">
    <div class="form-group">
        ...
        <input  name="date_to" id="date_to" placeholder="" type="text" class="form-control date-picker" value="<?php echo $date_to; ?>"  />
