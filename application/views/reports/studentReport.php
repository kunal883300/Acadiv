                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="box removeboxmius">
                                        ...
                                        <div class="box-body">
                                            <form role="form"
                                                action="<?php echo site_url('report/studentreportvalidation') ?>"
                                                method="post" class="" id="reportform">
                                                <div class="row">
                                        ...
                                        <div class="">
                                            ...
                                            <div class="box-body table-responsive">
                                                ...
                                                <div>
                                                    <table
                                                        class="table table-hover student-list"
                                                        data-export-title="<?php echo $this->lang->line('student_report'); ?>">
                                                        <thead>
                                                            <tr>
                                                                <th>
                                                                    <?php echo $this->lang->line('section'); ?>
