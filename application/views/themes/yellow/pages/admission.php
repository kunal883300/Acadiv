...
?>
 ...
 <div class="printcontent">
    ...
    <h4 class="pagetitleh2"><?php echo $this->lang->line('basic_details'); ?></h4>                             
        ...
        <div class="col-md-3">
            <div class="form-group">
                <label><?php echo $this->lang->line('first_name'); ?></label><small class="text-danger"> *</small> 
    ...
    <div class="row"> 
        <div class="col-md-3">
            <div class="form-group">
                <label><?php echo $this->lang->line('gender'); ?></label><small class="text-danger"> *</small> 
        ...
        <div class="col-md-3">
            <div class="form-group">
                <label><?php echo $this->lang->line('date_of_birth'); ?></label><small class="text-danger"> *</small> 
        ...
        <div class="col-md-3">
            <div class="form-group">
                <label><?php echo $this->lang->line('email'); ?></label><small class="text-danger"> *</small>
    ...
    <div class="printcontent">    
       <div class="row">
        ...
        <div class="col-md-3">
            <div class="form-group">
                <label><?php echo $this->lang->line('guardian_name'); ?></label><small class="text-danger"> *</small>
        ...
        <div class="col-md-3">
            <div class="form-group">
                <label><?php echo $this->lang->line('guardian_relation'); ?></label><small class="text-danger"> *</small>
      ...
      <div class="modal-header modal-header-small">
       ...
       <form action="<?php echo base_url().'welcome/checkadmissionstatus' ?>" method="post" class="onlineform" id="checkstatusform">
          <div class="modal-body">
            <div class="form-group">
            <label><?php echo $this->lang->line('enter_your_reference_number'); ?></label><small class="text-danger"> *</small> 
             ...
             <div class="form-group mb10">
              <label><?php echo $this->lang->line('select_your_date_of_birth'); ?></label><small class="text-danger"> *</small> 
