    <form id="form1" class="spaceb60 spacet40" action="<?php echo current_url() ?>" id="employeeform" name="employeeform"
         ...
         <h3 class="entered pb20"> <?php echo $this->lang->line('exam_result'); ?></h3>
            <div class="row">
               <div class="col-lg-6 col-md-5 col-sm-6">
                  <div class="form-group">
                     <label for="email"><?php echo $this->lang->line('exam'); ?><small class="text-danger"> *</small> </label>
            ...
            <div class="col-lg-3 col-md-4 col-sm-3">   
               <div class="form-group">
                  <label for="email"><?php echo $this->lang->line('roll_no'); ?><small class="text-danger"> *</small> </label>
