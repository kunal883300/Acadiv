...
<body>
    <?php $print_copy = explode(
        ",",
        $settinglist[0]["is_duplicate_fees_invoice"]
    ); ?>
    <div class="container">
        <div class="row">
            <div id="content" class="col-lg-12 col-sm-12 ">
                <div class="content_box">
                    <?php if (in_array("0", $print_copy)) { ?>
                        <div class="invoice">
                            <div class="row header ">
                                <div class="col-sm-12">

                                    <img src="<?php echo $this->media_storage->getImageURL(
                                        "/uploads/print_headerfooter/student_receipt/" .
                            ...
                            <div class="row" style="font-size: 12pt;">
                                <div class="col-xs-6 text-left">
                                    <br />
                                    <address>
                                        <strong><?php echo $this->customlib->getFullName(
                                            $feeList->firstname,
                                            $feeList->middlename,
                                            $feeList->lastname,
                                        ...
                                        <?php echo $feeList->class . " (" . $feeList->section . ")"; ?> <br />
                                ...
                                <div class="col-xs-6 text-right">
                                    <br />
                                    <address>
                                        <img width="100" height="100" class="mt3 mb10 sfborder-img-shadow  img-rounded" src="<?php
                            ...
                            <div class="row">
                                <?php if (!empty($feeList)) { ?>
                                    ...
                                    <table class="table table-striped table-bordered table-responsive" style="font-size: 12pt;">
                                        <thead>
                                            <tr>
                                ...
                                <div class="last_row">
                                    ...
                                    <h4> <?php echo $this->lang->line(
                                        "collected_by"
                                    ); ?>:
                                        <?php if (
                                            isJSON($feeList->amount_detail)
                                        ) {
                                            $fee = json_decode(
                ...
                <hr>
                <div class="content_box">
                    <?php if (in_array("1", $print_copy)) { ?>


                        <?php if (!$sch_setting->single_page_print) { ?>
                ...
                <br />
                <br />
                <div class="content_box my-3">
                    <?php if (in_array("2", $print_copy)) { ?>
