        ...
        ?>
                                            <tr>
                                                <td class="mailbox-name">
                                                    <a href="#" data-bs-toggle="popover" class="detail_popover"><?php echo $examgroup->name; ?></a>
...
if ($examgroup->description == "") {
        ...
        if ($this->rbac->hasPrivilege('exam_group', 'can_edit')) {
            ?>
                                                        <a href="<?php echo site_url('admin/examgroup/edit/' . $examgroup->id); ?>" class=" "  data-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>">
