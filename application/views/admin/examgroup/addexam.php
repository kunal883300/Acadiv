                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="box box-primary">
                                        <div class="box-header ptbnull">
                                            <div class="row">
                                                <div class="col-md-8">
                                                    <h5  class="box-title titlefix"><?php echo $this->lang->line('exam_list'); ?></h5>
                                                </div>
                                                <div class="col-md-4 text-right">
                                                    <div class="impbtntitle">
                                                        <?php if ($this->rbac->hasPrivilege('exam', 'can_add')) { ?>
                                                            <a tabindex="-1" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#examModal"  id="examModalButton"><?php echo $this->lang->line('new_exam'); ?></a>
                                                        <?php } ?>
                                                        <?php if ($this->rbac->hasPrivilege('link_exam', 'can_view')) { ?>
                                                            <a tabindex="-1" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#examconnectModal" href="#" id="examconnectModalButton" data-examGroup_id="<?php echo $examgroup->id; ?>"><?php echo $this->lang->line('link_exams'); ?></a>
                                                        <?php } ?>
                                                    </div>
                                                </div>
                                            </div>
        ...
        <form id="formadd" action="<?php echo site_url('admin/examgroup/ajaxaddexam'); ?>">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <button type="button" class="close" data-bs-dismiss="modal"><span aria-hidden="true" class="fs-3"><span aria-hidden="true" class="fs-3">&times;</span></span></button>
                </div>
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="form-group col-xs-12 col-sm-9 col-md-9 col-lg-9">
                            <label for="exam"><?php echo $this->lang->line('exam') ?><small class="text-danger"> *</small></label>
                            <input type="text" class="form-control" id="exam" name="exam">
                            <span class="text text-danger" id="exam_error"></span>
                        </div>
                        <div class="form-group col-xs-12 col-sm-3 col-md-3 col-lg-3">
                            <label for="exam"><?php echo $this->lang->line('session') ?><small class="text-danger"> *</small></label>
                        ...
                        ?>
                            ...
                            <div class="form-group col-xs-12 col-sm-9 col-md-9 col-lg-9">
                                <label for="passing_percentage"><?php echo $this->lang->line('exam_passing_percentage'); ?><small class="text-danger"> *</small></label>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <h4 class="modal-title" id="myModalLabel"><?php echo $this->lang->line('confirmation'); ?></h4>
                <button type="button" class="close" data-bs-dismiss="modal" aria-hidden="true"><span aria-hidden="true" class="fs-3">&times;</span></button>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-bs-dismiss="modal"><?php echo $this->lang->line('cancel'); ?></button>
                ...
                <form role="form" id="searchStudentForm" action="<?php echo site_url('admin/examgroup/subjectstudent') ?>" method="post" class="mb10">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                <div class="form-group">
                                    <label for="exampleInputEmail1"><?php echo $this->lang->line('section'); ?><small class="text-danger"> *</small></label>
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                <label><?php echo $this->lang->line('session'); ?><small class="text-danger"> *</small></label>
                                <select id="session_id" name="session_id" class="form-control">
                                    <option value=""><?php echo $this->lang->line('select'); ?></option>
                                    <?php
                                    foreach ($sessionlist as $session) {
    ...
    <div class="modal-dialog modal-xl">
        ...
        <div class="modal-content">
            ...
            <h4 class="modal-title"><?php echo $this->lang->line('student_exam_rank'); ?> : <b class="exam_title"></b></h4>
                <button type="button" class="close" data-bs-dismiss="modal" autocomplete="off">×</button>
...
<script>
    $(document).on('click', '.add', function() {
        ...
        html += '<td width="150"><select name="subject_type'+ x +'" class="form-control item_unit tddm200"><option value="1" selected >Theory</option><option value="2">Oral</option><option value="3">Practical</option></select></td>';
        html += '<td><div class="input-group "><input type="text" name="date_from_' + x + '" class="form-control date-picker"/><span class="input-group-addon" id="basic-addon2"><i class="fa fa-calendar"></i></span></div></td>';
        html += '<td><div class="input-group "><input type="text" name="time_from' + x + '" class="form-control time-picker"/><span class="input-group-addon" id="basic-addon2"><i class="fa fa-clock-o"></i></span></div></td>';
...
<script type="text/javascript">
    ...
    $('#subjectModal').on('shown.bs.modal', function(e) {
        ...
        var subject_type = $(e.relatedTarget).data('subject_type');
        var type ;
        if(subject_type == 1){
             type = "Theory";
        ...
        $('.subjectmodal_header').html("").html(subject_name +"("+type+")");
        $('.marksEntryForm').html("");
