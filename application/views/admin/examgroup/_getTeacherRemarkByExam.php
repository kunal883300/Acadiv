...
<form action="<?php echo site_url('admin/examgroup/saveexamremark') ?>" method="get" accept-charset="utf-8" method="POST" id="remark_form">
      ...
      <thead>
        <tr>
          ...
          <th><?php echo $this->lang->line('physical_health') ; ?></th>
        ...
        <?php
          foreach ($examgroupStudents as $exam_student_key => $student) { ?>
            ...
            <tr>
              ...
              <td>
                <div class="form-group">  
                  <textarea id="work_<?php echo $student->exam_group_class_batch_exam_student_id; ?>" name="work_<?php echo $student->exam_group_class_batch_exam_student_id; ?>" class="form-control"><?php echo $student->work_ex; ?></textarea>  
                </div>
              </td>
              <td>
                <div class="form-group">  
                  <textarea id="physical_<?php echo $student->exam_group_class_batch_exam_student_id; ?>" name="physical_<?php echo $student->exam_group_class_batch_exam_student_id; ?>" class="form-control"><?php echo $student->physical; ?></textarea>  
                </div>
              </td>
              <td>
                <div class="form-group">  
                  <textarea id="attendance_<?php echo $student->exam_group_class_batch_exam_student_id; ?>" name="attendance_<?php echo $student->exam_group_class_batch_exam_student_id; ?>" class="form-control"><?php echo $student->attendance; ?></textarea>  
                </div>
              </td>
            </tr>                                        
        <?php } ?>      
