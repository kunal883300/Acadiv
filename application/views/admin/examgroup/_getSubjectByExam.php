                              ...
                              <table class="table table-bordered" id="subjects_table">
                                <thead>
                                    <tr>
                                        ...
                                        <th class=""><?php echo $this->lang->line('subject_type'); ?></th>
                                    ...
                                    if (!empty($exam_subjects)) {
                                        ...
                                        foreach ($exam_subjects as $exam_subject_key => $exam_subject_value) {
                                            ...
                                            <tr>
                                                ...
                                                <td><?php if( $exam_subject_value->subject_type == '1'){
                                                  echo "Theory";
                                                }else if( $exam_subject_value->subject_type == '2'){
                                                  echo "Oral";
                                                }else{
                                                  echo "Practical";
                                                }
                                                ...
                                                <td class="col-sm-1 text-right">  
                                                    ...
                                                    <button type="button" class="btn btn-default btn-xs" data-bs-toggle="modal" data-bs-target="#subjectModal" data-subject_name="<?php echo $exam_subject_value->subject_name; ?>" data-subject_type="<?php echo $exam_subject_value->subject_type; ?>" data-subject_id="<?php echo $exam_subject_value->id; ?>" data-teachersubject_id="<?php echo $exam_subject_value->subject_id; ?>" ><i class="fa fa-newspaper-o" aria-hidden="true"></i></button></span>
                                                </td>
                                            </tr>
                                            <?php
                                        }
