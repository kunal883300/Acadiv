 ...
 <img class="logo-dark logo-img logo-img-lg" src="<?php echo $this->media_storage->getImageURL('uploads/school_content/admin_logo/'.$this->setting_model->getAdminlogo()); ?>" srcset="<?php echo $this->media_storage->getImageURL('uploads/school_content/admin_logo/'.$this->setting_model->getAdminlogo()); ?> 2x" alt="logo-dark">
                                ...
                                <div class="nk-block-head">
                                    <div class="nk-block-head-content">
                                        <h5 class="nk-block-title"><?php echo $this->lang->line('forgot_password'); ?></h5>
                                ...
                                <form action="<?php echo site_url('site/forgotpassword') ?>" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
											<input type="text" class="form-control form-control-lg" name="email" placeholder="<?php echo $this->lang->line('email'); ?>" value="<?php echo set_value('username') ?>" class="form-username form-control" id="form-username">
                                        </div>
