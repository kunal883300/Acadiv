...
<form class="change_status" action="<?php echo site_url('admin/offlinepayment/update') ?>" method="POST">
   ...
   <div class="form-group">
	...
	<div class="form-group">
	    <label for="amount"><?php echo $this->lang->line('amount'); ?> (<?php echo $currency_symbol; ?>)<small class="text-danger"> *</small></label>
	    <input type="text" class="form-control" id="amount" name="amount" value="<?php echo ($amount_to_paid['amount']); ?>">
	  </div>

  <div class="form-group">
    <label for="fine"><?php echo $this->lang->line('fine'); ?> (<?php echo $currency_symbol; ?>)<small class="text-danger">*</small></label>
