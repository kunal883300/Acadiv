                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="box box-primary" id="route">
                                            ...
                                            <h5 class="box-title titlefix pt5"><?php echo $this->lang->line('select_criteria'); ?></h5>
                                            <hr>
                                                ...
                                                <div class="card-inner">
                                                    <div class="pull-right">
                                                        ...
                                                        <?php if ($this->rbac->hasPrivilege('import_question', 'can_view')) { ?>
                                                            <button class="btn btn-primary btn-sm import-question-btn" data-bs-toggle="modal" data-bs-target="#myQuesImportModal"><i class="fa fa-plus"></i> <?php echo $this->lang->line('import'); ?></button>
                                                        <?php } ?>
                                            ...
                                            <div class="box-header ptbnull">
                                                <br>
                                                <h5 class="box-title titlefix"><i class=""></i><?php echo $this->lang->line('question_bank'); ?></h5>
                                                <hr>
                                            </div>
                                            <div class="box-body table-responsive">
                                                <div class="card card-bordered h-100 shadow-sm">
                                                    <div class="card-inner">
                                                        ...
                                                        <table class="datatable-init-export nowrap table  all-list" data-export-title="<?php echo $this->lang->line('question_bank'); ?>">
                                                            <thead>
                                                                <tr>
...
<div id="myModal" class="modal fade" role="dialog">
    <div class="modal-dialog modal-xl">
        ...
        <div class="modal-content">
            ...
            <h5 class="modal-title"><?php echo $this->lang->line('question') ?></h5>
...
<div id="myimgModal" class="modal fade" role="dialog">
    <div class="modal-dialog modal-xl">
        ...
        <div class="modal-content">
            <div class="modal-header">
            <h5 class="modal-title imgModal-title"><?php echo $this->lang->line('images'); ?> </h5>
...
<div id="myQuesImportModal" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
            <h5 class="modal-title"> <?php echo $this->lang->line('import_question'); ?></h5>
            ...
            <form action="<?php echo site_url('admin/question/uploadfile'); ?>" method="POST" id="formimportquestion">
                <div class="modal-body add_question_import_body">
                    <div class="form-group">
                        <label><?php echo $this->lang->line('subject'); ?></label><small class="text-danger"> *</small>
                    ...
                    <div class="form-group">
                        <label for="exampleInputEmail1"> <?php echo $this->lang->line('attach_file'); ?></label><small class="text-danger"> *</small>
