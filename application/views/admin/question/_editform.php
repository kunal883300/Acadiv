 ...
 <div class="row">
                    <div class="form-group col-md-6">
                        <label for="subject_id"><?php echo $this->lang->line('subject') ?></label><small class="text-danger"> *</small>
...
?>
                      ...
                      <div class="form-group col-md-3">
                        <label for="question_type"><?php echo $this->lang->line('question_type'); ?></label><small class="text-danger"> *</small>
...
?>
                      ...
                      <div class="form-group col-md-3">
                        <label for="question_level"><?php echo $this->lang->line('question_level'); ?></label><small class="text-danger"> *</small>
...
?>
                   ...
                   <div class="row">
                          <div class="form-group col-md-6">
                        <label for="class_id"><?php echo $this->lang->line('class') ?></label><small class="text-danger"> *</small>
...
?>
                    ...
                    <div class="form-group">
                        <label><?php echo $this->lang->line('question') ?></label><small class="text-danger"> *</small>
...
foreach ($questionOpt as $question_opt_key => $question_opt_value) {
    ?>
                        <div class="form-group">
                            <label for="<?php echo $question_opt_key; ?>"><?php echo $this->lang->line('option_' . $question_opt_value); ?><?php if ($question_opt_value != 'E') {?><small class="text-danger"> *</small><?php }?></label>
...
?>
                    ...
                    <div class="form-group ans" <?php echo ($question_result->question_type == "singlechoice" || $question_result->question_type == "") ? "style='display: block;'" : "" ?> >
                        <label><?php echo $this->lang->line('answer') ?></label><small class="text-danger"> *</small>
...
?>
  ...
  <div class="form-group ans_checkbox" <?php echo ($question_result->question_type == "multichoice") ? "style='display: block;'" : "" ?>>
                        <label for="subject_id"><?php echo $this->lang->line('answer') ?></label><small class="text-danger"> *</small>
                        <div>
                                                   <?php
foreach ($questionOpt as $question_opt_key => $question_opt_value) {
    ?>
