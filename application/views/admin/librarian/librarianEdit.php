<div class="content-wrapper">
    ...
    $this->session->unset_userdata('msg'); ?>
                            ...
                            <div class="form-group">
                                <label for="exampleInputEmail1"><?php echo $this->lang->line('email'); ?></label><small class="text-danger"> *</small>
...
?>
                            ...
                            <div class="form-group">
                                <label for="exampleInputEmail1"><?php echo $this->lang->line('phone'); ?></label><small class="text-danger"> *</small>
