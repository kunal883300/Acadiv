...
?> 
                            ...
                            <input id="member_id" name="member_id"  type="hidden" class="form-control date-picker"  value="<?php echo $memberList->lib_member_id; ?>" />

                            <div class="form-group">
                                <label for="exampleInputEmail1"><?php echo $this->lang->line('books'); ?>  <small class="text-danger"> *</small></label>
...
?>
                            ...
                            <div class="form-group">
                                <label><?php echo $this->lang->line('due_return_date'); ?> <small class="text-danger"> *</small></label>
                                <input id="dateto" name="return_date"  type="text" class="form-control date-picker"  value="<?php echo set_value('return_date', date($this->customlib->getSchoolDateFormat())); ?>" />
        ...
        <div class="modal-content">
            ...
            <form action="<?php echo site_url('admin/member/bookreturn') ?>" method="POST" id="return_book">
                <div class="modal-body issue_retrun_modal-body">
                    ...
                    <div class="form-group">
                        <label for="exampleInputEmail1"><?php echo $this->lang->line('return_date'); ?> <small class="text-danger"> *</small></label>
                        <div class="input-group">
                            <div class="input-group-addon">
                                <i class="fa fa-calendar"></i>
                            </div>
                            <input type="text" class="form-control date-picker" id="input-date" name="date" placeholder="<?php echo $this->lang->line('date'); ?>" value="<?php echo date($this->customlib->getSchoolDateFormat()); ?>">
                        </div>
