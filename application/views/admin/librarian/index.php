                                    ...
                                    <table class="table table-striped table-bordered table-hover example" id="members">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>
                                                    <?php echo $this->lang->line('library_card_no'); ?>
                                                </th>
                                                <th>
                                                ...
                                                <th>
                                                    <?php echo $this->lang->line('member_type'); ?>
                                                </th>
                                                <th>
                                ...
                                foreach ($memberList as $member) {
                                    ...
                                    <tr>
                                        ...
                                        <td class="mailbox-date pull-right">
                                            <a href="<?php echo base_url(); ?>admin/member/issue/<?php echo $member['lib_member_id'] ?>"
                                                class="btn btn-default btn-xs" data-toggle="tooltip"
                                                title="<?php echo $this->lang->line('issue_return'); ?>">
