...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="form-group">
            <label for="form_message"><?php echo $this->lang->line('subject'); ?></label><small class="text-danger"> *</small>
    ...
    <div class="col-md-12">
        <div class="form-group">
            <label for="form_message"><?php echo $this->lang->line('template'); ?></label><small class="text-danger"> *</small>
