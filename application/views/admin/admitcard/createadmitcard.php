                ...
                <div class="col-md-4">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h5 class="box-title"> <?php echo $this->lang->line('add_admit_card'); ?></h5>
                            <hr>
                        </div><!-- /.box-header -->
...
if (isset($error_message)) {
    ...
    ?>
                                <div class="form-group">
                                    <label> <?php echo $this->lang->line('template') ?></label><small class="text-danger"> *</small>
...
?>">
                ...
                <div class="box box-primary" id="hroom">
                    <div class="box-header ptbnull">
                        <h5 class="box-title titlefix"><?php echo $this->lang->line('admit_card_list'); ?></h5>
                        <hr>
                    </div><!-- /.box-header -->
                    <div class="card card-bordered h-100 shadow-none  " >
                        <div class="card-inner">
        ...
        ?>
                                            <tr>
                                                ...
                                                <td class="mailbox-date text-right no-print white-space-nowrap">
                                                    <a data-toggle="tooltip"  id="<?php echo $certificate->id ?>" class="btn btn-icon btn-sm btn-white btn-dim btn-outline-success p-1" title="<?php echo $this->lang->line('view'); ?>">
                                                        <i class="fa fa-reorder"></i>
                                                    </a>
                                                    <?php
if ($this->rbac->hasPrivilege('design_admit_card', 'can_edit')) {
            ?>
                                                        <a href="<?php echo site_url('admin/admitcard/edit/' . $certificate->id); ?>" class="btn btn-icon btn-sm btn-white btn-dim btn-outline-primary p-1"  data-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>">
        ...
        if ($this->rbac->hasPrivilege('design_admit_card', 'can_delete')) {
            ?>
                                                        <a href="<?php echo base_url(); ?>admin/admitcard/delete/<?php echo $certificate->id ?>" class="btn btn-icon btn-sm btn-white btn-dim btn-outline-danger p-1"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('<?php echo $this->lang->line('delete_confirm') ?>');">
