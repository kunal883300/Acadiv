                                        ...
                                        <div class="col-md-4">
                                            <div class="box box-primary">
                                                <div class="box-header with-border">
                                                    <h5 class="box-title"><?php echo $this->lang->line('add_student_certificate'); ?></h5>
                                                    <hr>
                                                </div><!-- /.box-header -->
                                                <div class="card card-bordered">
                                                    <div class="card-inner">
                                                                        ...
                                                                        <div class="col-md-6 col-sm-6 img_div_modal">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="custom-control custom-switch">
                                                                                    <input id="enable_student_img" name="is_active_student_img" type="checkbox" class="custom-control-input chk" value="1" onclick="valueChanged();">
    ...
    <div class="modal-dialog modal-xl" style="width: 90%;">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><?php echo $this->lang->line('view_certificate'); ?></h5>
