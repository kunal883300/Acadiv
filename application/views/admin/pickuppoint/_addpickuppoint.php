...
<div id="<?php echo $delete_string;?>">
        ...
        <div class="col-md-2">
            <div class="form-group">
                <label for="exampleInputEmail1"><?php echo $this->lang->line('pickup_time'); ?></label> 
                <div class="input-group">
                    <input value="<?php echo $this->customlib->timeFormat($result['pickup_time'],$this->customlib->getSchoolTimeFormat());?>" class="form-control  time-picker" name="time[]" />
        ...
        <div class="col-md-2">
            <div class="form-group">
                <label for="exampleInputEmail1"><?php echo $this->lang->line('monthly_fees'); ?> <?php echo "(" . $currency_symbol . ")"; ?> </label> <small class="text-danger"> *</small>
