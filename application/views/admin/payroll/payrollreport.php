                                    ...
                                    <div class="box removeboxmius">
                                        ...
                                        <div class="card card-bordered h-100 shadow-none  ">
                                            <div class="card-inner">
                                                <div class="box-body">
                                                    <form role="form"
                                                        action="<?php echo site_url('admin/payroll/payrollreport') ?>"
                                                        method="post">
                                            ...
                                            <div class="tab-content">
                                                <div class="tab-pane active table-responsive" id="tab_parent">
                                                    <div class="download_label">
                                                        <?php echo $this->lang->line('payroll_report_for') . ' ' . "<br>";
                                                    ...
                                                    <table
                                                        ...
                                                        <thead class="header">
                                                            <tr>
                                                                ...
                                                                <th>
                                                                    <?php echo $this->lang->line('month_year'); ?>
                                                                </th>
                                                                <th>
                                                                    <?php echo $this->lang->line('payslip'); ?> #
                                                                </th>
                                                                <th class="text text-right">
                                                                    <?php echo $this->lang->line('basic_salary'); ?> <span>
                                                                        <?php echo "(" . $currency_symbol . ")"; ?>
                                                                    </span>
                                                                </th>
                                                                <th class="text text-right">
                                                                    <?php echo $this->lang->line('earning'); ?> <span>
                                                                        <?php echo "(" . $currency_symbol . ")"; ?>
                                                                    </span>
                                                                </th>
                                                                <th class="text text-right">
                                                                    <?php echo $this->lang->line('deduction'); ?> <span>
                                                                        <?php echo "(" . $currency_symbol . ")"; ?>
                                                                    </span>
                                                                </th>
                                                                <th class="text text-right">
                                                                    <?php echo $this->lang->line('gross_salary'); ?> <span>
                                                                        <?php echo "(" . $currency_symbol . ")"; ?>
                                                                    </span>
                                                                </th>
                                                                <th class="text text-right">
                                                                    <?php echo $this->lang->line('tax'); ?> <span>
                                                                        <?php echo "(" . $currency_symbol . ")"; ?>
                                                                    </span>
                                                                </th>
                                                                <th class="text text-right">
                                                                    <?php echo $this->lang->line('net_salary'); ?> <span>
                                                                        <?php echo "(" . $currency_symbol . ")"; ?>
                                                                    </span>
                                                                </th>
                                                            </tr>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            if (empty($result)) {
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <div class="fee_detail_popover" style="display: none">
                                                                                ...
                                                                                <?php echo $payment_mode[$value["payment_mode"]] ?>
                                                                            </div>
                                                                ...
                                                                <tr class="box box-solid total-bg">
                                                                    ...
                                                                    <td class="text text-right">
                                                                        <?php echo $currency_symbol . amountFormat($basic); ?>
                                                                    </td>
                                                                    <td class="text text-right">
                                                                        <?php echo $currency_symbol . amountFormat($earnings); ?>
                                                                    </td>
                                                                    <td class="text text-right">
                                                                        <?php echo $currency_symbol . amountFormat($deduction); ?>
                                                                    </td>
                                                                    <td class="text text-right">
                                                                        <?php echo $currency_symbol . amountFormat($gross - $deduction); ?>
                                                                    </td>
                                                                    <td class="text text-right">
                                                                        <?php echo $currency_symbol . amountFormat($tax); ?>
                                                                    </td>
                                                                    <td class="text text-right">
                                                                        <?php echo $currency_symbol . amountFormat($net); ?>
                                                                    </td>
