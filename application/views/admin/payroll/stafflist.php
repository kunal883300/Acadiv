                                ...
                                <div class="col-md-12">
                                    ...
                                    ?>
                                        ...
                                        <div class="box-header ptbnull">
                                            <h5 class="box-title titlefix"><i class="fa fa-users"></i> <?php echo $this->lang->line('staff_list'); ?>
                                                            ...
                                                            ?>
                                                                ...
                                                                ?>
                                                                    <td class="no-print">
                                                                        ...
                                                                        ?>
                                                                            <button type="button" onclick="getRecord('<?php echo $staff["id"] ?>', '<?php echo $year ?>')" role="button" class="btn btn-primary btn-xs checkbox-toggle edit_setting" data-toggle="tooltip"><?php echo $this->lang->line('proceed_to_pay'); ?></button>
                                                                    <?php
                                                                        }
                                                                    }
                                                                    ?>
    ...
    <div class="modal-dialog modal-dialog2 modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title"><?php echo $this->lang->line('details'); ?> <span id="print1" class="ms-2"></span></h4>
...
<div id="proceedtopay" class="modal fade zoom" role="dialog">
    <div class="modal-dialog modal-dialog2 modal-lg">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
				<form role="form" id="schsetting_form" action="<?php echo site_url('admin/payroll/paymentSuccess') ?>">
					<div class="row">
						...
						<div class="form-group  col-xs-12 col-sm-12 col-md-12 col-lg-6">
							<label for="exampleInputEmail1" class="form-label"><?php echo $this->lang->line('payment_amount'); ?> (<?php echo $currency_symbol; ?>)</label>
							<input type="text" name="amount" readonly class="form-control" id="amount">
						</div>
						<div class="form-group  col-xs-12 col-sm-12 col-md-12 col-lg-6">
							<label for="exampleInputEmail1" class="form-label"><?php echo $this->lang->line("month_year") ?></label>
						...
						<div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-6">
							<label for="exampleInputEmail1" class="form-label"><?php echo $this->lang->line('payment_mode'); ?></label><small class="text-danger"> *</small><br /><span id="remark">
							</span>
						...
						<div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-6">
							...
							<label for="exampleInputEmail1" class="form-label"><?php echo $this->lang->line('payment_date'); ?></label><small class="text-danger"> *</small><br /><span id="remark">
							</span>
							<input type="text" name="payment_date" id="payment_date" class="form-control date-picker" value="<?php echo $this->customlib->dateformat(date('Y-m-d')); ?>">
						</div>
						<div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-6">
							<label for="exampleInputEmail1" class="form-label"><?php echo $this->lang->line('note'); ?></label><br /><span id="remark"> </span>
							<textarea name="remarks" class="form-control" row="2"></textarea>
						</div>
...
<script type="text/javascript">
    ...
    function getPayslip(id) {
        ...
        $.ajax({
            ...
            success: function(result) {
                $("#print1").html("<button type='button'  class='btn btn-dim btn-primary pull-right modal-title moprintblack'  onclick='printData(" + id + ")'  title='Print' ><i class='fa fa-print'></i></button>");
