                ...
                <div class="col-md-12">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h5 class="box-title"><?php echo $this->lang->line('media_manager'); ?></h5>
                            <hr>
                        </div>
                        <div class="box-body">
                        ...
                        <div class="card-inner">
                            ...
                            <div class="row"> 
                                ...
                                <div class="col-md-5 col-sm-5 col-lg-5">  
                                        <div class="form-group">
                                            <label for="video_url"><?php echo $this->lang->line('upload_youtube_video_link'); ?></label><small class="text-danger"> *</small>
