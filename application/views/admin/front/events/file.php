                            ...
                            <form  action="<?php echo site_url('admin/front/events/edit/' . $result['slug']) ?>"  id="eventform" name="employeeform" method="post" accept-charset="utf-8">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="start_date" name="start_date" placeholder="" type="text" class="form-control date-picker"  value="<?php echo set_value('start_date', date($this->customlib->getSchoolDateFormat(), $this->customlib->dateyyyymmddTodateformat($result['event_start']))); ?>" readonly="readonly" />
                                        <span class="text-danger"><?php echo form_error('event_start'); ?></span>
                                    </div> 
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Event end --r</label>
                                        <input id="end_date" name="end_date" placeholder="" type="text" class="form-control date-picker"  value="<?php echo set_value('end_date', date($this->customlib->getSchoolDateFormat(), $this->customlib->dateyyyymmddTodateformat($result['event_end']))); ?>" readonly="readonly" />
