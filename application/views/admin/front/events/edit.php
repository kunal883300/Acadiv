                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input id="start_date" name="start_date" placeholder="" type="text" class="form-control date-picker"  value="<?php echo date($this->customlib->getSchoolDateFormat(), strtotime($result["event_start"]))  ?>" readonly="readonly" />
                                ...
                                <div class="col-md-4 col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input id="end_date" name="end_date" placeholder="" type="text" class="form-control date-picker"  value="<?php echo date($this->customlib->getSchoolDateFormat(), strtotime($result["event_end"]));  ?>" readonly="readonly" />
