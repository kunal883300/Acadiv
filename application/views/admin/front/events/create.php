            ...
            <form id="form1" action="<?php echo site_url('admin/front/events/create') ?>" enctype="multipart/form-data" id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                <div class="col-md-9">
                    ...
                    <div class="box box-primary">
                        ...
                        <!-- <div class="card card-bordered h-100 shadow-sm" > -->
                        <!-- <div class="card-inner"> -->
                            <h5 class="box-title"><?php echo $this->lang->line('add_event'); ?></h5>
                               <hr>
                        </div><!-- /.box-header -->
                        <!-- form start -->
                            ...
                            <div class="row">    
                                ...
                                <div class="col-md-4 col-sm-4">    
                                    <div class="form-group">
                                        ...
                                        <input id="start_date" name="start_date" placeholder="" type="text" class="form-control date-picker"  value="<?php echo set_value('start_date', date($this->customlib->getSchoolDateFormat())); ?>" readonly="readonly" />
                                ...
                                <div class="col-md-4 col-sm-4">      
                                    <div class="form-group">
                                        ...
                                        <input id="end_date" name="end_date" placeholder="" type="text" class="form-control date-picker"  value="<?php echo set_value('end_date', date($this->customlib->getSchoolDateFormat())); ?>" readonly="readonly" />
                            ...
                            <button type="button" class="btn btn-primary btn-sm pull-right my-2 mx-2" id="media_images" data-toggle="modal" data-target="#mediaModal"><i class="fa fa-plus"></i>
