...
<div class="content-wrapper mx-3 my-3">
            ...
            <form id="form1" action="<?php echo site_url('admin/front/gallery/create') ?>"  enctype="multipart/form-data" id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                ...
                <div class="card card-bordered h-100 shadow-sm" >
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label for="exampleInputEmail1"><?php echo $this->lang->line('title'); ?></label><small class="text-danger"> *</small>  
                            ...
                            <div class="formgroup10 form-group mb10">
                                <label for="exampleInputEmail1"><?php echo $this->lang->line('description'); ?></label><small class="text-danger"> *</small>
                            ...
                            <div class="formgroup10 my-3">
                                <label><?php echo $this->lang->line('gallery_images'); ?></label>
                                <button type="button" class="btn btn-primary btn-sm gallery_image pull-right" id="gallery_images" data-target="#mediaModal" data-toggle="modal"><i class="fa fa-plus"></i>  <?php echo $this->lang->line('add_images'); ?></button>
                                <div class="mediarow">
                                    <div class="row">
                    ...
                    <!-- <div class="panel box box-primary collapsed-box"> 
                        <div class="box-header with-border">
                            <br>
                            <a class="btn boxplus" data-widget="collapse" data-original-title="Collapse">
                                <br
                                <?php echo $this->lang->line('seo_detail'); ?> <<i class=""></i>  
                                <  
                            </a>
                        </div>
    ...
    <div class="box-header with-border">
        <a class="btn boxplus" data-toggle="collapse" href="#collapseSeo" aria-expanded="false" aria-controls="collapseSeo"><?php echo $this->lang->line('seo_detail'); ?><i class="fa fa-plus"></i></a>
    </div>
    <div class="box-body collapse show" id="collapseSeo">
        <div class="form-group">
            <label for="exampleInputEmail1"><?php echo $this->lang->line('meta_title'); ?></label>
            <input id="meta_title" name="meta_title" placeholder="" type="text" class="form-control" value="<?php echo set_value('meta_title'); ?>" />
            <span class="text-danger"><?php echo form_error('meta_title'); ?></span>
        ...
        <div class="form-group">
            ...
            <span class="text-danger"><?php echo form_error('meta_description'); ?></span>
                ...
                <!-- </div>/.col (right) -->
                <!-- left column -->
                <div class="col-md-3 col-sm-12 my-2 mx-2">
...
<!-- Modal -->
<div class="modal " id="mediaModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
