                ...
                <div class="col-md-9">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h5 class="box-title"><?php echo $this->lang->line('add_news'); ?></h5>
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control date-picker" id="date" name="date" readonly="readonly" value="<?php echo set_value('start_date', date($this->customlib->getSchoolDateFormat())); ?>" type="text"/>
