                ...
                <div class="col-md-9">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h5 class="box-title"><?php echo $this->lang->line('edit_news'); ?></h5>
                        ...
                        <div class="card-inner">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control date-picker" id="date" name="date" readonly="readonly" value="<?php echo set_value('date', date($this->customlib->getSchoolDateFormat(), $this->customlib->dateyyyymmddTodateformat($result['date']))); ?>" type="text"/>
