                ...
                <div class="col-md-4">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h5 class="box-title"><?php echo $this->lang->line('edit_item_stock'); ?></h5>
                        </div><!-- /.box-header -->
                        <hr>
...
if (set_value('store_id', $item['store_id']) == $itemstore['id']) {
    ...
    ?>
                                ...
                                <div class="form-group">
                                    <label for="exampleInputEmail1"><?php echo $this->lang->line('quantity'); ?></label><small class="text-danger"> *</small><span id="item_unit"></span>
                                    <div class="">
                                        <span class="miplus">
...
if ($item['date'] != '0000-00-00') {
    ...
    ?>
                                <div class="form-group">
                                    ...
                                    <input id="date" name="date" placeholder="" type="text" class="form-control date-picker"  value="<?php if ($item['date'] != '0000-00-00') {
...
?>">
                ...
                <div class="box box-primary">
                    <div class="box-header ptbnull">
                        <h5 class="box-title titlefix"> <?php echo $this->lang->line('item_stock_list'); ?></h5>
                        <hr>
