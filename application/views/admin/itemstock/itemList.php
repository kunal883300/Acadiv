                                ...
                                <?php if ($this->rbac->hasPrivilege('item_stock', 'can_add')) {
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="box box-primary">
                                            ...
                                            <form id="form1" action="<?php echo base_url() ?>admin/itemstock"
                                                id="itemstockform" name="itemstockform" method="post" accept-charset="utf-8"
                                                    ...
                                                    <div class="card card-bordered h-100 shadow-sm">
                                                        <div class="card-inner">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select autofocus="" id="item_category_id"
                                                                    name="item_category_id" class="form-control">
                                                                    <option value="">
                                                                ...
                                                                <select id="supplier_id" name="supplier_id"
                                                                    ...
                                                                    foreach ($itemsupplier as $itemsup) {
                                                                        ...
                                                                        <option value="<?php echo $itemsup['id'] ?>" <?php
                                                                           ...
                                                                           ?>><?php echo $itemsup['item_supplier'] ?>
                                                                        </option>
                                                                ...
                                                                <select id="store_id" name="store_id" class="form-control">
                                                                    ...
                                                                    foreach ($itemstore as $itemstore) {
                                                                        ...
                                                                        <option value="<?php echo $itemstore['id'] ?>" <?php
                                                                           ...
                                                                           ?>><?php echo $itemstore['item_store'] ?>
                                                                            <?php if ($itemstore['code']) {
                                                                                echo ' (' . $itemstore['code'] . ')';
                                                                            } ?>
                                                                        </option>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                </label><small class="text-danger"> *</small> <span
                                                                    id="item_unit"></span>
                                                                <div class="">
                                                                    <span class="miplus">
                                                                    ...
                                                                    <input id="quantity" name="quantity" placeholder=""
                                                                        type="text" class="form-control miplusinput"
                                                            ...
                                                            <div class="form-group">
                                                                <label for="exampleInputEmail1">
                                                                    <?php echo $this->lang->line('purchase_price'); ?> (
                                                                    <?php echo $currency_symbol; ?>)
                                                                </label><small class="text-danger"> *</small>
                                                                <input id="date" name="purchase_price" placeholder=""
                                                                    type="text" class="form-control purchase_price"
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input id="item_photo" name="item_photo" placeholder=""
                                                                    type="file" class="filestyle form-control"
                                                                    data-height="40"
                                                                    value="<?php echo set_value('item_photo'); ?>" />
                                                                <span class="text-danger">
                                                                    <?php echo form_error('item_photo'); ?>
                                                                </span>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="exampleInputEmail1">
                                                        ...
                                                        <div class="box-footer my-2 mx-2">
                            ...
                            <div class="box box-primary">
                                <div class="box-header ptbnull">
                                    <h5 class="box-title titlefix">
                                        <?php echo $this->lang->line('item_stock_list'); ?>
                                    </h5>
                                    <hr>
                                                ...
                                                <table class="table table-hover  example">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th class="text-right">
                                                                <?php echo $this->lang->line('purchase_price') . " (" . $currency_symbol . ")"; ?>
                                                            </th>
                                                            <th>
                                                                <?php echo $this->lang->line('date'); ?>
                                                            </th>
                                                            <th width="12%" class="text-right noExport">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="mailbox-date pull-right">
                                                                        <?php if ($items['attachment']) {
                                                                            ?>
                                                                            <a href="<?php echo base_url(); ?>admin/itemstock/download/<?php echo $items['id'] ?>"
                                                                        ...
                                                                        <?php if ($this->rbac->hasPrivilege('item_stock', 'can_edit')) { ?>
                                                                            <a href="<?php echo base_url(); ?>admin/itemstock/edit/<?php echo $items['id'] ?>"
                                                                                class="btn btn-default btn-xs" data-toggle="tooltip"
                                                                        ...
                                                                        if ($this->rbac->hasPrivilege('item_stock', 'can_delete')) { ?>
                                                                            <a href="<?php echo base_url(); ?>admin/itemstock/delete/<?php echo $items['id'] ?>"
                                                                                class="btn btn-default btn-xs" data-toggle="tooltip"
