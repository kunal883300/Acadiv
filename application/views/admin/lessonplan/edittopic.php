...
?>
                            ...
                            <?php foreach ($edittopicname as $edittopicname_value) {?>
                                <div class="form-group" id="<?php echo $edittopicname_value['id']; ?>"><label><?php echo $this->lang->line("topic_name"); ?></label><small class="text-danger"> *</small><input type="text" name="topic_<?php echo $edittopicname_value['id']; ?>" value="<?php echo $edittopicname_value['name']; ?>" style="width:95%" /><?php if ($this->rbac->hasPrivilege('topic', 'can_delete')) {?><span  onclick="remove_topic('<?php echo $edittopicname_value['id']; ?>')" class="section_id_error text-danger">&nbsp;<i class="fa fa-remove"></i></span> <?php }?></div>
                            <?php }?>
...
<script>
    ...
    function add_topic() {
        var id = makeid(8);
        $('#topic_result').append('<div class="form-group" id="' + id + '"><label><?php echo $this->lang->line("topic_name"); ?></label><small class="text-danger"> *</small><input type="text" name="topic[]" style="width:95%" /><span  onclick="remove_topic(' + id + ')" class="section_id_error text-danger">&nbsp;<i class="fa fa-remove"></i></span></div>');
    }
