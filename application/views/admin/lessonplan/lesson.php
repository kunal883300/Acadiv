                ...
                <div class="col-md-4">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h5 class="box-title"><?php echo $this->lang->line('add_lesson'); ?></h5>
                         <hr>
                        </div>
...
?>">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h5 class="box-title"><?php echo $this->lang->line("lesson_list"); ?></h5>
                        <hr>
                    ...
                    <div class="card card-bordered h-100 shadow-sm" >
                        ...
                        <div class="table-responsive mailbox-messages overflow-visible-lg" id="transfee">
                              <table class="nowrap table  topic-list " id="headerTable" data-export-title="<?php echo $this->lang->line('lesson_list'); ?>" id="headerTable" >
                                <thead>
...
<script>
    ...
    function add_lesson() {
        var id = makeid(8);
        $('#lesson_result').append('<div class="form-group" id="' + id + '"><label><?php echo $this->lang->line("lesson_name"); ?></label><small class="text-danger"> *</small><br><input type="text" name="lessons[]" class="lessinput" /> <span  onclick="remove_lesson(' + id + ')" class="section_id_error text-danger">&nbsp;<i class="fa fa-remove"></i></span></div>');
    }
