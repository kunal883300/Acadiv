                    ...
                    <form   id="lesson_form" name="lesson_form" method="post" accept-charset="utf-8">
                        <div class="box-body">
                            ...
                            <?php foreach ($editlessonname as $editlessonname_value) { ?>
                                <div class="form-group" id="<?php echo $editlessonname_value['id']; ?>"><label><?php echo $this->lang->line('lesson_name'); ?></label><small class="text-danger"> *</small><input type="text" name="lessons_<?php echo $editlessonname_value['id']; ?>" value="<?php echo $editlessonname_value['name']; ?>"  style="width:95%" />  <?php if ($this->rbac->hasPrivilege('lesson', 'can_delete')) {
