                ...
                <div class="col-md-4">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h5 class="box-title"><?php echo $this->lang->line('add_topic'); ?></h5>
                         <hr>
                        </div>
...
if ($class_id == $class["id"]) {
    ...
    ?>
                                ...
                                <div class="form-group">
                                    <label><?php echo $this->lang->line('lesson'); ?></label><small class="text-danger"> *</small>
                            ...
                            <div class="box-footer">
                                <button type="submit" class="btn btn-info pull-right mb-2 mx-3"><?php echo $this->lang->line('save'); ?></button>
                            </div>
                        </form>
</div>
</div>
...
?>">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h5 class="box-title"><?php echo $this->lang->line('topic_list'); ?></h5>
                        <hr>
                    ...
                    <div class="card card-bordered h-100 " >
                        ...
                        <div class="table-responsive mailbox-messages " id="transfee">
                           <table class="nowrap table topic-list" id="headerTable" data-export-title="<?php echo $this->lang->line('topic_list'); ?>" >
                                <thead>
...
<script>
    ...
    function add_topic() {
        ...
        var id = makeid(8);
        $('#topic_result').append('<div class="form-group" id="' + id + '"><label><?php echo $this->lang->line("topic_name"); ?></label><small class="text-danger"> *</small><input type="text" name="topic[]" class="lessinput" /><span  onclick="remove_topic(' + id + ')" class="section_id_error text-danger">&nbsp;<i class="fa fa-remove"></i></span></div>');
