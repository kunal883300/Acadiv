                                                ...
                                                <div class="box box-primary">
                                                    ...
                                                    <div class="card card-bordered h-100 shadow-none  ">
                                                        <div class="card-inner">
                                                            <div class="box-body">
                                                                ...
                                                                <div class="">
                                                                    <button type="submit" name="action" value="search" class="btn btn-primary pull-right my-2"><?php echo $this->lang->line('search'); ?></button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    ?>
                                                        ...
                                                        <div class="">
                                                            <div class="box-header with-border">
                                                                <br>
                                                                <h5 class="box-title titlefix"><?php echo $this->lang->line('previous_session_balance_fees'); ?></h5>
                                                                <hr>
                                                                <div class="pull-right">
                                                                    ...
                                                                    <input id="due_date" name="due_date" placeholder="" type="hidden" class="form-control date-picker" value="<?php echo set_value('due_date', $due_date_formated); ?>" readonly />
                                                                </div>
                                                            </div>
                                                            <div class="box-body">
                                                                <?php
                                                                                    ...
                                                                                    ?>
                                                                                        <tr>
                                                                                            ...
                                                                                            <td class="text text-right">
                                                                                                <span class="d-none"><?php echo convertBaseAmountCurrencyFormat($due_fee_value->balance); ?></span>
