            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h5 class="box-title"><i class="fa fa-search"></i> <?php echo $this->lang->line('manage_lesson_plan'); ?></h5>
                        <hr>
                            ...
                            <form action="<?php echo site_url('admin/syllabus/getteachertimetable'); ?>" id="getTimetable" class="row">
                                <div class="col-lg-4 col-md-4 col-sm-4">
                                    <div class="form-group">
                                        <label for="teacher"><?php echo $this->lang->line('teachers'); ?><small class="text-danger"> *</small></label>
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4">
                                        <div class="form-group">
                                            <label><?php echo $this->lang->line('topic'); ?></label><small class="text-danger"> *</small>
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4">
                                        <div class="form-group">
                                            <label for="pwd"><?php echo $this->lang->line('date'); ?></label><small class="text-danger"> *</small>
