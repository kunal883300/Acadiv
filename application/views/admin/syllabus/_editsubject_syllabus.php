                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label><?php echo ('lesson --r'); ?></label><small class="text-danger"> *</small>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label><?php echo ('topic --r'); ?></label><small class="text-danger"> *</small>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            <label for="pwd"><?php echo ('date --r'); ?></label><small class="text-danger"> *</small>
                            <input type="text" id="editdate" name="date" class="form-control date-picker" >
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-group">
                            <label for="pwd"><?php echo ('time_from --r'); ?></label><small class="text-danger"> *</small>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            <label for="pwd"><?php echo ('time_to --r'); ?></label><small class="text-danger"> *</small>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="exampleInputEmail1"><?php echo ('presentation --r'); ?></label><small class="text-danger"> *</small>
