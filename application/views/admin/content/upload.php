                                                    ...
                                                    <div class="col">
                                                        <div
                                                            ...
                                                            <h5 class="box-title titlefix">
                                                                <?php echo $this->lang->line('content_list'); ?>
                                                            </h5>
                                                            <hr>
                                                        ...
                                                        <form method="POST" action="#" id="searchform">
                                                            ...
                                                            <div class="input-group input-group-sm">
                                                                ...
                                                                <div class="input-group-btn">
                                                                    <button type="submit"
                                                                        class="btn btn-default  post_search_submit"><i
                                                        ...
                                                        <div class="pull-right">
                                                            <div class="btn-group">
                                                                <button class="btn btn-default btn-sm"
                                                                    title="<?php echo $this->lang->line('list_view'); ?>"
                                                                    id="list">
                                                                    <span class="fa fa-1-2x fa-th-list"></span>
                                                                </button>
                                                                <button class="btn btn-default btn-sm"
                                                                    title="<?php echo $this->lang->line('card_view'); ?>"
                                                                    id="grid">
                                                                ...
                                                                <div class="documents_sidebar_info p-2">
                                                                    <div class="sidear-info">
                                                                        <table class="table no-border">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td>
                                                                                        <?php echo $this->lang->line('total_documents'); ?>
                                                                                    </td>
                                                                                    <td class="total_files">
                                                                                        <?php echo $count->number; ?>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td>
                                                                                    ...
                                                                                    <td class="total_size">
                                                                                        <?php echo format_file_size($count->file_size); ?>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                    ...
                                                                    <div class="sidebar-form-content displaynone">
                                                                        ...
                                                                        <?php if ($this->rbac->hasPrivilege('upload_content', 'can_delete')) { ?>
                                                                            <button href="#"
                                                                                class="btn btn-sm btn-default btn-white pull-right side_delete_btn"
                                                                                data-toggle="modal"
                                                                        ...
                                                                        <form class="pt20"
                                                                            ...
                                                                            <div class="form-group row">
                                                                                <label
                                                                                    class="control-label col-sm-4 col-xs-4">
                                                                            ...
                                                                            <div class="form-group row">
                                                                                <label
                                                                                    class="control-label col-sm-4 col-xs-4">
                                                                                    <?php echo $this->lang->line('content_type'); ?>
                                                                                    <small class="text-danger">
                                                                                        *</small>
                                                                                </label>
                                                                                <div class="col-sm-8 col-xs-8">
                                                                                    <select id="content_type"
                                                                                        ...
                                                                                        foreach ($content_types as $content_type_key => $content_type_value) {
                                                                                            ?>
                                                                                            <option
                                                                                                value="<?php echo $content_type_value->id; ?>">
                                                                                                <?php echo $content_type_value->name; ?>
                                                                                            </option>
                                                                                            <?php
                                                                                        }
                                                                                        ?>
            ...
            <div class="modal-content">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                            <div class="form-group">
                                <label for="content_type">
                                    <?php echo $this->lang->line('content_type'); ?> <small class="text-danger">
                                        *</small>
                                </label>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-4 col-md-4 col-lg-5">
                            <div class="form-group">
                                ...
                                <div class="files">
                                    <input type="file" name="upload[]" class="filestyle form-control" data-height="26"
                                        id="file">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xs-12 col-sm-4 col-md-4 col-lg-5">
                            <div class="form-group">
                                <label>
                                    <?php echo $this->lang->line('upload_youtube_video_link'); ?>
                                </label>
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-primary" id="load"
                        data-loading-text="<i class='fa fa-spinner fa-spin'></i> <?php echo $this->lang->line('saving'); ?>">
                        <?php echo $this->lang->line('save'); ?>
                    </button>
                </div>
            </div>
...
<div id="shareURLModal" class="modal fade" role="dialog">
        ...
        <form id="shareurl" action="<?php echo site_url('admin/content/generate_url'); ?>"
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">
                        <?php echo $this->lang->line('generate_url'); ?>
                    </h4>
                </div>
  ...
  <input type="text" class="form-control share_link"><span class="btn btn-xs btn-info input-group-addon" onclick="copylink()" id="basic-addon1" data-toggle="tooltip" data-original-title="<?php echo $this->lang->line('copy'); ?>"><i class="fa fa-copy"></i></span>
                    ...
                    <div class="from_content">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="exampleInputEmail1">
                                        <?php echo $this->lang->line('share_date'); ?>
                                    </label><small class="text-danger"> *</small>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="exampleInputEmail1">
                                        <?php echo $this->lang->line('valid_upto'); ?>
                                    </label>
                    ...
                    <div class="url_content_list">
                        ...
                        <h4>
                            <?php echo $this->lang->line('selected_document'); ?>
                        </h4>
        ...
        <form id="share_form" action="<?php echo site_url('admin/content/share'); ?>" enctype="multipart/form-data">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">
                        <?php echo $this->lang->line('share_selected'); ?>
                    </h4>
                </div>
                <div class="modal-body">
                    <div class="row">
                            ...
                            <div class="nav-tabs-radio" role="tablist">
                                <div class="form-group">
                                    <label for="input-type">
                                        <?php echo $this->lang->line('send_to'); ?> <small class="text-danger">
                                            *</small>
                                    </label>
                                        ...
                                        <div class="col-md-4">
                                            <label class="radio-inline">
                                                <input value="group" name="send_to" type="radio"
                                                    data-target="#share_group" checked="checked" />
                                        ...
                                        <div class="col-md-4">
                                            <label class="radio-inline">
                                                <input value="individual" name="send_to" type="radio"
                                                    data-target="#share_individual" />
                                                <?php echo $this->lang->line('individual'); ?>
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        <div class="well minheight303">
                                            <div class="checkbox mt0">
                                                <label><input type="checkbox" name="user[]" value="student"> <b>
                                            ...
                                            if ($sch_setting->guardian_name) { ?>
                                                <div class="checkbox">
                                                    <label><input type="checkbox" name="user[]" value="parent"> <b>
                                                            <?php echo $this->lang->line('guardians'); ?>
                                                        </b></label>
                                                </div>
                                            <?php }
                                            ?>
                                                ...
                                                if ($role_value["name"] != 'Super Admin' || $superadmin_restriction != 'disabled') { ?>
                                                    ...
                                                    <div class="checkbox">
                                                        <label><input type="checkbox" name="user[]"
                                                                value="<?php echo $role_value['id']; ?>"> <b>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            <div class="input-group-btn bs-dropdown-to-select-group">
                                                <button type="button"
                                                    class="btn btn-default btn-searchsm dropdown-toggle as-is bs-dropdown-to-select"
                                                ...
                                                <ul class="dropdown-menu" role="menu" style="">
                                                    <li data-value="student"><a href="#">
                                                            <?php echo $this->lang->line('students'); ?>
                                                        </a></li>
                                                    <?php
                                                    if ($sch_setting->guardian_name) {
                                                        ?>
                                                        <li data-value="parent"><a href="#">
                                                                <?php echo $this->lang->line('guardians'); ?>
                                                            </a></li>
                                                        <li data-value="student_guardian"><a href="#">
                                                                <?php echo $this->lang->line('students_guardians'); ?>
                                                            </a></li>
                                                        <?php
                                                    }
                                                    ?>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="input-group">
                                                        ...
                                                        <div class="input-group-btn"><span 
                                                                class="btn btn-default input-group-addon bright"><i
                                    ...
                                    <div class="dual-list list-right">
                                        <div class="well minheight260">
                                            <div class="wellscroll">
                                                ...
                                                </b> <small class="text-danger"> *</small>
...
<div class="modal fade" id="single-delete" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>
                    <?php echo $this->lang->line('you_are_about_to_delete'); ?> <b><i class="title"></i></b> ,
                    <?php echo $this->lang->line('this_procedure_is_irreversible_do_you_want_to_proceed'); ?>
                </p>
            </div>
            <div class="modal-footer">
...
<div class="modal fade" id="confirm-delete" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>
                    <?php echo $this->lang->line('you_are_about_to_delete'); ?>
                </p>
