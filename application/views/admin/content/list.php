                                            ...
                                            <div class="box box-primary">
                                                <div class="box-header ptbnull">
                                                    <h5 class="box-title titlefix">
                                                        <?php echo $this->lang->line('content_share_list'); ?>
                                                    </h5>
                                                    <hr>
                                                    <div class="box-tools ">
                                                    </div><!-- /.box-tools -->
                                                ...
                                                <div class="box-body">
                                                    <div class="table-responsive mailbox-messages overflow-visible-lg">
                                                        <table
                                                            class="table table-striped  nowrap table table-hover content-list"
                                                            data-export-title="<?php echo $this->lang->line('content_share_list'); ?>">
                                                            <thead>
                                                                <tr>
                                                                    <th>
                                                                    ...
                                                                    <th>
                                                                        <?php echo $this->lang->line('shared_by'); ?>
                                                                    </th>
                                                                    <th>
            ...
            <div class="modal-dialog modal-xl">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" autocomplete="off">×</button>
                        <h4 class="modal-title">
                            <?php echo $this->lang->line('shared_contents'); ?>
                        </h4>
                    </div>
