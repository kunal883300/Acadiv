                ...
                <div class="col-md-4">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h5 class="box-title"><?php echo $this->lang->line('add_subject_group'); ?></h5>
                            <hr>
                        </div><!-- /.box-header -->
...
if (set_value('class_id') == $class['id']) {
    ...
    ?>
                                ...
                                <div class="form-group"> <!-- Radio group !-->
                                    <label class="control-label"><?php echo $this->lang->line('sections'); ?></label><small class="text-danger"> *</small>
                                ...
                                <div class="form-group">
                                    <label for="exampleInputEmail1"><?php echo $this->lang->line('subject') ?></label><small class="text-danger"> *</small>
...
?>">
                ...
                <div class="box box-primary" id="subject_list">
                    <div class="box-header ptbnull">
                        <h5 class="box-title titlefix"><?php echo $this->lang->line('subject_group_list'); ?></h5>
                        <hr>
...
foreach ($subjectgroup->group_subject as $group_subject_key => $group_subject_value) {
    ...
    ?>
                                            ...
                                            <td class="mailbox-date  no_print">
                                                <?php
if ($this->rbac->hasPrivilege('subject_group', 'can_edit')) {
        ?>
                                                    <a href="<?php echo base_url(); ?>admin/subjectgroup/edit/<?php echo $subjectgroup->id; ?>" class="btn btn-icon btn-sm btn-white btn-dim btn-outline-primary p-1" data-bs-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>">
...
if ($this->rbac->hasPrivilege('subject_group', 'can_delete')) {
        ?>
                                                    <a  href="<?php echo base_url(); ?>admin/subjectgroup/delete/<?php echo $subjectgroup->id; ?>"class="btn btn-icon btn-sm btn-white btn-dim btn-outline-danger p-1" data-bs-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('<?php echo $this->lang->line('delete_confirm') ?>');">
