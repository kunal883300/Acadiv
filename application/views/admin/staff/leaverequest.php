                ...
                <div class="box box-primary">
                    ...
                    <div class="row">
                                                  <div class="col">
                                                      ...
                                                      <h5 class="box-title titlefix"><?php echo $this->lang->line('leaves'); ?> </h5>

                                                          <?php if ($this->rbac->hasPrivilege('visitor_book', 'can_add')) { ?>
                                                            <small class="pull-right"><a href="#addleave" data-bs-toggle="modal" data-bs-target="#addleave" onclick="addLeave()" role="button" class="btn btn-primary btn-sm checkbox-toggle pull-right edit_setting" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> <?php echo $this->lang->line('processing'); ?>"><?php echo $this->lang->line('apply_leave'); ?></a></small>
                                                          <?php } ?>
                                                      </div><!-- /.box-header -->
                                                      <hr>
                                                  </div>
            ...
            <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="form-group  col-xs-12 col-sm-12 col-md-12 col-lg-6">
                            ...
                            <input type="text" id="applieddate" name="applieddate" value="" class="form-control date-picker" readonly="readonly">
                        </div>
                        <div class="form-group  col-xs-12 col-sm-12 col-md-12 col-lg-6 ">
                            <label>
                                <?php echo $this->lang->line('available_leave'); ?></label><small class="text-danger"> *</small>
                            <div id="leavetypeddl">
