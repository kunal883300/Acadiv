															...
															<?php
																...
																<div class="col-md-3">
																	<div class="form-group">
																		...
																		<input autofocus="" id="employee_id" name="employee_id"  placeholder="" type="text" class="form-control"  value="<?php echo $staff["employee_id"] ?>" />
																		...
																		foreach ($getStaffRole as $key => $role) {
																			if ($role["id"] == "7") {
																				...
																				if ($staff["user_type"] == $role["type"]) {
																					// Super Admin sees only their role as selected
																					echo '<option value="' . $role["id"] . '" selected>' . $role["type"] . '</option>';
																				} 
																				// No need for else, as other users shouldn't see the Super Admin role at all
																			} else {
																				// Render all other roles normally, but not for Super Admin
																				if ($staff["user_type"] != "Super Admin") {
																					echo '<option value="' . $role["id"] . '" ' . ($staff["user_type"] == $role["type"] ? "selected" : "") . '>' . $role["type"] . '</option>';
																				}
																			}
																		}
																		?>
														...
														<div class="row">
															<div class="col-md-3">
																<div class="form-group">
																	...
																	<input id="name" name="name" placeholder="" type="text" class="form-control"  value="<?php echo set_value('name', $staff["name"]); ?>" />
														...
														<div class="row">
															<div class="col-md-3">
																<div class="form-group">
																	...
																	<?php if($staff['role_id'] == "7"){?>
																	<input id="email" name="email" placeholder="" type="text" class="form-control"  value="<?php echo set_value('email', $staff["email"]); ?>" readonly />
																	<?php }else{?>
															...
															<div class="col-md-3">
																<div class="form-group">
																	...
																	<input id="dob" name="dob" placeholder="" type="text" class="form-control date-picker"  value="<?php
																		if (!empty($staff["dob"])) {
															...
															<?php if ($sch_setting->staff_date_of_joining) {?>
																<div class="col-md-3">
																	<div class="form-group">
																		...
																		<input id="date_of_joining" name="date_of_joining" placeholder="" type="text" class="form-control date-picker"  value="<?php
																...
																<div class="col-md-6">
																	<div class="form-group">
																		...
																		<div class="form-control-wrap">
																			<textarea id="default-textarea" name="address" class="form-control custom-textarea"><?php echo set_value('address', $staff["local_address"]) ?></textarea>
																		</div>
															...
															<?php }if ($sch_setting->staff_permanent_address) {?>
																<div class="col-md-6">
																	<div class="form-group">
																		...
																		<div><textarea name="permanent_address" class="form-control custom-textarea"><?php echo set_value('permanent_address', $staff["permanent_address"]); ?></textarea>
																		</div>
																		<span class="text-danger"></span></div>
																</div>
															<?php }if ($sch_setting->staff_qualification) {?>
																<div class="col-md-3">
																	...
																	<div class="form-group">
																		...
																		<textarea id="qualification" name="qualification" placeholder=""  class="form-control custom-textarea" ><?php echo set_value('qualification', $staff["qualification"]); ?></textarea>
															...
															<?php }if ($sch_setting->staff_work_experience) {?>
																<div class="col-md-3">
																	...
																	<div class="form-group">
																		...
																		<textarea id="work_exp" name="work_exp" placeholder="" class="form-control custom-textarea"><?php echo set_value('work_exp', $staff["work_exp"]) ?></textarea>
															...
															<?php }if ($sch_setting->staff_note) {?>
																<div class="col-md-6">
																	<div class="form-group">
																		...
																		<div><textarea name="note" class="form-control custom-textarea"><?php echo set_value('note', $staff["note"]) ?></textarea>
																		</div>
																		<span class="text-danger"></span></div>
																</div>
															<?php }?>
														  ...
														  <div class="accordion-inner">
															<div class="mb-3">
																...
																<div class="row">
																	...
																	<div class="col-md-4">
																		<div class="form-group">
																			<label for="exampleInputEmail1" class="form-label"><?php echo $this->lang->line('date_of_leaving'); ?></label>
																			<input id="date_of_leaving" name="date_of_leaving" placeholder="" type="text" class="form-control date-picker"  value="<?php
