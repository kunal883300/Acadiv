                ...
                <div class="box box-primary">
                    ...
                    <div class="row">
                                                  <div class="col">
                                                      ...
                                                      <h5 class="box-title titlefix pt5"><?php echo $this->lang->line('approve_leave_request'); ?></h5>

                                                          <?php if ($this->rbac->hasPrivilege('visitor_book', 'can_add')) { ?>
                                                            <small class="pull-right"><a href="#addleave" onclick="addLeave()" data-bs-target="#addleave"  data-bs-toggle="modal" role="button" class="btn btn-primary btn-sm checkbox-toggle pull-right edit_setting" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> <?php echo $this->lang->line('processing'); ?>"><?php echo $this->lang->line('add_leave_request'); ?></a></small>
...
<div id="addleave" class="modal fade " role="dialog">
                ...
                <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="form-group   col-sm-6 col-md-6 col-xs-6">
                            <label>
                                <?php echo $this->lang->line('role'); ?></label><small class="text-danger"> *</small>
    ...
    ?>
                        ...
                        <div class="form-group   col-sm-6 col-md-6 col-xs-6">
                            <label><?php echo $this->lang->line('apply_date'); ?></label><small class="text-danger"> *</small>
                            <input type="text" id="applieddate" name="applieddate" value="<?php echo date($this->customlib->getSchoolDateFormat()) ?>" class="form-control date-picker">
                        </div>
                        <div class="form-group  col-xs-12 col-sm-12 col-md-12 col-lg-6 ">
                            <label>
                                <?php echo $this->lang->line('leave_type'); ?></label><small class="text-danger"> *</small>
                            <div id="leavetypeddl">
...
?>
                          ...
                          <div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-6">
                            <label><?php echo $this->lang->line('leave_from_date'); ?></label><small class="text-danger"> *</small>
                                <input type="text" readonly id="leave_from_date" name="leave_from_date" class="form-control date-picker" >
                            <!-- /.input group -->
                        </div>
                         <div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-6">
                            <label><?php echo $this->lang->line('leave_to_date'); ?></label><small class="text-danger"> *</small>
                                <input type="text" readonly id="leave_to_date" name="leave_to_date" class="form-control date-picker" >
                            <!-- /.input group -->
                        </div>
                        <div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-6">
