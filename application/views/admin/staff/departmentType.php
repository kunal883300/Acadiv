       ...
       <div class="card-inner">
                ...
                <div class="box box-primary" id="tachelist">
                    <div class="box-header ptbnull">
                        <h5 class="box-title titlefix"><?php echo $this->lang->line('department_list'); ?>s</h5>
                        <hr>
                    </div>
                    <div class="box-body">
...
foreach ($departmenttype as $value) {
    ...
    ?>
        ...
        ?>
                                                    <a href="<?php echo base_url(); ?>admin/department/departmentedit/<?php echo $value['id'] ?>" class="btn btn-icon btn-sm btn-white btn-dim btn-outline-primary p-1"  data-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>">
                                                    <em class="ni ni-edit"></em>
                                                    </a>
                                                <?php }if ($this->rbac->hasPrivilege('department', 'can_delete')) {
        ?>
                                                    <a href="<?php echo base_url(); ?>admin/department/departmentdelete/<?php echo $value['id'] ?>" class="btn btn-icon btn-sm btn-white btn-dim btn-outline-danger p-1"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('<?php echo $this->lang->line('delete_confirm') ?>')";>
