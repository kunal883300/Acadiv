                                    ...
                                    ?>
                                        <div class="nav-tabs-custom theme-shadow">
                                            <ul class="nav nav-tabs mt-n3">
                                                <li class="active nav-item"><a class="nav-link active" href="#tab_1" data-bs-toggle="tab" aria-expanded="false"><i class="fa fa-newspaper-o"></i> <?php echo $this->lang->line('card_view'); ?></a></li>
                                                <li class="nav-item"><a class="nav-link" href="#tab_2" data-bs-toggle="tab" aria-expanded="true"><i class="fa fa-list"></i> <?php echo $this->lang->line('list_view'); ?></a></li>
                                            </ul>
                                                                    ...
                                                                    <div class="col-lg-3 col-md-6 col-sm-6 img_div_modal">
                                                                        <div class="staffinfo-box">
                                                                            ...
                                                                            <div class="staffleft-content">
                                                                                ...
                                                                                <p>
                                                                                    <font data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> <?php echo $this->lang->line('processing'); ?>"><?php echo $staff["employee_id"] ?></font>
                                                                                </p>

                                                                                <p>
                                                                                    <font data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> <?php echo $this->lang->line('processing'); ?>"><?php echo $staff["contact_no"] ?></font>
                                                                                </p>

                                                                                <p>
                                                                                    <font data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> <?php echo $this->lang->line('processing'); ?>"><?php
                                                                                                                                                                                                            if (!empty($staff["location"])) {
                                                                                                                                                                                                                echo $staff["location"] . ",";
                                                                                                                                                                                                            }
                                                                                                                                                                                                            ?></font>
                                                                                    <font data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> <?php echo $this->lang->line('processing'); ?>"> <?php echo $staff["department"]; ?></font>
                                                                                </p>
                                                                                ...
                                                                                <p class="staffsub"><span data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> <?php echo $this->lang->line('processing'); ?>"><?php echo $staff["user_type"] ?></span>
                                                                                    ...
                                                                                    <span data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> <?php echo $this->lang->line('processing'); ?>"><?php echo $staff["designation"] ?></span>
                                                                                </p>
                                                                            </div>
                                                                            <div class="overlay3">
