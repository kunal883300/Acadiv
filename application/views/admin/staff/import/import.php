                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="box box-info" style="padding:5px;">
                                            ...
                                            <div class="pull-right box-tools">
                                                <a href="<?php echo site_url('admin/staff/exportformat') ?>">
                                                    <button class="btn btn-primary btn-sm"><i
                                                        ...
                                                        <?php echo $this->lang->line('download_sample_import_file'); ?></button>
                                                </a>
                                            </div>
                                        </div>
                                        <div class="box-body">
                                                ...
                                                <thead>
                                                    <tr>
                                                        ...
                                                        foreach ($field as $key => $value) {
                                                            ...
                                                            ?>
                                                            <th><?php echo "<span>" . $this->lang->line($value) . "</span>" . $req; ?>
                                                            </th>
                                                        <?php } ?>
                                                    </tr>
                                                </thead>
                                        ...
                                        <hr />
                                        <form action="<?php echo site_url('admin/staff/import') ?>" id="employeeform"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <select id="designation" name="designation" placeholder=""
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <select id="department" name="department" placeholder=""
                                                                type="text" class="form-control">
                                                                <option value="select">
                                                                    <?php echo $this->lang->line('select') ?></option>
                                                                <?php foreach ($department as $key => $value) {
                                                                    ?>
                                                                    <option value="<?php echo $value["id"] ?>" <?php echo set_select('department', $value['id'], set_value('department')); ?>>
                                                            ...
                                                            <span
                                                                class="text-danger"><?php echo form_error('department'); ?></span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label
                                                                for="exampleInputFile"><?php echo $this->lang->line('select_csv_file'); ?></label><small
                                                                class="text-danger"> *</small>
                                                    ...
                                                    <div class="col-md-6 pt20">
                                                        <button type="submit" class="btn btn-info pull-right">
                                                            <?php echo $this->lang->line('staff') . " " . $this->lang->line('import'); ?></button>
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
