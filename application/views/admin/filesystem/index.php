                            ...
                            <?php echo $this->customlib->getCSRF(); ?>                          
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                     ...
                                     <div class="form-group">
                                                   <label class="control-label col-md-3 col-sm-3 col-xs-12"><?php echo $this->lang->line('status'); ?><small class="text-danger"> *</small></label>
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
      ...
      <input type="hidden" name="storage_type" value="amazon_s3">
                                    <div class="row">
                                        <div class="minheight170">
                                            <div class="col-md-7">
                                                 <div class="form-group">
                                                    <label class="col-sm-5 control-label">api_key --r<small class="text-danger"> *</small></label>
                                                    <div class="col-sm-7">
                                                     ...
                                                     <div class="form-group">
                                                    <label class="col-sm-5 control-label">secret --r<small class="text-danger"> *</small></label>
                                                    <div class="col-sm-7">
                                             ...
                                             <div class="form-group">
                                                    <label class="col-sm-5 control-label">version --r<small class="text-danger"> *</small></label>
                                                    <div class="col-sm-7">
                                               ...
                                               <div class="form-group">
                                                    <label class="col-sm-5 control-label">region --r<small class="text-danger"> *</small></label>
                                                    <div class="col-sm-7">
                                                    ...
                                                    <div class="form-group">
                                                    <label class="col-sm-5 control-label">bucket --r<small class="text-danger"> *</small></label>
                                                    <div class="col-sm-7">
                                                        ...
                                                        <span class="text text-danger bucket_error"></span>
                                                              ...
                                                              <div class="form-group">
                                                   <label class="col-sm-5 control-label"><?php echo $this->lang->line('status'); ?><small class="text-danger"> *</small></label>
                                                    <div class="col-sm-7">
                                                        <select class="form-control" name="status">
                                                            <?php
                                                            foreach ($statuslist as $s_key => $s_value) {
