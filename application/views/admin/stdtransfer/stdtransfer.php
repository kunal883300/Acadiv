                ...
                <div class="box box-primary">
                    ...
                    <form id='form1' class="stdtransfer " action="<?php echo site_url('admin/stdtransfer/index') ?>"  method="post" accept-charset="utf-8">
                        <div class="box-body">
                            ...
                            <hr>
                            <h5 > <?php echo $this->lang->line('promote_students_in_next_session'); ?></h5> 
                             <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1"><?php echo $this->lang->line('promote_in_session'); ?> </label><small class="text-danger"> *</small>
     ...
     <option value="<?php echo $session['id'] ?>" <?php if (set_value('session_id') == $session['id']) echo "selected=selected"; ?>><?php echo $session['session'] ?></option>
        ...
        <option value="<?php echo $class['id'] ?>" <?php if (set_value('class_promote_id') == $class['id']) echo "selected=selected"; ?>><?php echo $class['class'] ?></option>
                        ...
                        <div class="box-footer">
                            <button type="submit" id="search_btn" class="btn btn-primary btn-sm pull-right my-2"><?php echo $this->lang->line('array_search(needle, haystack)'); ?><?php echo $this->lang->line('search'); ?></button>
                        </div>
                    </form>
                    <?php
                    if (isset($resultlist)) {
                        ?>                      
                        <div class="box-header ptbnull my-5">
                            <h5 class="box-title"><i class="fa fa-list"></i><?php echo $this->lang->line('student_list'); ?>  </h5>
                            <div class="box-tools pull-right">
                            </div>
                        </div>
                        <div class="box-body">
                ...
                <td><?php echo $student['admission_no']; ?></td>
                        ...
                        <div class="box-footer clearfix" >
                            ...
                            if (!empty($resultlist)) {
                                ...
                                <a class="btn btn-sm btn-primary pull-right" data-bs-toggle="modal" data-bs-target="#pramoteStudentModal"><?php echo $this->lang->line('promote'); ?></a>
                                <?php
                            }
                            ?>
                        </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><?php echo $this->lang->line('promote_confirmation'); ?></h5>
