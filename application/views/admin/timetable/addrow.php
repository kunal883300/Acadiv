...
<div class="row clearfix">
    <div class="col-md-12">
        <a id="add_row" class="addrow addbtnright btn btn-primary btn-sm pull-right mb-2"><i class="fa fa-plus"></i> <?php echo $this->lang->line('add_new'); ?></a>
        <form method="POST" action="<?php echo site_url('admin/timetable/savetimetable'); ?>" id="form_<?php echo $day; ?>" class="autoscroll">
                            ...
                            <tr id='addr0'>
									...
									<div class="form-group">
										<div class="form-control-wrap">
											<div class="input-group">
												<input type="text" name="time_from_<?php echo $counter; ?>" class="form-control time_from time-picker" id="time_from_<?php echo $counter; ?>" value="<?php echo ($prev_rec_value->start_time != "") ? $prev_rec_value->time_from :  $this->customlib->timeFormat($prev_rec_value->start_time);?>">
                                ...
                                <td>
									<div class="form-group">
										<div class="form-control-wrap">
											<div class="input-group">
												<input type="text" name="time_to_<?php echo $counter; ?>" class="form-control time_to time-picker" id="time_to_<?php echo $counter; ?>" value="<?php echo ($prev_rec_value->end_time != "") ? $prev_rec_value->time_to :  $this->customlib->timeFormat($prev_rec_value->end_time);?>">
												<div class="input-group-append">
													<span class="input-group-text"><em class="ni ni-clock"></em></span>
												</div>
											</div>
                        ...
                        <tr id='addr0'>
                            ...
                            <td>
								<div class="form-group">
									<div class="form-control-wrap">
										<div class="input-group">
											<input type="text" name="time_from_<?php echo $total_count; ?>" class="form-control time_from time-picker" id="time_from_<?php echo $total_count; ?>" aria-invalid="false">
											<div class="input-group-append">
												<span class="input-group-text"><em class="ni ni-clock"></em></span>
											</div>
										</div>
                            ...
                            <td>
								...
								<div class="form-control-wrap">
                                <div class="input-group">
                                    <input type="text" name="time_to_<?php echo $total_count; ?>" class="form-control time_to time-picker" id="time_to_<?php echo $total_count; ?>" aria-invalid="false">
                                    <div class="input-group-append">
                                        <span class="input-group-text"><em class="ni ni-clock"></em></span>
                                    </div>
                                </div>
