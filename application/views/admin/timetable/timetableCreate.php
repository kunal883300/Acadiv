						...
						<div class="col-md-12">
								...
								<form class="create_time_table" action="<?php echo site_url('admin/timetable/create') ?>" method="post" accept-charset="utf-8">
									<div class="box-body">
										...
										<div class="row">
											...
											<div class="col-md-4">
												<div class="form-group">
													<label><?php echo $this->lang->line('subject_group'); ?><small class="text-danger"> *</small></label>
									...
									<div class="box-footer">
										<button type="submit" id="insertbtn" class="btn btn-primary pull-right btn-sm my-2"><?php echo $this->lang->line('search'); ?></button>
									</div>
								</form>
								<?php
									if (isset($getDaysnameList)) {
									?>
								<div class="box-header with-border mt-5 mb-2">
									<h5 class="box-title"><?php echo $this->lang->line('select_parameter_to_generate_time_table_quickly'); ?></h5>
								</div>
								<div class="box-header ptbnull">
									<form action="#" method="POST" id="universal_from">
										<div class="row">
											<div class="col-sm-2">
												<div class="form-group">
													<label for="start_time"><?php echo $this->lang->line('period_start_time'); ?><small class="text-danger"> *</small></label>
													<div class="form-control-wrap">
														<div class="input-group">
															<input type="text" id="start_time"name="start_time" class="form-control time-picker" value="">
															<div class="input-group-append">
																<span class="input-group-text"><em class="ni ni-clock"></em></span>
															</div>
														</div>
													</div>
											...
											<div class="col-sm-2">
												<div class="form-group">
													<label for="form_email"><?php echo $this->lang->line('duration_minute'); ?><small class="text-danger"> *</small></label>                     
													<div class="form-control-wrap">
														<div class="input-group">
															<input type="number" name="duration" class="form-control" id="duration" value="">
															<div class="input-group-append">
																<span class="input-group-text fa fa-hourglass-start"></span>
															</div>
														</div>
													</div>
													<div class="text text-danger"></div>
											...
											<div class="col-sm-2">
												<div class="form-group">
													<label for="form_phone"><?php echo $this->lang->line('interval_minute'); ?><small class="text-danger"> *</small></label>
													<div class="form-control-wrap">
														<div class="input-group">
											...
											<div class="col-sm-2">
												<div class="form-group">
													...
													<input type="submit" class="btn btn-primary btn-sm btn-send mt-4" value="<?php echo $this->lang->line('apply'); ?>">
													<div class="help-block with-errors"></div>
												</div>
											</div>
										</div>
								...
								<ul class="nav nav-tabs">
									...
									foreach ($getDaysnameList as $days_key => $days_value) {
										...
										?>
									<li class="nav-item">
										<a class="nav-link" data-bs-toggle="tab" href="#tab_<?php echo $count; ?>" data-c="<?php echo set_value('class_id'); ?>" data-days="<?php echo $days_value; ?>" data-s="<?php echo set_value('section_id'); ?>" data-group="<?php echo set_value('subject_group_id'); ?>" data-day="<?php echo $days_key; ?>" data-toggle="tab" aria-expanded="true"><?php echo $days_value; ?></a>
									</li>
									<?php
									$count++;
										}
	...
	$(document).on('submit','.create_time_table',function(e){
	    document.getElementById("insertbtn").disabled = true;
	            ...
	            /*$(document).on('focus', '.time', function () {
	                var timepickerinst = $(this);
	                timepickerinst.datetimepicker({
	                    format: 'LT'
	                });
	            });*/
	            var tot_count = 0;
	            ...
	            $(document).ready(function () {
	                ...
	                $(document).on("click", ".addrow", function () {                       
	                    ...
	                    cols += '<td><div class="form-control-wrap"><div class="input-group"><input type="text" name="time_from_' + tot_count + '" class="form-control time_from time-picker" id="time_from_' + tot_count + '"  ><div class="input-group-append"><span class="input-group-text"><em class="ni ni-clock"></em></span></div></div></span></div></td>';
	
	                    cols += '<td><div class="form-control-wrap"><div class="input-group"><input type="text" name="time_to_' + tot_count + '" class="form-control time_to time-picker" id="time_to_' + tot_count + '" ><div class="input-group-append"><span class="input-group-text"><em class="ni ni-clock"></em></span></div></div></span></div></td>';
...
<script type="text/javascript">
	...
	let start_time= $('#start_time',form).val();
	 ...
	 $('tbody  > tr',interest).each(function() {
	    ...
	    start_time=moment(new_time, "hh:mm A").add(interval, 'minutes').format('hh:mm A');
	 });
	}
	});
	});
