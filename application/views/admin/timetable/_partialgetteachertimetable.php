...
if (!empty($timetable)) {
    ...
    <table class="table table-stripped fs-12px">
        <thead>
            <tr>
                <?php
                        ...
                        ?>
                            ...
                            ?>
                                <div class="clearfix border p-1 mb-1 text-teal">
                                    <div class="relative attachment-left-space"><i class="fa fa-book text-gray me-1"></i><?php echo $this->lang->line('class') ?>: <?php echo $tm_kue->class . "(" . $tm_kue->section . ")"; ?>
                                    ...
                                    <div class="relative attachment-left-space"><i class="fa fa-clock-o text-gray me-1"></i><?php echo $tm_kue->time_from ?>
                                        <b class="text text-center">-</b>
                                        <strong><?php echo $tm_kue->time_to; ?></strong>
                                    </div>
                                    <div class="relative attachment-left-space"><i class="fa fa-building text-gray me-1"></i><?php echo $this->lang->line('room_no') ?>: <?php echo $tm_kue->room_no; ?></div>
