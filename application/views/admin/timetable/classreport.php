                        ...
                        <div class="card-inner">
                            <div class="row">
                                <div class="col-md-12">
                                            ...
                                            <div class="col">
                                                <div
                                                    ...
                                                    <?php if ($this->rbac->hasPrivilege('visitor_book', 'can_add')) { ?>
                                                        <a href="<?php echo site_url('admin/timetable/create') ?>"
                                    ...
                                    <form class="mb-4" action="<?php echo site_url('admin/timetable/classreport') ?>"
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select autofocus="" id="class_id" name="class_id"
                                                        class="form-control">
                                        ...
                                        <div class="box-footer">
                                            <button type="submit" class="btn btn-primary pull-right btn-sm my-2"
                                        ...
                                        <div class="box-body mt-5">
                                            ...
                                            if (!empty($timetable)) {
                                                ...
                                                <div class="row">
                                                    <div
                                                        class="box-header ptbnull d-flex justify-content-between align-items-center">
                                                        <button type="submit" title="<?php echo $this->lang->line('print'); ?>"
                                                            class="btn btn-primary btn-sm float-end print_timetable"
                                                            data-class_id="<?php echo set_value('class_id'); ?>"
                                                            data-section_id="<?php echo set_value('section_id'); ?>" id="load"
                                                            data-loading-text="<i class='fa fa-spinner fa-spin'></i> <?php echo $this->lang->line('please_wait'); ?>"><i
                                                                class="fa fa-print"></i></button>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <table class="table table-stripped fs-11px">
                                                        <thead>
                                                            <tr>
                                                                <?php
                                                                foreach ($timetable as $tm_key => $tm_value) {
                                                                    ?>
                                                                    <th class="text">
                                                                        <?php echo $this->lang->line(strtolower($tm_key)); ?></th>
                                                                    <?php
                                                                }
                                                                ?>
                                                            </tr>
                                                                        ...
                                                                        if (!$timetable[$tm_key]) {
                                                                            ...
                                                                            <div class="attachment-block block-b-noraml clearfix">
                                                                                <b class="text text-danger"><i
                                                                                    ...
                                                                                    <?php echo $this->lang->line('not_scheduled'); ?></b><br>
                                                                            </div>
                                                                            <?php
                                                                        } else {
                                                                            foreach ($timetable[$tm_key] as $tm_k => $tm_kue) {
                                                                                ?>
                                                                                <div class="clearfix border p-1 mb-1 text-teal">

                                                                                    <div class=""><i class="fa fa-book"></i>
                                                                                    ...
                                                                                    <div class="relative attachment-left-space"><i
                                                                                        ...
                                                                                        <?php echo $tm_kue->time_from ?>
                                                                                        <b class="text text-center">-</b>
                                                                                        <strong
                                                                                            class=""><?php echo $tm_kue->time_to; ?></strong>
                                                                                    </div>

                                                                                    <div class="relative attachment-left-space"><i
                                                                                            class="fa fa-user"></i>
                                                                                        <?php echo $tm_kue->name . " " . $tm_kue->surname . " (" . $tm_kue->employee_id . ")"; ?>
                                                                                    </div>
                                                                                    <div class="relative attachment-left-space"><i
                                                                                            class="fa fa-building"></i>
                                                                                        <?php echo $this->lang->line('room_no'); ?>:
                                                                                        <?php echo $tm_kue->room_no; ?></div>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $(document).on("click", ".addrow", function () {
            ...
            cols += '<td> <div class = "input-group" > < input type = "text" name = "time_from_' + tot_count + '" class = "form-control time_from time-picker" id = "time_from_' + tot_count + '" aria - invalid = "false" ><div class = "input-group-addon" > < span class = "glyphicon glyphicon-dashboard" > < /span></div ></div> </td>';

            cols += '<td> <div class = "input-group" > < input type = "text" name = "time_to_' + tot_count + '"class = "form-control time_to time-picker" id = "time_to_' + tot_count + ' "aria - invalid = "false" ><div class = "input-group-addon" > < span class = "glyphicon glyphicon-dashboard"> </span></div></div> </td>';
