...
<div class="col-sm-12">
    <div class="form-group">
        <label for="email"><?php echo $this->lang->line('description'); ?></label><small class="text-danger"> *</small>
        <textarea name="description" id="compose-textarea" class="form-control" ><?php echo $result['question'] ?></textarea>
    </div>
</div>
<div class="col-sm-6">
    <div class="form-group">
        <label for="email"><?php echo $this->lang->line('subject'); ?></label><small class="text-danger"> *</small>
...
<div class="col-sm-6">
    <div class="form-group" id="extraoption">
        <label for="email"><?php echo $this->lang->line('option'); ?></label><small class="text-danger"> *</small></br>
