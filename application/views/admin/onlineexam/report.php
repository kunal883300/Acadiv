    ...
    $this->session->unset_userdata('msg'); ?>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1"><?php echo $this->lang->line('exam') ?><small class="text-danger"> *</small></label>
...
?>
                                ...
                                <div class="col-sm-12 my-2">
                                    <div class="form-group">
                                        <button type="submit" name="action" value ="search" class="btn btn-primary pull-right my-3 mx-3  btn-sm"><i class="fa fa-search"></i> <?php echo $this->lang->line('search'); ?></button>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="">
                                ...
                                <div class="box-header with-border">
                                    <br>
                                    <h5 class="box-title titlefix"> <?php echo $this->lang->line('result_report'); ?></h5>
                                    <hr>
                                </div>
                                <div class="box-body">
                                <div class="card card-bordered h-100 shadow-sm" >
