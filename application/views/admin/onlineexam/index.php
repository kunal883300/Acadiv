...
<div class="nk-content">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="nav-tabs-custom theme-shadow">
                                                ...
                                                <button class="btn btn-primary btn-sm pull-right question-btn" data-bs-recordid="0"><i class="fa fa-plus"></i> <?php echo $this->lang->line('add_exam'); ?></button>
                                                    <h5 class="box-title titlefix pt5"> <?php echo $this->lang->line('online_exam_list'); ?></h5>
                                                    <hr>
                                                    ...
                                                    ?>
                                                            ...
                                                            <ul class="nav nav-tabs ">
                                                                ...
                                                                <li class="nav-item active"><a class= "nav-link" href="#tab_2" class="upcoming-exam" data-bs-toggle="tab"><?php echo $this->lang->line('upcoming_exams');  ?></a></li>
                                                               
                                                                <li class="nav-item"><a class= "nav-link" href="#tab_3" class="closed-exam"  data-bs-toggle="tab"><?php echo $this->lang->line('closed_exams'); ?></a></li>
                                                            </ul>
                                                                        ...
                                                                        <div class="card card-bordered h-100 shadow-sm">
                                                                            <div class="card-inner">
                                                                                ...
                                                                                <div class="mailbox-messages">
                                                                                    ...
                                                                                    <table class="datatable-init-export nowrap table  exam-list" data-export-title="<?php echo $this->lang->line('online_exam_list'); ?>">
                                                                                            <thead>
                                                                                                <tr>
    ...
    <div id="myModal" class="modal " role="dialog">
        <div class="modal-dialog modal-lg">
            ...
            <div class="modal-content">
                ...
                <h5 class="modal-title"><?php echo $this->lang->line('exam') ?></h5>
                ...
                <form action="<?php echo site_url('admin/onlineexam/add'); ?>" method="POST" id="formsubject">
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label for="exam"><?php echo $this->lang->line('exam_title'); ?></label><small class="text-danger"> *</small>
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label for="exam_from"><?php echo $this->lang->line('exam_from'); ?></label><small class="text-danger"> *</small>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label for="exam_to"><?php echo $this->lang->line('exam_to'); ?></label><small class="text-danger"> *</small>
                                    <div class="input-group">
                        ...
                        <div class="row">
                            <div class="col-sm-3">
                                <div class="form-group">
                                    <label for="duration"><?php echo $this->lang->line('time_duration'); ?></label><small class="text-danger"> *</small>
                                    <input type="text" class="form-control time-picker"  name="duration">
                                </div>
                            </div>
                            <div class="col-sm-3">
                                <div class="form-group">
                                    <label for="attempt"><?php echo $this->lang->line('attempt'); ?></label><small class="text-danger"> *</small>
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    <label for="attempt"><?php echo $this->lang->line('passing_percentage'); ?></label><small class="text-danger"> *</small>
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    <label for="attempt"><?php echo $this->lang->line('answer_word_limit'); ?></label><small class="text-danger"> *</small>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label for="description"><?php echo $this->lang->line('description'); ?><small class="text-danger"> *</small></label>
    ...
    <div id="myQuestionModal" class="modal " role="dialog">
                            ...
                            <div class="col-md-3 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="search_box" id="search_box" style="display: inline-block;">
                                        ...
                                        ?>
                                            <option value="<?php echo $subject_value['id']; ?>"><?php echo $subject_value['name']; ?> <?php if ($subject_value['code']) {
...
<div id="myQuestionListModal" class="modal ">
    <div class="modal-dialog modal-xl">
        <!-- Modal content-->
        <div class="modal-content">
            <div class="modal-header">
...
<!-- Modal -->
<div id="myGenerateRankModal" class="modal " role="dialog">
    <div class="modal-dialog modal-lg">
        <!-- Modal content-->
        <div class="modal-content">
            <div class="modal-header">
