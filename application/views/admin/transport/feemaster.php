                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="box-header ptbnull d-flex justify-content-between align-items-center">
                                            <h5 class="box-title titlefix"><?php echo $this->lang->line('transport_fees_master'); ?></h5>
                                            <a target="_blank" href="<?php echo base_url(); ?>admin/transport/bulk_fees_master">
                                            <button class="btn btn-primary">Bulk Fees Upload</button>
                                            </a>
                                        </div>
                                        <hr>
                                        <hr>
                                        ...
                                        <form action="" id="fee_form" method="POST">
                                                    ...
                                                    ?>
                                                        ...
                                                        <div class="row block_row">
                                                            ...
                                                            <div class="col-sm-10 col-lg-1 col-md-2 ">
                                                                <h6 class="transport_fee_line"><?php echo $month_value; ?></h6>
                                                            </div>
                                                            <div class="col-sm-11 col-lg-11 col-md-11">
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-2">
                                                                        ...
                                                                        <div class="form-group">
                                                                            <label class="radio-inline">
                                                                                <input name="fine_type_<?php echo $count; ?>" class="finetype" id="input-type-tutor" value="" type="radio" <?php echo ($inserted_array['fine_type'] == "") ? "checked" : "" ?>><?php echo $this->lang->line('none'); ?> </label>
                                                                        </div>
                                                                    </div>

                                                                    <div class="col-sm-4">
                                                                        <label class="radio-inline pt4">
                                                                            <input name="fine_type_<?php echo $count; ?>" class="finetype" id="input-type-student" value="percentage" type="radio" <?php echo ($inserted_array['fine_type'] == "percentage") ? "checked" : "" ?>><?php echo $this->lang->line('percentage'); ?> (%)
                                                                        </label>
                                                                        <input id="percentage" name="percentage_<?php echo $count; ?>" type="text" class="form-control percentage" value="<?php echo set_value("percentage_" . $count, $inserted_array['fine_percentage']) ?>" <?php echo ($inserted_array['fine_type'] == "percentage") ? "" : "readonly" ?> autocomplete="off">
                                                                    ...
                                                                    <div class="col-sm-4">
                                                                        ...
                                                                        <input type="text" class="form-control fine_amount" name="fine_amount_<?php echo $count; ?>" id="inputLastname" autocomplete="off" <?php echo ($inserted_array['fine_type'] == "fix") ? "" : "readonly" ?> value="<?php if ($inserted_array['fine_amount']) {
                                                                                                                                                                                                                                                                                                echo set_value("fine_amount_" . $count, convertBaseAmountCurrencyFormat($inserted_array['fine_amount']));
                                                                                                                                                                                                                                                                                            } ?>">
                                            ...
                                            <div class="box-footer">
                                                <?php if ($this->rbac->hasPrivilege('transport_fees_master', 'can_edit')) {  ?>
                                                    <button type="submit" class="btn btn-info pull-right my-2" autocomplete="off"><?php echo $this->lang->line('save'); ?></button>
                                                <?php } ?>
                                            </div>
                                        </form>
