								...
								<div class="col-md-12">
									<div class="nav-tabs-custom">
										<ul class="nav nav-tabs pull-right mt-n3">
											<li class="nav-item"><a class="nav-link" href="#tab_parent" data-bs-toggle="tab"><?php echo $this->lang->line('staff') ?></a></li>
											<li class="nav-item active"><a class="nav-link active" href="#tab_student" data-bs-toggle="tab"><?php echo $this->lang->line('student') ?></a></li>
										</ul>
										<div class="tab-content">
											<div class="tab-pane active " id="tab_student">
												<h5 class="box-title"><?php echo $this->lang->line('system_fields'); ?> </h5><hr>
