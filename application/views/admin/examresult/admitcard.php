                        ...
                        <form role="form" action="<?php echo site_url('admin/examresult/admitcard') ?>" method="post" class="row">
                            ...
                            <div class="col-sm-6 col-lg-4 col-md-4 mb-3">
                                <div class="form-group">
                                    <label ><?php echo $this->lang->line('exam_group'); ?><small class="text-danger"> *</small></label>
...
?>
                            ...
                            <div class="col-sm-6 col-lg-4 col-md-4">
                                <div class="form-group">
                                    <label><?php echo $this->lang->line('exam'); ?><small class="text-danger"> *</small></label>
...
?>
                            ...
                            <div class="col-sm-6 col-lg-4 col-md-4">
                                <div class="form-group">
                                    <label for="exampleInputEmail1"><?php echo $this->lang->line('admit_card_template'); ?><small class="text-danger"> *</small></label>
