    ...
    <div class="container-fluid">
        ...
        <div class="row">
                        ...
                        <form role="form" action="<?php echo site_url('admin/examresult/marksheet') ?>" method="post" class="row">
                            ...
                            <div class="col-sm-6 col-lg-4 col-md-4 mb-2">
                                <div class="form-group">
                                    <label><?php echo $this->lang->line('exam_group'); ?></label><small class="text-danger"> *</small>
                            ...
                            <div class="col-sm-6 col-lg-4 col-md-4">
                                <div class="form-group">   
                                    <label><?php echo $this->lang->line('exam'); ?></label><small class="text-danger"> *</small>
                            ...
                            <div class="col-sm-6 col-lg-4 col-md-4">
                                <div class="form-group">  
                                    <label><?php echo $this->lang->line('session'); ?></label><small class="text-danger"> *</small>
                            ...
                            <div class="col-sm-6 col-lg-4 col-md-4">
                                <div class="form-group">
                                    <label for="exampleInputEmail1"><?php echo $this->lang->line('marksheet_template'); ?></label><small class="text-danger"> *</small>
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <button type="submit" name="search" value="search_filter" class="btn btn-primary pull-right btn-sm checkbox-toggle my-2"><i class="fa fa-search"></i> <?php echo $this->lang->line('search'); ?></button>
                                </div>
                            </div>
                        </form>
                    </div>
            ...
            <?php echo $student_name; ?>            
                       ...
                       <a target="_blank" href="<?php echo base_url('admin/examresult/print_marksheet/'.set_value('marksheet').'/'.$student_value->exam_group_class_batch_exam_student_id.'/'. $student_value->student_id.'/'.$exam_id.'/'.$exam_group_id)?>">View</a>
                       
                       <button  type="button" class="btn btn-default btn-xs " data-action="download" data-bs-toggle="tooltip"  data-original-title="<?php echo $this->lang->line('download'); ?>"  data-exam_group_class_batch_exam_student_id="<?php echo $student_value->exam_group_class_batch_exam_student_id; ?>" data-admission_no="<?php echo $student_value->admission_no;?>" data-student_name="<?php echo $student_name; ?>" data-student_id="<?php echo $student_value->student_id?>" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i>" ><i class="fa fa-download"></i></button>
                       <button  type="button"  class="btn btn-default btn-xs email_pdf" data-action="email" data-exam_group_class_batch_exam_student_id="<?php echo $student_value->exam_group_class_batch_exam_student_id; ?>" id="load1" data-bs-toggle="tooltip"  data-original-title="<?php echo $this->lang->line('sent_to_email'); ?>" data-student_id="<?php echo $student_value->student_id?>" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i>" ><i class="fa fa-envelope"></i></button>
                                                        </td>
                                                    </tr>
                                                    <?php
                                                    $count++;
...
$.ajax({
    ...
    xhr: function () { // To get access to the xhr object
