                                    ...
                                    <div class="row">
                                        <div class="col-md-10">
                                                ...
                                                <div class="card card-bordered h-90 ">
                                                    ...
                                                    <h5 class="box-title titlefix"><?php echo $this->lang->line('payment_methods'); ?></h5><hr>
                                                        <ul class="nav nav-tabs nav-tabs2 mt-n3">
                                                            <li class="active nav-item"><a class= "nav-link active" href="#tab_1" data-bs-toggle="tab"><?php echo $this->lang->line('paypal'); ?></a></li>
                                                            ...
                                                            <li class=" nav-item"><a class= "nav-link" href="#tab_4" data-bs-toggle="tab"><?php echo $this->lang->line('ccavenue'); ?></a></li>
                                                            ...
                                                            <li class=" nav-item"><a class= "nav-link" href="#tab_11" data-bs-toggle="tab"><?php echo $this->lang->line('flutter_wave'); ?> </a></li>
                                                            <li class=" nav-item"><a class= "nav-link" href="#tab_12" data-bs-toggle="tab"><?php echo $this->lang->line('ipay_africa'); ?></a></li>
                                                            <li class=" nav-item"><a class= "nav-link" href="#tab_13" data-bs-toggle="tab"><?php echo $this->lang->line('jazzcash'); ?></a></li>
                                                            <li class=" nav-item"><a class= "nav-link" href="#tab_14" data-bs-toggle="tab"><?php echo $this->lang->line('billplz'); ?></a></li>
                                                            <li class=" nav-item"><a class= "nav-link" href="#tab_15" data-bs-toggle="tab"><?php echo $this->lang->line('sslcommerz'); ?></a></li>
                                                            <li class=" nav-item"><a class= "nav-link" href="#tab_16" data-bs-toggle="tab"><?php echo $this->lang->line('walkingm'); ?></a></li>
                                                            <li class=" nav-item"><a class= "nav-link" href="#tab_17" data-bs-toggle="tab"><?php echo $this->lang->line('mollie'); ?></a></li>
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-md-7">
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <label class="col-sm-5 control-label" for="exampleInputEmail1">
                                                                                        <?php echo $this->lang->line('paypal_username'); ?><small class="text-danger"> *</small>
                                                                                    </label>
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <label class="control-label col-lg-5 col-md-5 col-sm-5" for="exampleInputEmail1">
                                                                                        <?php echo $this->lang->line('paypal_password'); ?><small class="text-danger"> *</small>
                                                                                    </label>
                                                                                    <div class="col-lg-7 col-md-7 col-sm-7">
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <label class="control-label col-lg-5 col-md-5 col-sm-5 col-xs-12" for="exampleInputEmail1">
                                                                                        <?php echo $this->lang->line('paypal_signature'); ?><small class="text-danger"> *</small>
                                                                                    </label>
                                                                            ...
                                                                            <div class="col-md-5 text text-center disblock">
                                                                                <a href="https://www.paypal.com/in/home" target="_blank">
                                                                                    ...
                                                                                    <img src="<?php echo $this->media_storage->getImageURL('backend/images/paypal.png'); ?>" width="200">
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3 pl-sm-6">
                                                                                <?php if ($this->rbac->hasPrivilege('payment_methods', 'can_edit')) { ?>
                                                                                    <button type="submit" class="btn btn-primary paypal_save ml-n1 float-sm-right my-2" data-loading-text="<i class='fa fa-spinner fa-spin '></i> <?php echo $this->lang->line('save'); ?>"><?php echo $this->lang->line('save'); ?></button>
                                                                                <?php } ?>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="box-body minheight149">
                                                                        <div class="row">
                                                                            <div class="col-md-7">
                                                                                ...
                                                                                ?>
                                                                                <div class="form-group">
                                                                                    <label class="col-sm-5 control-label"><?php echo $this->lang->line('stripe_api_secret_key'); ?><small class="text-danger"> *</small></label>
                                                                                    <div class="col-sm-7">
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <label class="col-sm-5 control-label">
                                                                                        <?php echo $this->lang->line('stripe_publishable_key'); ?><small class="text-danger"> *</small></label>
                                                                                    <div class="col-sm-7">
                                                                            ...
                                                                            <div class="col-md-5 text text-center disblock">
                                                                                <a href="https://stripe.com/" target="_blank">
                                                                                    <h5><?php echo $this->lang->line('multinational_payment_gateway'); ?></h5>
                                                                                    <img src="<?php echo $this->media_storage->getImageURL('backend/images/stripe.png') ?>" width="200">
                                                                    ...
                                                                    <div class="box-body minheight149">
                                                                        <div class="row">
                                                                            <div class="col-md-7">
                                                                                ...
                                                                                ?>
                                                                                <div class="form-group">
                                                                                    <label class="col-sm-5 control-label"><?php echo $this->lang->line('payu_money_key'); ?><small class="text-danger"> *</small>
                                                                                    </label>
                                                                                    <div class="col-sm-7">
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <label class="col-sm-5 control-label"><?php echo $this->lang->line('payu_money_salt'); ?><small class="text-danger"> *</small>
                                                                                    </label>
                                                                                    <div class="col-sm-7">
                                                                            ...
                                                                            <div class="col-md-5 text text-center disblock">
                                                                                <a href="https://www.payumoney.com" target="_blank">
                                                                                    ...
                                                                                    <img src="<?php echo $this->media_storage->getImageURL('backend/images/paym.png'); ?>" width="200">
                                                                ...
                                                                <form role="form" id="ccavenue" action="<?php echo site_url('admin/paymentsettings/ccavenue') ?>" class="form-horizontal" method="post">
                                                                    <div class="box-body minheight149">
                                                                        <div class="row">
                                                                            <div class="col-md-7">
                                                                                ...
                                                                                ?>
                                                                                <div class="form-group">
                                                                                    <label class="col-sm-5 control-label"><?php echo $this->lang->line('ccavenue_merchant_id'); ?><small class="text-danger"> *</small>
                                                                                    </label>
                                                                                    <div class="col-sm-7">
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <label class="col-sm-5 control-label"><?php echo $this->lang->line('ccavenue_working_key'); ?><small class="text-danger"> *</small>
                                                                                    </label>
                                                                                    <div class="col-sm-7">
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <label class="col-sm-5 control-label"><?php echo $this->lang->line('access_code'); ?><small class="text-danger"> *</small>
                                                                                    </label>
                                                                                    <div class="col-sm-7">
                                                                            ...
                                                                            <div class="col-md-5 text text-center disblock">
                                                                                <a href="https://www.ccavenue.com" target="_blank">
                                                                                    ...
                                                                                    <img src="<?php echo $this->media_storage->getImageURL('backend/images/ccavenue.png'); ?>" width="200">
                                                                    ...
                                                                    <div class="box-footer">
                                                                        <div class="row">
                                                                            <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                                                                <?php if ($this->rbac->hasPrivilege('payment_methods', 'can_edit')) { ?>
                                                                                    <button type="submit" class="btn btn-primary ccavenue_save my-2" data-loading-text="<i class='fa fa-spinner fa-spin '></i> <?php echo $this->lang->line('save'); ?>"><?php echo $this->lang->line('save'); ?></button>
                                                                                <?php } ?>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <form role="form" id="instamojo" action="<?php echo site_url('admin/paymentsettings/instamojo') ?>" class="form-horizontal" method="post">
                                                                    <div class="box-body minheight149">
                                                                        <div class="row">
                                                                            <div class="col-md-7">
                                                                                ...
                                                                                ?>
                                                                                <div class="form-group">
                                                                                    <label class="col-sm-5 control-label"><?php echo $this->lang->line('private_api_key'); ?><small class="text-danger"> *</small>
                                                                                    </label>
                                                                                    <div class="col-sm-7">
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <label class="col-sm-5 control-label"><?php echo $this->lang->line('private_auth_token'); ?><small class="text-danger"> *</small>
                                                                                    </label>
                                                                                    <div class="col-sm-7">
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <label class="col-sm-5 control-label"><?php echo $this->lang->line('private_salt'); ?><small class="text-danger"> *</small>
                                                                                    </label>
                                                                                    <div class="col-sm-7">
                                                                            ...
                                                                            <div class="col-md-5 text text-center disblock">
                                                                                <a href="https://www.instamojo.com/" target="_blank">
                                                                                    ...
                                                                                    <img src="<?php echo $this->media_storage->getImageURL('backend/images/instamojo.png'); ?>" width="200">
                                                                    ...
                                                                    <div class="box-footer">
                                                                        <div class="row">
                                                                            <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                                                                <?php if ($this->rbac->hasPrivilege('payment_methods', 'can_edit')) { ?>
                                                                                    <button type="submit" class="btn btn-primary instamojo_save my-2" data-loading-text="<i class='fa fa-spinner fa-spin '></i> <?php echo $this->lang->line('save'); ?>"><?php echo $this->lang->line('save'); ?></button>
                                                                                <?php } ?>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-md-7">
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <label class="control-label col-md-5 col-sm-12 col-xs-12" for="exampleInputEmail1">
                                                                                        <?php echo $this->lang->line('paystack_secret_key'); ?><small class="text-danger"> *</small>
                                                                                    </label>
                                                                            ...
                                                                            <div class="col-md-5 text text-center disblock">
                                                                                <a href="https://paystack.com/" target="_blank">
                                                                                    ...
                                                                                    <img src="<?php echo $this->media_storage->getImageURL('backend/images/paystack.png'); ?>" width="200">
                                                                    ...
                                                                    <div class="box-body">
                                                                        <div class="row">
                                                                            <div class="col-md-7">
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <label class="control-label col-md-5 col-sm-12 col-xs-12" for="exampleInputEmail1">
                                                                                        <?php echo $this->lang->line('razorpay_key_id'); ?><small class="text-danger"> *</small>
                                                                                    </label>
                                                                                    <div class="col-md-7 col-sm-7 col-xs-12">
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <label class="control-label col-md-5 col-sm-12 col-xs-12" for="exampleInputEmail1">
                                                                                        <?php echo $this->lang->line('razorpay_key_secret'); ?><small class="text-danger"> *</small>
                                                                                    </label>
                                                                                    <div class="col-md-7 col-sm-7 col-xs-12">
                                                                            ...
                                                                            <div class="col-md-5 text text-center disblock">
                                                                                <a href="https://razorpay.com/" target="_blank">
                                                                                    <h5><?php echo $this->lang->line('payment_gateway_for_india'); ?></h5>
                                                                                    <img src="<?php echo base_url(); ?>/backend/images/razorpay.jpg<?php echo img_time(); ?>" width="200">
                                                                ...
                                                                <form role="form" id="paytm" action="<?php echo site_url('admin/paymentsettings/paytm') ?>" class="form-horizontal" method="post">
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-5 text text-center disblock">
                                                                                <a href="https://paytm.com/" target="_blank">
                                                                                    <h5><?php echo $this->lang->line('payment_gateway_for_india'); ?></h5>
                                                                                    <img src="<?php echo base_url(); ?>/backend/images/paytm.jpg<?php echo img_time(); ?>" width="200">
                                                                                    <p>https://paytm.com/</p>
                                                                                </a>
                                                                            </div>
                                                                        </div>
                                                                    ...
                                                                    <div class="box-footer">
                                                                        <div class="row">
                                                                            <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                                                                <?php if ($this->rbac->hasPrivilege('payment_methods', 'can_edit')) { ?>
                                                                                    <button type="submit" class="btn btn-primary paytm_save my-2" data-loading-text="<i class='fa fa-spinner fa-spin '></i> <?php echo $this->lang->line('save'); ?>"><?php echo $this->lang->line('save'); ?></button>
                                                                                <?php } ?>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-5 text text-center disblock">
                                                                                <a href="https://midtrans.com/" target="_blank">
                                                                                    ...
                                                                                    <img src="<?php echo base_url(); ?>/backend/images/midtrans.jpg<?php echo img_time(); ?>" width="200">
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-5 text text-center disblock">
                                                                                <a href="https://www.pesapal.com/" target="_blank">
                                                                                    <h5><?php echo $this->lang->line('payment_gateway_for_afirican_countries'); ?></h5>
                                                                                    <img src="<?php echo base_url(); ?>/backend/images/pesapal.jpg<?php echo img_time(); ?>" width="200">
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-5 text text-center disblock">
                                                                                <a href="https://flutterwave.com/us/" target="_blank">
                                                                                    <h5><?php echo $this->lang->line('multinational_payment_gateway'); ?></h5>
                                                                                    <img src="<?php echo base_url(); ?>/backend/images/flutterwave.png<?php echo img_time(); ?>" width="200">
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-5 text text-center disblock">
                                                                                <a href="https://ipayafrica.com/" target="_blank">
                                                                                    <h5><?php echo $this->lang->line('payment_gateway_for_afirican_countries'); ?></h5>
                                                                                    <img src="<?php echo base_url(); ?>/backend/images/ipayafrica.png<?php echo img_time(); ?>" width="200">
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-5 text text-center disblock">
                                                                                <a href="https://www.jazzcash.com.pk/" target="_blank">
                                                                                    ...
                                                                                    <img src="<?php echo base_url(); ?>/backend/images/jazzcash.jpg<?php echo img_time(); ?>" width="200">
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-5 text text-center disblock">
                                                                                <a href="https://www.billplz.com/" target="_blank">
                                                                                    ...
                                                                                    <img src="<?php echo base_url(); ?>/backend/images/billplz.jpg<?php echo img_time(); ?>" width="200">
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-5 text text-center disblock">
                                                                                <a href="https://www.sslcommerz.com/" target="_blank">
                                                                                    ...
                                                                                    <img src="<?php echo base_url(); ?>/backend/images/sslcommerz.png<?php echo img_time(); ?>" width="200"><br><br>
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-5 text text-center disblock">
                                                                                <a href="https://walkingm.com/" target="_blank">
                                                                                    ...
                                                                                    <img src="<?php echo base_url(); ?>/backend/images/walkingm.png<?php echo img_time(); ?>" width="200"><br><br>
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-5 text text-center disblock">
                                                                                <a href="https://www.mollie.com/" target="_blank">
                                                                                    ...
                                                                                    <img src="<?php echo base_url(); ?>/backend/images/mollie.png<?php echo img_time(); ?>" width="200"><br><br>
                                                                                    <p>https://www.mollie.com/</p>
                                                                                </a>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-5 text text-center disblock">
                                                                                <a href="https://www.cashfree.com/" target="_blank">
                                                                                    ...
                                                                                    <img src="<?php echo base_url(); ?>/backend/images/cashfree.png<?php echo img_time(); ?>" width="200"><br><br>
                                                                                    <p>https://www.cashfree.com/</p>
                                                                                </a>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-5 text text-center disblock">
                                                                                <a href="https://www.payfast.co.za/" target="_blank">
                                                                                    ...
                                                                                    <img src="<?php echo base_url(); ?>/backend/images/payfast.png<?php echo img_time(); ?>" width="200"><br><br>
                                                                                    <p>https://www.payfast.co.za/</p>
                                                                                </a>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-5 text text-center disblock">
                                                                                <a href="https://toyyibpay.com/" target="_blank">
                                                                                    ...
                                                                                    <img src="<?php echo base_url(); ?>/backend/images/toyyibpay.png<?php echo img_time(); ?>" width="200"><br><br>
                                                                                    <p>https://toyyibpay.com/</p>
                                                                                </a>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-5 text text-center disblock">
                                                                                <a href="https://www.2checkout.com/" target="_blank">
                                                                                    <h5><?php echo $this->lang->line('payment_gateway_for_malaysia'); ?></h5><br>
                                                                                    <img src="<?php echo base_url(); ?>/backend/images/twocheckout.png<?php echo img_time(); ?>" width="200"><br><br>
                                                                                    <p>https://www.2checkout.com/</p>
                                                                                </a>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-5 text text-center disblock">
                                                                                <a href="https://www.onepay.vn/" target="_blank">
                                                                                    ...
                                                                                    <img src="<?php echo base_url(); ?>/backend/images/onepay.svg" width="200"><br><br>
                                                                                    <p>https://www.onepay.vn</p>
                                                                                </a>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                        ...
                                                        <form role="form" action="<?php echo site_url('admin/paymentsettings/setting') ?>" id="payment_gateway" method="POST">
                                                            <div class="box-body minheight199">
                                                                <div class="form-group"> <!-- Radio group !-->
                                                                    ...
                                                                    <h5 class="control-label"><?php echo $this->lang->line('select_payment_gateway'); ?></h5>
                                                            ...
                                                            <div class="box-footer">
                                                                <?php if ($this->rbac->hasPrivilege('payment_methods', 'can_edit')) { ?>
                                                                    <button type="submit" class="btn btn-primary pull-right payment_gateway_save my-2" data-loading-text="<i class='fa fa-spinner fa-spin '></i> <?php echo $this->lang->line('save'); ?>"><?php echo $this->lang->line('save'); ?></button>
                                                                <?php } ?>
                                                            </div>
                                                        </form>
                                                    </div>
