                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="box box-primary">
                                                                ...
                                                                <div class="row">
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-sm-6 col-md-6">
                                                                                <div class="form-group">
                                                                                    <label><?php echo $this->lang->line('search_type'); ?></label><small class="text-danger"> *</small>
                                                                            ...
                                                                            <div class="col-sm-12">
                                                                                <div class="form-group">
                                                                                    <button type="submit" name="search" value="search_filter" class="btn btn-primary btn-sm checkbox-toggle pull-left my-2"><i class="fa fa-search"></i> <?php echo $this->lang->line('search'); ?></button>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-sm-12">
                                                                                <div class="form-group">
                                                                                    <label><?php echo $this->lang->line('search'); ?></label><small class="text-danger"> *</small>
                                                                            ...
                                                                            <div class="col-sm-12">
                                                                                <div class="form-group">
                                                                                    <button type="submit" name="search" value="search_full" class="btn btn-primary btn-sm checkbox-toggle pull-right my-2"><i class="fa fa-search"></i> <?php echo $this->lang->line('search'); ?></button>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                ...
                                                <div class="my-3" id="exp">
                                                    <div class="box-header ptbnull"></div>
                                                    <div class="box-header ptbnull">
                                                        <h5 class="box-title titlefix"><i class=""></i> <?php echo $this->lang->line('expense_list'); ?></h5>
                                                        <hr>
                                                    </div>
                                                    <div class="card card-bordered h-100 shadow-none  ">
                                                        <div class="card-inner">
