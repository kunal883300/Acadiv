                                            ...
                                            <div class="card card-bordered h-100 shadow-sm">
                                                <div class="card-inner">
                                                    ...
                                                    <div class="box-header with-border">
                                                        <h5 class="box-title">
                                                            <?php echo $this->lang->line('add_content_type'); ?>
                                                        </h5>
                                                        <hr>
                                                    </div><!-- /.box-header -->
                                                    <form id="form1" action="<?php echo site_url('admin/contenttype') ?>"
                                            ...
                                            <div class="card-inner">
                                                ...
                                                <div class="box-header ptbnull">
                                                    <h5 class="box-title titlefix">
                                                        <?php echo $this->lang->line('content_type_list'); ?>
                                                    </h5>
                                                    <hr>
                                                ...
                                                <div class="box-body">
                                                    <div class="mailbox-messages">
                                                        ...
                                                        <div class="table-responsive overflow-visible">
                                                            <table
                                                                class="datatable-init-export nowrap table  expense-list"
                                                                data-export-title="<?php echo $this->lang->line('content_type_list'); ?>">
                                                                <thead>
                                                                    <tr>
                                                                        <th>
                                                                            <?php echo $this->lang->line('name'); ?>
