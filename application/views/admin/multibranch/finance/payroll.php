                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <?php if ($this->session->flashdata('msg')) {?> <div class="alert alert-success">  <?php echo $this->session->flashdata('msg') ?> </div> <?php }?>
                            ...
                            <div class="col-sm-6 col-md-3" >
                                <div class="form-group">
                                    <label><?php echo $this->lang->line('search') . " " . $this->lang->line('type'); ?><small class="text-danger"> *</small></label>
                        ...
                        <div class="box-header ptbnull">
                            <br>
                            <h5 class="box-title titlefix"><i class=""></i> <?php echo $this->lang->line('payroll') . " " . $this->lang->line('report'); ?></h5>
                            <hr>
                        </div>
