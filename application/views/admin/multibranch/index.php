                                ...
                                <div class="col-md-12">
                                    <div class="box box-primary" id="route">
                                        <button type="button" data-bs-toggle="modal" data-bs-target="#addModal"
                                            class="btn btn-primary btn-sm mt10 mb10 pull-right mb-2"><i
                                                class="fa fa-plus"></i> <?php echo $this->lang->line('add_new') ?>
                                        </button>
                                        <div class="box-header ptbnull">
                                            <h5 class="box-title titlefix pt5">
                                                <?php echo $this->lang->line('setting') ?></h5>
                                            <hr>
                                        </div>
                                        <div class="card card-bordered h-100 shadow-none  ">
                                            <div class="card-inner">
                                                <div class="box-body">
                                                    <table class="datatable-init-export nowrap table branch-list"
                                                        data-export-title="<?php echo $this->lang->line('branch_list') ?>">
                                                        <thead>
                                                            <tr>
...
<!-- Modal -->
<div id="addModal" class="modal " role="dialog" data-keyboard="false" data-backdrop="static">
            ...
            <div class="modal-body">
                <form method="POST" class="form_db" action="<?php echo site_url('admin/multibranch/branch/add') ?>">
                    ...
                    <div class="form-group">
                        <label><?php echo $this->lang->line('url'); ?></label><small class="text-danger"> *</small>
                    ...
                    <span class="clearfix">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group displaynone branch_div">
                                <label><?php echo $this->lang->line('branch_name'); ?></label><small
                                    class="text-danger"> *</small>
                                <input type="text" class="form-control branch_name" name="branch_name">
                            </div>
                            <div class="col-md-6 form-group">
                                <label><?php echo $this->lang->line('hostname'); ?></label><small class="text-danger">
                                    *</small>
                                <input type="text" class="form-control host_name" name="host_name">
                            </div>
                            <div class="col-md-6 form-group">
                                <label><?php echo $this->lang->line('database_name'); ?></label><small
                                    class="text-danger"> *</small>
                                <input type="text" class="form-control database" name="database">
                            </div>
                            <div class="col-md-6 form-group">
                                <label><?php echo $this->lang->line('username'); ?></label><small class="text-danger">
                                    *</small>
                                <input type="text" class="form-control username" name="username">
                            </div>
                            <div class="col-md-6 form-group">
                                <label><?php echo $this->lang->line('password'); ?></label><small class="text-danger">
                                    *</small>
                                <input type="password" class="form-control password" name="password">
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                <button type="submit" class="btn btn-primary pull-right"
                                    data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Please wait"><?php echo $this->lang->line('verify_save'); ?>
                                </button>
                            </div>
