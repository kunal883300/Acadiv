                ...
                <div class="col-md-4">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h5 class="box-title"><?php echo $this->lang->line('edit_marks_division'); ?></h5>
                        </div><!-- /.box-header -->
                        <hr>
...
?>
                                ...
                                <input type="hidden" name="id" value="<?php echo set_value('id', $editdivision->id); ?>" >
                                  <div class="form-group">
                                    <label><?php echo $this->lang->line('division_name'); ?><small class="text-danger"> *</small></label>
                                ...
                                <div class="form-group">
                                    <label for="exampleInputEmail1"><?php echo $this->lang->line('percent_from'); ?><small class="text-danger"> *</small></label>
                                ...
                                <div class="form-group">
                                    <label><?php echo $this->lang->line('percent_upto'); ?><small class="text-danger"> *</small></label>
            ...
            <div class="col-md-8">
                ...
                <div class="box box-primary">
                    <div class="box-header ptbnull">
                        <h5 class="box-title titlefix"><?php echo $this->lang->line('division_list'); ?></h5>
                        <hr>
