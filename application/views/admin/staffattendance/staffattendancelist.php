                                ...
                                <div class="col-md-12">
                                    <div class="box box-primary">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input name="date" placeholder="" type="text" class="form-control date-picker" value="<?php echo set_value('date', date($this->customlib->getSchoolDateFormat())); ?>" readonly="readonly" />
                                                            <span class="text-danger"><?php echo form_error('date'); ?></span>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12">
                                                        <div class="form-group my-2">
                                                            <button type="submit" name="search" value="search" class="btn btn-primary btn-sm pull-right checkbox-toggle"><i class="fa fa-search me-1"></i> <?php echo $this->lang->line('search'); ?></button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        ?>
                                            ...
                                            <div class="box-header with-border">
                                                <h5 class="box-title mx-2"><i class="fa fa-users"></i> <?php echo $this->lang->line('staff_list'); ?></h5>
                                                    ...
                                                    <form action="<?php echo site_url('admin/staffattendance/index') ?>" id="save_attendance" method="post">
                                                        ...
                                                        <div class="row">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        ?>
                                                                            <div class="col g-4 align-center flex-wrap ms-1">
                                                                                <div class="custom-control custom-control-sm custom-radio">
                                                                                    <input type="radio" name="attendencetype" class="custom-control-input" value="radio_<?php echo $type['id'] ?>" id="attendencetype<?php echo $type['id'] ?>">
                                                                                    <label class="custom-control-label" for="attendencetype<?php echo $type['id'] ?>">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="pull-right">
                                                                                    ...
                                                                                    <button type="submit" name="search" value="saveattendence" id="saveattendence" class="btn btn-primary btn-sm pull-right checkbox-toggle"><i class="fa fa-save me-1"></i> <?php echo $this->lang->line('save_attendance'); ?> </button>
