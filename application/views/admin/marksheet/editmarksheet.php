                ...
                <div class="col-md-4">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h5 class="box-title"><?php echo $this->lang->line('edit_marksheet'); ?></h5>
                            <hr>
                        </div><!-- /.box-header -->
...
if (isset($error_message)) {
    ...
    ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <input autofocus="" id="date" name="date" placeholder="" type="text" class="form-control date-picker" value="<?php echo set_value('date', $marksheet->date); ?>"/>
...
?>">
                ...
                <div class="box box-primary" id="hroom">
                    <div class="box-header ptbnull">
                        <h5 class="box-title titlefix"><?php echo $this->lang->line('marksheet_list'); ?></h5>
                        <hr>
                    </div><!-- /.box-header -->
                    <div class="box-body">
