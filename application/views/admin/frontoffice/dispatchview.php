	...
	<div class="container-fluid">
       ...
       <div class="card-inner">
                        ...
                        <div class="box-header with-border">
                            <h5 class="box-title"><?php echo $this->lang->line('add_postal_dispatch'); ?></h5>
                            <hr>
                        </div><!-- /.box-header -->
                        ...
                        <form id="form1" action="<?php echo site_url('admin/dispatch') ?>"   method="post" accept-charset="utf-8" enctype="multipart/form-data" >
                            ...
                            <div class="box-footer">
                                <button type="submit" class="btn btn-info pull-right my-2 receive" id="submitbtn"><?php echo $this->lang->line('save'); ?></button>
                            </div>
                        </form>
...
" data-bs-target="#receviedetails" data-bs-toggle="modal" data-original-title="<?php echo $this->lang->line('view')?>">
