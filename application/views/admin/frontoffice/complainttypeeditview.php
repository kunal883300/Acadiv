                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="box box-primary">
                                                <div class="box-header with-border">
                                                    <h5 class="box-title"><?php echo $this->lang->line('edit_complaint_type'); ?></h5>
                                                    <hr>
                                                </div><!-- /.box-header -->
                                                <form id="form1" action="<?php echo site_url('admin/complainttype/editcomplainttype/' . $complaint_type_data['id']) ?>" method="post">
                                                    <div class="box-body">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="pwd"><?php echo $this->lang->line('complaint_type'); ?></label><small class="text-danger"> *</small>
                                    ...
                                    <div class="col-md-<?php
                                        ...
                                        <div class="box box-primary">
                                            <div class="box-header ptbnull">
                                                <h5 class="box-title titlefix"><?php echo $this->lang->line('complaint_type_list'); ?></h5>
                                                <hr>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="mailbox-date ">
                                                                            <?php if ($this->rbac->hasPrivilege('setup_font_office', 'can_edit')) { ?>
                                                                                <a href="<?php echo base_url(); ?>admin/complainttype/editcomplainttype/<?php echo $value['id']; ?>" class="btn btn-icon btn-sm btn-white btn-dim btn-outline-primary p-1" data-toggle="tooltip" title="" data-original-title="<?php echo $this->lang->line('edit') ?>">
                                                                                <em class="ni ni-edit"></em>
                                                                                </a>
                                                                            <?php }
                                                                            if ($this->rbac->hasPrivilege('setup_font_office', 'can_delete')) { ?>
                                                                                <a href="<?php echo base_url(); ?>admin/complainttype/delete/<?php echo $value['id']; ?>" class="btn btn-icon btn-sm btn-white btn-dim btn-outline-danger p-1" data-toggle="tooltip" title="" onclick="return confirm('<?php echo $this->lang->line('delete_confirm') ?>');" data-original-title="<?php echo $this->lang->line('delete') ?>">
