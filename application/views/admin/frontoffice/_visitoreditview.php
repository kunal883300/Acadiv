<div class="row">
	<div class="col-lg-12 col-md-12 col-sm-12">
        ...
        <div class="row mb-2" id="edit_visible_student">
            <div class="col-sm-4">
                <div class="form-group">
                    <label class="form-label"><?php echo $this->lang->line('class'); ?></label><small class="text-danger"> *</small>
            ...
            <div class="col-md-4">
                <div class="form-group">
                    <label class="form-label"><?php echo $this->lang->line('section'); ?></label><small class="text-danger"> *</small>
            ...
            <div class="col-md-4">
                <div class="form-group">
                    <label><?php echo $this->lang->line('student'); ?></label><small class="text-danger"> *</small>
	...
	<div class="row mb-2">
        <div class="col-sm-4">
            <div class="form-group">
                <label for="name" class="form-label"><?php echo $this->lang->line('visitor_name'); ?></label>  <small class="text-danger"> *</small>
    ...
    <div class="row mb-2">
        ...
        <div class="col-sm-4">
            <div class="form-group">
                <label for="pepples" class="form-label"><?php echo $this->lang->line('number_of_person'); ?></label>
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                <input type="text" id="date" class="form-control date-picker" value="<?php echo set_value('date', date($this->customlib->getSchoolDateFormat(), $this->customlib->dateyyyymmddTodateformat($visitor_data['date']))); ?>"  name="date" readonly="">
    ...
    <div class="row mb-2">
        ...
        <div class="col-sm-4">
            <div class="form-group">
                <label for="file" class="form-label"><?php echo $this->lang->line('attach_document'); ?></label>
                <div>
