                    ...
                    <div class="card card-bordered">
                        <div class="card-inner">
                                <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="nk-block-head-content">
                                                    <h4 class="nk-block-title">
                                                        <?php echo $this->lang->line('edit_phone_call_log'); ?>
                                                    </h4>
                                                </div><!-- /.box-header -->
                                                <hr>
                                  ...
                                  <div class="card-inner">
                                                <form id="form1"
                                                    action="<?php echo site_url('admin/generalcall/edit/' . $Call_data['id']) ?>"
                                                    ...
                                                    <div class="box-body">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                value="<?php echo set_value('name', $Call_data['name']); ?>"
                                                                name="name">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                value="<?php echo set_value('contact', $Call_data['contact']); ?>"
                                                                name="contact">
                                                            <span class="text-danger">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input id="date" name="date" placeholder="" type="text"
                                                                ...
                                                                value="<?php echo set_value('date', date($this->customlib->getSchoolDateFormat(), $this->customlib->dateyyyymmddTodateformat($Call_data['date']))); ?>"
                                                                readonly="readonly" />
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="email">
                                                            ...
                                                            <textarea class="form-control" rows="3"
                                                                name="description"><?php echo set_value('description', $Call_data['description']); ?></textarea>
                                                        </div>
                                                        <div class="form-group">
                                                            <div class="form-group">
                                                                <label for="pwd">
                                                                ...
                                                                <input id="follow_up_date" name="follow_up_date"
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                value="<?php echo set_value('call_duration', $Call_data['call_duration']); ?>"
                                                                name="call_duration">
                                                            <span class="text-danger">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="form-control" id="description" name="note"
                                                                rows="3"><?php echo set_value('note', $Call_data['note']); ?></textarea>
                                                            <span class="text-danger">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <?php foreach ($call_type as $key => $value) { ?>
                                                                <label class="radio-inline"><input type="radio" name="call_type"
                                                                        value="<?php echo $key; ?>" <?php if (set_value('call_type', $Call_data['call_type']) == $key) { ?> checked="" <?php } ?>>
                                                                    <?php echo $value; ?>
                                                                </label>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="mailbox-date pull-right white-space-nowrap">
                                                                            ...
                                                                            <?php if ($this->rbac->hasPrivilege('phone_call_log', 'can_delete')) { ?>
                                                                                <a href="<?php echo base_url('admin/generalcall/delete/' . $value['id']) ?>"
                                                                                    class="btn btn-default btn-xs"
                                                                                    data-bs-toggle="tooltip" title=""
