                                                ...
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="box-header ptbnull d-flex justify-content-between align-items-center">
                                                            <h5 class="box-title"><i class="fa fa-database"></i> <?php echo $this->lang->line('backup_history'); ?></h5>
                                            ...
                                            <div class="card-inner">
                                                <div class="box box-primary">
                                                    <div class="box-header with-border">
                                                        <h5 class="box-title"><?php echo $this->lang->line('upload_from_local_directory'); ?></h5>
                                                        <hr>
                                                    </div>
                                                    <form role="form" action="<?php echo site_url('admin/admin/backup') ?>" method="post" enctype="multipart/form-data" id="local_form">
                                                        ...
                                                        <div class="box-footer">
                                                            ...
                                                            <button class="btn btn-primary btn-sm pull-right my-2" type="submit" name="backup" value="upload" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> <?php echo $this->lang->line('please_wait') ?>"><i class="fa fa-upload"></i> <?php echo $this->lang->line('upload'); ?></button>
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
                                            ...
                                            <div class="card-inner">
                                                <div class="box box-primary">
                                                    <div class="row">
                                                        <div class="col">
                                                            <div class="box-header ptbnull d-flex justify-content-between align-items-center">
                                                                <h5 class="box-title"><?php echo $this->lang->line('cron_secret_key') ?></h5>
                                                                <?php if ($this->rbac->hasPrivilege('visitor_book', 'can_add')) { ?>
