...
<div class="content-wrapper mx-3 my-3">
    <section class="content">
        <div class="row">
            <div class="col-md-6">
            <div class="card card-bordered h-90 shadow-lg" >
                ...
                <div class="box box-primary">
                    ...
                    <div class="row">
                        <div class="col">
                           ...
                           <h5 class="box-title"> <?php echo $this->lang->line('event_list'); ?></h5>
                         <?php if ($this->rbac->hasPrivilege('visitor_book', 'can_add')) { ?>
                            <button class="btn btn-primary btn-sm pull-right" onclick="add_event()"><?php echo $this->lang->line('add_event'); ?></button><?php } ?>
                            </div><!-- /.box-header -->
                            <hr>
                        </div>
                    </div>
                    ...
                    <div class="box-body">
                        ...
                        <div class="table-responsive overflow-visible">
                            <table class="datatable-init-export nowrap table  example">
                                <thead>
...
<div id="newevent" class="modal " role="dialog">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="form-group col-md-12">
                            <label><?php echo $this->lang->line('event_for'); ?></label><small class="text-danger"> *</small>&nbsp;&nbsp;&nbsp;
                        ...
                        <div id="sessionlist" class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-12 hide">
                            <label class="displayblock"><?php echo $this->lang->line('pass_out_session'); ?> <small class="text-danger"> *</small></label>
...
?>
                        ...
                        <div id="classlist" class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-12 hide">
                            <label class="displayblock"><?php echo $this->lang->line('select_class'); ?><small class="text-danger"> *</small></label>
...
?>
                        ...
                        <div class="form-group col-md-12">
                            <label><?php echo $this->lang->line('event_title'); ?></label><small class="text-danger"> *</small>
                            <input type="hidden" name="id" id="id">
                            <input class="form-control" id="event_title" name="event_title">
                            <span class="text-danger"><?php echo form_error('title'); ?></span>
                        </div>
                        <div class="form-group col-md-4">
                            <label><?php echo $this->lang->line('event_from_date'); ?></label><small class="text-danger"> *</small>                          
                                <input type="text" autocomplete="off" id="from_date" name="from_date" class="form-control date " >                            
                        </div>
                         <div class="form-group col-md-4">
                            <label><?php echo $this->lang->line('event_to_date'); ?></label><small class="text-danger"> *</small>                          
                                <input type="text" autocomplete="off" id="to_date" name="to_date" class="form-control date-picker">
