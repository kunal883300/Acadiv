        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    <form action="<?php echo site_url('admin/issueitem/add') ?>" id="issueitem" name="employeeform"
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-4 col-sm-4">
                                    <label for="exampleInputEmail1">
                                        <?php echo $this->lang->line('user_type'); ?>
                                    </label><small class="text-danger"> *</small>
                                    <select name="account_type" onchange="getIssueUser(this.value)"
                                        id="input-type-student" class="form-control ac_type">
                                        <option value="">
                                ...
                                <div class="form-group col-md-4 col-sm-4">
                                    <label for="exampleInputEmail1">
                                        <?php echo $this->lang->line('issue_to'); ?>
                                    </label><small class="text-danger"> *</small>
                                ...
                                <div class="form-group col-md-4 col-sm-4">
                                    <label for="exampleInputEmail1">
                                        <?php echo $this->lang->line('issue_by'); ?>
                                    </label><small class="text-danger"> *</small>
                                    <select class="form-control " name="issue_by">
                                        ...
                                        foreach ($staff as $key => $value) {
                                            ...
                                            <option value="<?php echo $value['id']; ?>">
                                                <?php echo $value['name'] . ' (' . $value['employee_id'] . ')'; ?>
                                            </option>
                                            <?php
                                        }
                                        ?>
                                ...
                                <div class="form-group col-md-4 col-sm-4">
                                    ...
                                    <input id="issue_date" name="issue_date" placeholder="" type="text"
                                        class="form-control date-picker" value="<?php echo set_value('issue_date'); ?>"
                                        readonly />
                                    <span class="text-danger">
                                ...
                                <div class="form-group col-md-4 col-sm-4">
                                    ...
                                    <input id="return_date" name="return_date" placeholder="" type="text"
                                        class="form-control date-picker" value="<?php echo set_value('return_date'); ?>"
                                        readonly />
                                    <span class="text-danger">
                                ...
                                <div class="form-group col-md-4 col-sm-4">
                                    ...
                                    <?php echo set_value('note'); ?></textarea>
                                    <span class="text-danger">
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <div id="div_avail">
                                                <span>
                                                    <?php echo $this->lang->line('available_quantity'); ?> :
                                                </span>
                        ...
                        <div class="box-footer">
                            <button type="submit" class="allot-fees btn btn-primary btn-sm pull-right" id="load"
