...
<div class="content-wrapper my-3 mx-3">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h5 class="box-title"><?php echo $this->lang->line('student_list'); ?></h5>
                        <hr>
    ...
    $this->session->unset_userdata('msg');}?>
                            <table class="table datatable-init-export nowrap table  table-hover student-list" data-export-title="<?php echo $this->lang->line('student_list'); ?>">
                                <thead>
                                    <tr>
