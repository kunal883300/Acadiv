...
?>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input id="dob" name="dob" placeholder="" type="text" class="form-control date-picker"  value="<?php echo set_value('dob', $this->customlib->dateformat(($student['dob']))); ?>" readonly="readonly"/>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input id="admission_date" name="admission_date" placeholder="" type="text" class="form-control date-picker"  value="<?php echo set_value('admission_date', $this->customlib->dateformat(($student['admission_date']))); ?>" readonly="readonly" />
...
<?php ?>
                                        ...
                                        <div class="col-md-3 col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <input id="measure_date" name="measure_date" placeholder="" type="text" class="form-control date-picker"  value="<?php if ($student['measurement_date'] != '0000-00-00' && $student['measurement_date'] != "" && $student['measurement_date'] != '1970-01-01') {echo set_value('measure_date', $this->customlib->dateformat($student['measurement_date']));}?>" readonly="readonly"/>
