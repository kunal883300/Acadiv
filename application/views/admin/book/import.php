            ...
            <div class="col-md-12">
                <div class="box box-info" style="padding:5px;">
                    ...
                    <div class="box-body">
                        ...
                        <br/>
                        1. <b><?php echo $this->lang->line('book_instruction_one'); ?></b><br/>
                        2. <b><?php echo $this->lang->line('book_instruction_two'); ?></b><br/>
                        <hr/></div>
                    <div class="box-body table-responsive overflow-visible">
                        <table class="table  table-bordered table-hover" id="sampledata">
                            <thead>
                                <tr>
                                    <?php
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="exampleInputFile"><?php echo $this->lang->line('select_csv_file'); ?></label><small class="text-danger"> *</small>
