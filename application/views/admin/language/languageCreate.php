                        ...
                        <div class="box-body">
                            <div class="row">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="exampleInputEmail1"><?php echo $this->lang->line('language'); ?> <small class="text-danger">  *</small></label>
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="exampleInputEmail1"><?php echo $this->lang->line('language_short_code'); ?> <small class="text-danger"> *</small></label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="exampleInputEmail1"><?php echo $this->lang->line('country_code'); ?> <small class="text-danger"> *</small></label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
