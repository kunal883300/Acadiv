...
if (in_array($language["id"], $selected_lang)) {
            ...
            ?>
                               class="chk custom-control-input" data-rowid="<?php echo $language["id"] ?>" value="checked" <?php if (in_array($language["id"], $selected_lang)) {
                echo "checked='checked'";
            }
            ?> />
                        <label for="student<?php echo $language["id"] ?>" class="custom-control-label"></label>
                    </div>
        <?php }
    }
    ?>
