                    ...
                    <div class="card card-bordered">
                        ...
                        <div class="nk-block nk-block-lg">
                                                ...
                                                <ul class="nav nav-tabs mt-n3">
                                                    <li class="nav-item">
                                                        <a class="nav-link active" data-bs-toggle="tab" href="#tabItem9"><?php echo $this->lang->line('todays_birtday'); ?></a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link" data-bs-toggle="tab" href="#tabItem10"><?php echo $this->lang->line('class'); ?></a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link" data-bs-toggle="tab" href="#tabItem11"><?php echo $this->lang->line('individual'); ?></a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link" data-bs-toggle="tab" href="#tabItem12"><?php echo $this->lang->line('group'); ?></a>
                                                    </li>
                                                </ul>
                                ...
                                <div class="">
                                    <div class="row">
                                        <div class="col-md-8">
                                            ...
                                            <div class="form-group">
                                                <label class="pr20"><?php echo $this->lang->line('send_through'); ?><small class="text-danger"> *</small></label>
