            ...
            <div class="col-md-12">
                <div class="box box-info">
                    ...
                    <div class="box-tools pull-right">
                        ...
                        <h5 class="box-title titlefix"> <?php echo $this->lang->line('email_template_list'); ?></h5>
                        <hr>
...
foreach ($email_template_list as $key => $email_template_list_value) {?>
                                        <tr>
                                            ...
                                            <td class="mailbox-date pull-right no-print">
                                                ...
                                                <a class="btn btn-default btn-xs editemailtemplate" data-id="<?php echo $email_template_list_value['id'] ?>"  data-bs-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>"><i class="fa fa-pencil"></i>
                                                </a>
                                                <?php }if ($this->rbac->hasPrivilege('email_template', 'can_delete')) {?>
                                                <a href="<?php echo base_url(); ?>admin/mailsms/delete_email_template/<?php echo $email_template_list_value['id'] ?>"class="btn btn-default btn-xs"  data-bs-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('<?php echo $this->lang->line('delete_confirm') ?>');"><i class="fa fa-remove"></i>
                                                </a>
                                                <?php }?>
                                            </td>
                                        </tr>
