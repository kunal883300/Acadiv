                        ...
                        <div class="nk-block nk-block-lg">
                                            ...
                                            <div class="card-inner">
                                                <ul class="nav nav-tabs mt-n3">
                                                    <li class="nav-item">
                                                        <a class="nav-link active" data-bs-toggle="tab" href="#tabItem1"><?php echo $this->lang->line('todays_birtday'); ?></a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link" data-bs-toggle="tab" href="#tabItem2"><?php echo $this->lang->line('class'); ?></a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link" data-bs-toggle="tab" href="#tabItem3"><?php echo $this->lang->line('individual'); ?></a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link" data-bs-toggle="tab" href="#tabItem4"><?php echo $this->lang->line('send_email'); ?></a>
                                                    </li>
                                                </ul>
                                                    ...
                                                    <form action="<?php echo site_url('admin/mailsms/send_group') ?>" method="post" id="group_form">
                                                            <div class="row">
                                                                <div class="col-md-8">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label><?php echo $this->lang->line('title'); ?></label><small class="text-danger"> *</small>
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label><?php echo $this->lang->line('message'); ?></label><small class="text-danger"> *</small>
                                                                ...
                                                                <div class="col-md-4">
                                                                    <div class="form-group">
                                                                        <label for="exampleInputEmail1"><?php echo $this->lang->line('message_to'); ?></label><small class="text-danger"> *</small>
                                                        ...
                                                        <div class="">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-4">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label for="inpuFname"><?php echo $this->lang->line('message_to'); ?></label><small class="text-danger"> *</small>
                                                                        <div class="input-group">
                                                                            <div class="input-group-btn bs-dropdown-to-select-group">
                                                                                <button type="button" class="btn btn-default btn-searchsm dropdown-toggle as-is bs-dropdown-to-select" data-bs-toggle="dropdown">
...
$(function() {
    $('input:radio[name="send_type"]').change(function() {
        if ($(this).val() == 'schedule') {
            $('#schedule_div').html('<label for="exam_to"><?php echo $this->lang->line('schedule_date_time'); ?><small class="text-danger"> * </small></label> <div class="input-group datewidth-schedule"><input class="form-control datetime" name="schedule_date_time" type="text" id="schedule_date_time" ><span class="input-group-addon" id="basic-addon2"><i class="fa fa-calendar"></i></span></div>');
        } else {
            $('#schedule_div').html('');
        }
    });
...
$(function() {
    $('input:radio[name="individual_send_type"]').change(function() {
        if ($(this).val() == 'schedule') {
            $('#individual_schedule_div').html('<label for="exam_to"><?php echo $this->lang->line('schedule_date_time'); ?></label><small class="text-danger"> *</small><div class="input-group"><input class="form-control tddm200 datetime" name="schedule_date_time" type="text" id="schedule_date_time" ><span class="input-group-addon" id="basic-addon2"><i class="fa fa-calendar"></i></span></div>');
        } else {
...
$(function() {
    $('input:radio[name="birthday_send_type"]').change(function() {
        if ($(this).val() == 'schedule') {
            $('#birthday_schedule_div').html('<label for="exam_to"><?php echo $this->lang->line('schedule_date_time'); ?></label><small class="text-danger"> *</small><div class="input-group"><input class="form-control tddm200 datetime" name="schedule_date_time" type="text" id="schedule_date_time" ><span class="input-group-addon" id="basic-addon2"><i class="fa fa-calendar"></i></span></div>');
        } else {
...
$(function() {
    $('input:radio[name="class_send_type"]').change(function() {
        if ($(this).val() == 'schedule') {
            $('#class_schedule_div').html('<label for="exam_to"><?php echo $this->lang->line('schedule_date_time'); ?></label><small class="text-danger"> *</small><div class="input-group"><input class="form-control tddm200 datetime" name="schedule_date_time" type="text" id="schedule_date_time" ><span class="input-group-addon" id="basic-addon2"><i class="fa fa-calendar"></i></span></div>');
        } else {
