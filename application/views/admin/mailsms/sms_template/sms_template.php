            ...
            <div class="col-md-12">
                <div class="box box-info">
                    ...
                    <div class="box-tools pull-right">
                        ...
                        <h5 class="box-title titlefix"> <?php echo $this->lang->line('sms_template_list'); ?></h5>
                        <hr>
...
foreach ($sms_template_list as $key => $sms_template_list_value) {?>
                                        <tr>
                                            ...
                                            <?php if ($this->rbac->hasPrivilege('sms_template', 'can_edit')) {?>
                                                <a class="btn btn-default btn-xs editsmstemplate" data-id="<?php echo $sms_template_list_value['id'] ?>"  data-bs-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>"><i class="fa fa-pencil"></i>
                                                </a>
                                            <?php }?>
                                            <?php if ($this->rbac->hasPrivilege('sms_template', 'can_delete')) {?>
                                                <a href="<?php echo base_url(); ?>admin/mailsms/delete_sms_template/<?php echo $sms_template_list_value['id'] ?>"class="btn btn-default btn-xs"  data-bs-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('<?php echo $this->lang->line('delete_confirm') ?>');"><i class="fa fa-remove"></i>
                                                </a>
                                            <?php }?>
                                            </td>
                                        </tr>
