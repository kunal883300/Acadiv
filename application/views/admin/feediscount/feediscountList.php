                ...
                <div class="col-md-4">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h5 class="box-title"><?php echo $this->lang->line('add_fees_discount'); ?></h5>
                            <hr>
                        </div><!-- /.box-header -->
                        ...
                        <form id="form1" action="<?php echo site_url('admin/feediscount') ?>"  id="feediscountform" name="feediscountform" method="post" accept-charset="utf-8">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    <label for="exampleInputEmail1"><?php echo $this->lang->line('discount_code'); ?></label> <small class="text-danger">*</small>
