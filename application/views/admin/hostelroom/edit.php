                                                ...
                                                <div class="card card-bordered h-100 shadow-sm">
                                                    <div class="card-inner">
                                                        <div class="box-header with-border">
                                                            <h5 class="box-title"><?php echo $this->lang->line('edit_hostel_room'); ?></h5>
                                                            <hr>
                                                        </div><!-- /.box-header -->
                                                        <!-- form start -->
                                                        <form action="<?php echo site_url('admin/hostelroom/edit/' . $id) ?>" id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                                                            <div class="box-body">
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="exampleInputEmail1"><?php echo $this->lang->line('room_number_name'); ?></label><small class="text-danger"> *</small>
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="exampleInputEmail1"><?php echo $this->lang->line('hostel'); ?></label><small class="text-danger"> *</small>
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="exampleInputEmail1"><?php echo $this->lang->line('number_of_bed'); ?></label><small class="text-danger"> *</small>
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="exampleInputEmail1"><?php echo $this->lang->line('cost_per_bed'); ?></label><small class="text-danger"> *</small>
                                            ...
                                            <div class="card card-bordered h-100 shadow-sm">
                                                <div class="card-inner">
                                                    <div class="box-header ptbnull">
                                                        <h5 class="box-title titlefix"><?php echo $this->lang->line('hostel_room_list'); ?></h5>
                                                        <hr>
                                                    </div><!-- /.box-header -->
                                                    <div class="box-body">
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td class="mailbox-date  no-print">
                                                                                    <?php if ($this->rbac->hasPrivilege('hostel_rooms', 'can_edit')) { ?>
                                                                                        <a href="<?php echo base_url(); ?>admin/hostelroom/edit/<?php echo $hostelroom['id'] ?>" class="btn btn-icon btn-sm btn-white btn-dim btn-outline-primary p-1" data-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>">

                                                                                            <em class="ni ni-edit"></em>
                                                                                        </a>
                                                                                    <?php }
                                                                                    if ($this->rbac->hasPrivilege('hostel_rooms', 'can_delete')) { ?>
                                                                                        <a href="<?php echo base_url(); ?>admin/hostelroom/delete/<?php echo $hostelroom['id'] ?>" class="btn btn-icon btn-sm btn-white btn-dim btn-outline-danger p-1" " data-toggle=" tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('<?php echo $this->lang->line('delete_confirm') ?>');">
