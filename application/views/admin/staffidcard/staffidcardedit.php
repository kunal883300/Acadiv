                                                ...
                                                <div class="card card-bordered h-100 shadow-none  ">
                                                    <div class="card-inner">
                                                        <div class="box-header with-border">
                                                            <h5 class="box-title"><?php echo $this->lang->line('edit_staff_id_card'); ?></h5>
                                                            <hr>
                                                        </div><!-- /.box-header -->
                                                        <!-- form start -->
                                                            ...
                                                            <div class="box-body">
                                                                ...
                                                                <div class="form-group ">
                                                                    <div class="custom-control custom-switch">
                                                                        <input id="enable_name" name="is_active_staff_name" type="checkbox" class="chk custom-control-input" value="1" <?php echo set_checkbox('is_active_staff_name', '1', (set_value('is_active_staff_name', $editstaffidcard[0]->enable_name) == 1) ? true : false); ?>>
                                                                        <label for="enable_name" class="custom-control-label"><?php echo $this->lang->line('staff_name'); ?></label>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
																	<div class="custom-control custom-switch">
                                                                        <input id="enable_staff_id" name="is_active_staff_id" type="checkbox" class="chk custom-control-input" value="1" <?php echo set_checkbox('is_active_staff_id', '1', (set_value('is_active_staff_id', $editstaffidcard[0]->enable_staff_id) == 1) ? true : false); ?>>
                                                                        <label for="enable_staff_id" class="custom-control-label"><?php echo $this->lang->line('staff_id'); ?></label>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group ">
                                                                    <div class="custom-control custom-switch">
                                                                        <input id="enable_designation" name="is_active_designation" type="checkbox" class="chk custom-control-input" value="1" <?php echo set_checkbox('is_active_designation', '1', (set_value('is_active_designation', $editstaffidcard[0]->enable_designation) == 1) ? true : false); ?>>
                                                                        <label for="enable_designation" class="custom-control-label"><?php echo $this->lang->line('designation'); ?></label>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group ">
                                                                    <div class="custom-control custom-switch">
                                                                        <input id="enable_department" name="is_active_department" type="checkbox" class="chk custom-control-input" value="1" <?php echo set_checkbox('is_active_department', '1', (set_value('is_active_department', $editstaffidcard[0]->enable_staff_department) == 1) ? true : false); ?>>
                                                                        <label for="enable_department" class="custom-control-label"><?php echo $this->lang->line('department'); ?></label>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group ">
                                                                    <div class="custom-control custom-switch">
                                                                        <input id="enable_fathers_name" name="is_active_staff_father_name" type="checkbox" class="chk custom-control-input" value="1" <?php echo set_checkbox('is_active_staff_father_name', '1', (set_value('is_active_staff_father_name', $editstaffidcard[0]->enable_fathers_name) == 1) ? true : false); ?>>
                                                                        <label for="enable_fathers_name" class="custom-control-label"><?php echo $this->lang->line('father_name'); ?></label>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group ">
                                                                    <div class="custom-control custom-switch">
                                                                        <input id="enable_mother_name" name="is_active_staff_mother_name" type="checkbox" class="chk custom-control-input" value="1" <?php echo set_checkbox('is_active_staff_mother_name', '1', (set_value('is_active_staff_mother_name', $editstaffidcard[0]->enable_mothers_name) == 1) ? true : false); ?>>
                                                                        <label for="enable_mother_name" class="custom-control-label"><?php echo $this->lang->line('mother_name'); ?></label>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group ">
                                                                    <div class="custom-control custom-switch">
                                                                        <input id="enable_date_of_joining" name="is_active_date_of_joining" type="checkbox" class="chk custom-control-input" value="1" <?php echo set_checkbox('is_active_date_of_joining', '1', (set_value('is_active_date_of_joining', $editstaffidcard[0]->enable_date_of_joining) == 1) ? true : false); ?>>
                                                                        <label for="enable_date_of_joining" class="custom-control-label"><?php echo $this->lang->line('date_of_joining'); ?></label>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group ">
                                                                    <div class="custom-control custom-switch">
                                                                        <input id="enable_staff_permanent_address" name="is_active_staff_permanent_address" type="checkbox" class="chk custom-control-input" value="1" <?php echo set_checkbox('is_active_staff_permanent_address', '1', (set_value('is_active_staff_permanent_address', $editstaffidcard[0]->enable_permanent_address) == 1) ? true : false); ?>>
                                                                        <label for="enable_staff_permanent_address" class="custom-control-label"><?php echo $this->lang->line('current_address'); ?></label>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group ">
                                                                    <div class="custom-control custom-switch">
                                                                        <input id="enable_staff_phone" name="is_active_staff_phone" type="checkbox" class="chk custom-control-input" value="1" <?php echo set_checkbox('is_active_staff_phone', '1', (set_value('is_active_staff_phone', $editstaffidcard[0]->enable_staff_phone) == 1) ? true : false); ?>>
                                                                        <label for="enable_staff_phone" class="custom-control-label"><?php echo $this->lang->line('phone'); ?></label>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group ">
                                                                    <div class="custom-control custom-switch">
                                                                        <input id="enable_staff_dob" name="is_active_staff_dob" type="checkbox" class="chk custom-control-input" value="1" <?php echo set_checkbox('is_active_staff_dob', '1', (set_value('is_active_staff_dob', $editstaffidcard[0]->enable_staff_dob) == 1) ? true : false); ?>>
                                                                        <label for="enable_staff_dob" class="custom-control-label"><?php echo $this->lang->line('date_of_birth'); ?></label>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group ">
                                                                    <div class="custom-control custom-switch">
                                                                        <input id="enable_vertical_card" name="enable_vertical_card" type="checkbox" class="chk custom-control-input" value="1" <?php echo set_checkbox('enable_vertical_card', '1', (set_value('enable_vertical_card', $editstaffidcard[0]->enable_vertical_card) == 1) ? true : false); ?>>
                                                                        <label for="enable_vertical_card" class="custom-control-label"><?php echo $this->lang->line('design_type'); ?></label>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group ">
                                                                    <div class="custom-control custom-switch">
                                                                        <input id="enable_staff_barcode" name="enable_staff_barcode" type="checkbox" class="chk custom-control-input" value="1" <?php echo set_checkbox('enable_staff_barcode', '1', (set_value('enable_staff_barcode', $editstaffidcard[0]->enable_staff_barcode) == 1) ? true : false); ?>>
