							...
							<div class="row gy-5">
								...
								<div class="col-lg-4">
									<div class="nk-block-head">
										<div class="nk-block-head-content">
											<h5 class="nk-block-title title"><?php echo $this->lang->line('add_session'); ?></h5>
										</div>
									</div><!-- .nk-block-head -->
										   ...
										   <?php echo $this->customlib->getCSRF(); ?>
											<div class="form-group">
												...
												<div class="form-control-wrap">
													<input class="form-control" autofocus="" id="session" name="session" placeholder="" type="text" value="<?php echo set_value('session'); ?>">
