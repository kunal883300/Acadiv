                                ...
                                <section class="content">
                                    <div class="box removeboxmius">
                                        ...
                                        <div class="card card-bordered h-100 shadow-none  ">
                                            <div class="card-inner">
                                                <form class="search_daily_assignment_form"
                                                    action="<?php echo base_url(); ?>homework/assignmentvalidation"
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-2 col-lg-2 col-sm-6">
                                                                <div class="form-group">
                                                                    <label>
                                                                        <?php echo $this->lang->line('class'); ?><small
                                                                            class="text-danger"> *</small>
                                                                    </label>
                                                                    <select autofocus="" id="searchclassid"
                                                                        name="class_id"
                                                            ...
                                                            <div class="col-md-2 col-lg-2 col-sm-6">
                                                                <div class="form-group">
                                                                    <label>
                                                                        <?php echo $this->lang->line('section'); ?><small
                                                                            class="text-danger"> *</small>
                                                                    </label>
                                                                    <select id="secid" name="section_id"
                                                                        class="form-control">
                                                                        <option value="">
                                                                            <?php echo $this->lang->line('select'); ?>
                                                                        </option>
                                                                    ...
                                                                    <span class="text-danger"
                                                                        id="error_section_id"></span>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-3 col-lg-3 col-sm-6">
                                                                <div class="form-group">
                                                                    <label>
                                                                        <?php echo $this->lang->line('subject_group'); ?><small
                                                                            class="text-danger"> *</small>
                                                                    </label>
                                                                    <select id="subject_group_id"
                                                                        name="subject_group_id" class="form-control">
                                                                        <option value="">
                                                                            <?php echo $this->lang->line('select'); ?>
                                                                        </option>
                                                                    </select>
                                                                    <span class="text-danger"
                                                                        id="error_subject_group_id"></span>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-3 col-lg-3 col-sm-6">
                                                                <div class="form-group">
                                                                    <label>
                                                                        <?php echo $this->lang->line('subject'); ?><small
                                                                            class="text-danger"> *</small>
                                                                    </label>
                                                                    <select id="subid" name="subject_id"
                                                                        class="form-control">
                                                                        <option value="">
                                                                            <?php echo $this->lang->line('select'); ?>
                                                                        </option>
                                        ...
                                        <div class="" id="box_display">
                                            ...
                                            <div class="box-header with-border">
                                                <h5 class="box-title"><i class=""> </i>
                                                    <?php echo $this->lang->line('daily_assignment_list'); ?>
                                                </h5>
                                                <hr>
                                            </div>
                                            <hr>
                                            <div class="card card-bordered h-100 shadow-none  ">
                                                <div class="card-inner">
                                                    <div class="box-body table-responsive">
                                                        <table
                                                         class="datatable-init-export nowrap table income-list" daily
                                                            data-export-title="<?php echo $this->lang->line('') . "";
                                                            ...
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th>
                                                                        <?php echo $this->lang->line('evaluated_by'); ?>
                                                                    </th>
                                                                    <th class="noExport">
                                    ...
                                    <div class="modal fade" id="assignmentevaluation" tabindex="-1" role="dialog"
                                            ...
                                            <form id="evaluation_data" method="post">
                                                <div class="modal-content modal-media-content">
                                                    <div class="modal-header modal-media-header">
                                                        ...
                                                        <h4 class="box-title">
                                                            <?php echo $this->lang->line('daily_assignment_evaluation'); ?>
                                                        </h4>
                                                    </div>
                                                    <div class="modal-body ptt10 pb0" id="">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="evaluation_date"
                                                                id="evaluation_date"
                                                                class="form-control date-picker"></textarea>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content modal-media-content">
            <div class="modal-header modal-media-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="box-title">
                    <?php echo $this->lang->line('assignment_detail'); ?>
                </h4>
            </div>
