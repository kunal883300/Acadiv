...
<div class="nk-content">
                                            ...
                                            <div class="box-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3 col-lg-3 col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <select autofocus="" id="searchclassid" name="class_id"
                                                                onchange="getSectionByClass(this.value, 0, 'secid')"
                                                                class="form-control">
                                                                <option value="">
                                                    ...
                                                    <div class="col-md-3 col-lg-3 col-sm-6">
                                                        <div class="form-group">
                                                            <label>
                                                                <?php echo $this->lang->line('subject_group'); ?>
                                                            </label>
                                                ...
                                                <button type="submit" id="search_filter" name="search"
                                                    value="search_filter"
                                                    class="btn btn-primary btn-sm checkbox-toggle pull-right my-3 mx-3"><i
                                ...
                                <div class="my-3">
                                    <div class="nav-tabs-custom theme-shadow">
                                        <div class="box-header with-border">
                                            <?php if ($this->rbac->hasPrivilege('homework', 'can_add')) { ?>
                                                <div class="box-tools pull-right">
                                                    <button onclick="addform()" type="button"
                                                        class="btn btn-sm btn-primary modal_form" data-method_call="add"><i
                                                            class="fa fa-plus"></i>
                                            ...
                                            <?php } ?>
                                            <h5 class="box-title"><i class=""></i>
                                                <?php echo $this->lang->line('homework_list'); ?>
                                            </h5>
                                            <hr>
                                        ...
                                        <ul class="nav nav-tabs">
                                            ...
                                            <li class=" nav-item  "><a class= "nav-link" href="#tab_2" data-bs-toggle="tab"><?php echo $this->lang->line('upcoming_homework'); ?></a></li>
                                            
                                            <li class=" nav-item"><a class= "nav-link" href="#tab_2" data-bs-toggle="tab"><?php echo $this->lang->line('closed_homework'); ?></a></li>
                                                ...
                                                <div class="tab-content">
                                                    <div class="tab-pane active" id="tab_1">
                                                        <div class="box-body table-responsive">
                                                            ...
                                                            <div>
                                                                <table
                                                                    class="table table-striped table-bordered table-hover homework-list"
                                                                    data-export-title="<?php echo $this->lang->line('homework_list'); ?>">
                                                                    <thead>
                                                                        <tr>
                                                                            <th>
                                                                                <?php echo $this->lang->line('class') ?>
                                                                            ...
                                                                            <th>
                                                                                <?php echo $this->lang->line('evaluation_date'); ?>
                                                                            </th>
                                                                            <th>
                                                    ...
                                                    <div class="tab-pane " id="tab_3">
                                                        <form action="<?php echo site_url('homework/deletehomework') ?>"
                                                            method="POST" id="deletebulk">
                                                            <div class="">
                                                                <div class="checkbox">
                                                                    <label><input type="checkbox" name="checkAll"> <b>
                                                                            <?php echo $this->lang->line('select_all'); ?>
                                                                        </b> </label>
                                                                    <?php if ($this->rbac->hasPrivilege('homework', 'can_delete')) { ?>
                                                                        <button type="submit" id="delete_btn_id"
                                                                            class="btn btn-primary btn-sm pull-right mb10"
                                                            ...
                                                            <div class="table-responsive overflow-visible-lg">
                                                                ...
                                                                <div>
                                                                    <table
                                                                        class="table table-striped table-bordered table-hover homework-list-close"
                                                                        data-export-title="<?php echo $this->lang->line('homework_list'); ?>">
                                                                        <thead>
                                                                            <tr>
                                                                                <th>#</th>
    ...
    <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content modal-media-content">
                ...
                <h5 class="modal-title box-title"></h5>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control modal_class_id" name="modal_class_id"
                                                id="modal_class_id">
                                                <option value="">
                                                    <?php echo $this->lang->line('select') ?>
                                                </option>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control modal_section_id" name="modal_section_id"
                                                id="modal_section_id">
                                                <option value="">
                                                    <?php echo $this->lang->line('select') ?>
                                                </option>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select id="modal_subject_group_id" name="modal_subject_group_id"
                                                class="form-control">
                                                <option value="">
                                                    <?php echo $this->lang->line('select'); ?>
                                                </option>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <span id="name_add_error" class="text-danger">
                                                <?php echo form_error('modal_subject_id'); ?>
                                            </span>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="homework_date" class="form-control"
                                                id="homework_date"
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="submit_date" name="submit_date" class="form-control"
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="homework_marks" name="homework_marks"
                                                class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
    ...
    <div class="modal fade pr-0" id="evaluation" tabindex="-1" role="dialog" aria-labelledby="evaluation"
            ...
            <div class="modal-content modal-media-content">
                <div class="modal-header modal-media-header">
                    ...
                    <h4 class="modal-title">
                        <?php echo $this->lang->line('evaluate_homework'); ?>
                    </h4>
                </div>
    ...
    <div class="modal fade" id="homework_docs" tabindex="-1" role="dialog" aria-labelledby="evaluation"
        style="padding-left: 0 !important">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content modal-media-content">
                <div class="modal-header modal-media-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title">
                        <?php echo $this->lang->line('homework_assignments'); ?>
                    </h4>
                </div>
                                ...
                                <div class="table-responsive overflow-visible-lg">
                                    <div>
                                        <table class="table table-hover table-striped table-bordered all-list"
                                            data-export-title="<?php echo $this->lang->line('homework_assignments'); ?>">
                                            <thead>
                                                <tr>
