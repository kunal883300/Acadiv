        ...
        <div class="nk-content-inner">
            ...
            <div class="box removeboxmius">
                <div class="box box-primary">
                    ...
                    <button type="submit" id="search_filter" name="search" value="search_filter" class="btn btn-primary btn-sm checkbox-toggle pull-right my-3 mx-3"><i class="fa fa-search"></i> <?php echo $this->lang->line('search'); ?></button>
                </div>
                    </form>
                    <div class="">
                        ...
                        <div class="box-header ptbnull">
                            ...
                            <h5 class="box-title titlefix"><i class=""></i>
                                <?php echo $this->lang->line('homework_report') ?></h5>
                                <hr>
                        </div>
                                    ...
                                    if (empty($resultlist)) {
                                        ...
                                        foreach ($resultlist as $student) {                                           
                                            ...
                                            <tr>
                                                ...
                                                ?></td>                                                
                                                <td>
                                                    <a class="studentlist cursor-pointer" id="load" data-bs-toggle="tooltip"  data-clss-id="<?php echo $student['class_id']; ?>" data-section-id="<?php echo $student['section_id']; ?>" data-homework-id="<?php echo $student['id']; ?>" data-type="student_count" ><?php echo $student['student_count']; ?></a>    
                                                </td>                                                
                                                <td> 
                                                    <a  class="studentlist cursor-pointer" id="load" data-bs-toggle="tooltip"  data-clss-id="<?php echo $student['class_id']; ?>" data-section-id="<?php echo $student['section_id']; ?>" data-homework-id="<?php echo $student['id']; ?>" data-type="homework_submitted" ><?php echo $student['assignments']; ?></a>
                                                </td>                                                
                                                <td>
                                                    <a class="studentlist cursor-pointer text-left displayblock" id="load" data-bs-toggle="tooltip" data-clss-id="<?php echo $student['class_id']; ?>" data-section-id="<?php echo $student['section_id']; ?>" data-homework-id="<?php echo $student['id']; ?>" data-type="pending_student" ><?php echo $student['student_count']-$student['assignments']; ?></a>                                         
                                                </td>                                                   
                                            </tr>
                                            <?php
                                            $count++;
