                            ...
                            <ul multiple="" class="list-group mb0" id="slist">
                              <div class="table-responsive">
                                <table class="table table-striped table-bordered">
                                    <thead>
                                        <tr>
                                            <th class="white-space-nowrap"><?php echo $this->lang->line('student_name') ?><small class="text-danger"> *</small></th>
                        ...
                        <div class="row">   
                            <div class="col-md-2 col-sm-2 col-xs-12">  
                                <div class="form-group">
                                    <label class="pt5"><?php echo $this->lang->line('evaluation_date'); ?> <small class="text-danger"> *</small></label>
                                </div>
                            </div> 
