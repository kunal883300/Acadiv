            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    <div class="box-header ptbnull">
                        <h5 class="box-title titlefix"><?php echo $this->lang->line('offline_bank_payments'); ?></h5>
                        <hr>
    ...
    ?>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                            ...
                                            <label for="payment_date_error"><?php echo $this->lang->line('date_of_payment'); ?></label><small class="text-danger"> *</small>
                                            <input id="payment_date" name="payment_date" placeholder="" type="text" class="form-control date-picker"  value="<?php echo set_value('payment_date'); ?>" />
                                      ...
                                      <div class="col-md-6">
                                          <div class="form-group">
                                            <label for="bank_from"><?php echo $this->lang->line('payment_mode'); ?></label><small class="text-danger"> *</small>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <label for="bank_account_transferred"><?php echo $this->lang->line('payment_from'); ?></label><small class="text-danger"> *</small>
                             ...
                             <div class="row">
                                 <div class="col-md-6">
                                      <div class="form-group">
                                            <label for="amount"><?php echo $this->lang->line('amount_paid'); ?> (<?php echo $currency_symbol; ?>) </label><small class="text-danger"> *</small>
