                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                <label for="pwd"><?php echo $this->lang->line('apply_date'); ?></label><small class="text-danger"> *</small>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="pwd"><?php echo $this->lang->line('from_date'); ?></label><small class="text-danger"> *</small>
                                <input type="text" name="from_date" id="from_date" class="form-control date-picker">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="pwd"><?php echo $this->lang->line('to_date'); ?></label><small class="text-danger"> *</small>
