                            ...
                            <div id='timeline_hide_show' class="row">
                                ...
                                <div class=" col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="timeline_date" value="<?php echo set_value('timeline_date', date($this->customlib->getSchoolDateFormat())); ?>" name="timeline_date" placeholder="" type="text" class="form-control date-picker" />
