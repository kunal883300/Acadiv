                        ...
                        <div class="row">
                            <div class="col-lg-3 col-md-3 col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input id="dob" name="dob" placeholder="" type="text" class="form-control date-picker" value="<?php echo date($this->customlib->getSchoolDateFormat(), $this->customlib->dateyyyymmddTodateformat(date('Y-m-d'))); ?>" />
                                </div>
                            </div>
                        </div>
