                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                <label for="pwd"><?php echo $this->lang->line('rating') ?><small class="text-danger"> *</small></label>
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                <label for="pwd"><?php echo $this->lang->line('comment'); ?><small class="text-danger"> *</small></label>
