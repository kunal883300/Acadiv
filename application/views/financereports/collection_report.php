                        ...
                        <div class="card-inner">
                            ...
                            <div class="col-sm-2 col-lg-2 col-md-2">
                                <div class="form-group">
                                    <label><?php echo $this->lang->line('search_duration'); ?><small class="text-danger"> *</small></label>
...
if ((isset($group_byid)) && ($group_byid == $key)) {
    ...
    ?> ><?php echo $value ?></option>
                            ...
                            <div class="form-group">
                                <div class="col-sm-12">
                                    <button type="submit" name="search" value="search_filter" id="search_btn" class="btn btn-primary btn-sm checkbox-toggle pull-right my-2"><i class="fa fa-search"></i> <?php echo $this->lang->line('search'); ?></button>
                                </div>
                            </div>
                        </div>
                        </div>
