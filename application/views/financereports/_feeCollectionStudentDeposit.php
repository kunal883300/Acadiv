...
foreach ($student_list as $student_key => $student_value) {
	if (isJSON($student_value->amount_detail)) {
		    ...
		    <tr>
                ...
                <?php if($student_value->student_transport_fee_id && $student_value->student_transport_fee_id !=""){?>
                    <td>
                    <button class="btn btn-sm btn-default printInv"
                            ...
                            data-trans_fee_id="<?php echo $student_value->student_transport_fee_id; ?>"
               ...
               <?php }else{?>
                ...
                <button class="btn btn-sm btn-default printInv"
                    data-student_session_id="<?php echo $student_value->student_session_id; ?>"
                    data-fee_master_id="<?php echo $student_value->id ?>"
                    data-fee_session_group_id="<?php echo $student_value->fee_session_group_id ?>"
                    data-fee_groups_feetype_id="<?php echo $student_value->fee_groups_feetype_id ?>"
