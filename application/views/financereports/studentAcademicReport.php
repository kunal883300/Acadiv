                ...
                <div class="box removeboxmius">
                    ...
                    <form action="<?php echo site_url('financereports/studentacademicreport') ?>"  method="post" accept-charset="utf-8">
                            ...
                            <div class="row">
                                      <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1"><?php echo $this->lang->line('locations'); ?></label>
                                                <select autofocus="" id="location_id" name="location_id"
                                                                class="form-control">
                                                                <option value="">
                                                                ...
                                                                foreach ($locationList as $location) {
                                                                    ?>
                                                                    <option value="<?php echo $location['id'] ?>" <?php if (set_value('location_id') == $location['id']) {
                        ...
                        <div class="box-footer">
                            ...
                            <button type="submit" class="btn btn-primary btn-sm pull-right my-2 mx-2"><i class="fa fa-search"></i> <?php echo $this->lang->line('search'); ?></button>   </div>
                    </form>
                </div>
            </div>
                    ...
                    <div class="row">
                        ...
                        if (isset($student_due_fee) && !empty($student_due_fee)) {
                            ...
                            <div class="my-2" id="transfee">
                                <div class="box-header ptbnull">
                                    <h6 class="box-title titlefix"><i class="fa fa-users"></i> <?php echo $this->lang->line('balance_fees_report'); ?></h6>
                                </div>                              
                                    ...
                                    <table class="table table-striped table-hover example" id="headerTable">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text text-left"><?php echo $this->lang->line('locations'); ?></th>
                                            ...
                                            if (!empty($resultarray)) {
                                                ...
                                                foreach ($resultarray as $key => $section) {                                                   
                                                      ...
                                                      <tr>
                                                            ...
                                                            <td><?php echo $students->location_name;?></td>
