                ...
                <div class="box removeboxmius">
                    ...
                    <form action="<?php echo site_url('financereports/reportduefees') ?>"  method="post" accept-charset="utf-8">
                        ...
                        <div class="box-footer">
                            ...
                            <button type="submit" class="btn btn-primary btn-sm pull-right mx-3 my-2"><i class="fa fa-search"></i> <?php echo $this->lang->line('search') ?></button>   </div>
                    </form>
                </div>
            </div>
            <br>                         
                        ...
                        if (isset($student_due_fee)) {
                            ...
                            <div class="" id="transfee">
                                <div class="box-header ptbnull">
                                    <h5 class="box-title titlefix"><i class="fa fa-users"></i> <?php echo $this->lang->line('balance_fees_statement'); ?></h5>
                                </div>   
                                <hr>  
                                <div class="box-body">
                                    <?php
