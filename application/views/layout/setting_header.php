                ...
                <div class="nk-sidebar" data-content="sidebarMenu">
                    <div class="nk-sidebar-inner" data-simplebar>
                        <ul class="nk-menu nk-menu-md">
                            ...
                            <!-- //==================sidebar dynamic======================= -->
                            <?php
                            $side_list_value = getSubmenusByMenuId(27,1);

                            if (!empty($side_list_value)) {
								
                            ?>
								<li class="nk-menu-items">
									<?php
									foreach ($side_list_value as $submenu_key => $submenu_value) {
									...
									?>
											...
											<li class=" <?php echo activate_submenu($submenu_value->activate_controller, explode(',', $submenu_value->activate_methods)); ?> mb-1">
