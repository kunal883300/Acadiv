                                            ...
                                            <div class="col">
                                                <div
                                                    ...
                                                    <h5 class="box-title titlefix">
                                                        <?php echo $this->lang->line('assessment_list'); ?></h5>
                                                    <hr>
                                                    <?php if ($this->rbac->hasPrivilege('visitor_book', 'can_add')) { ?>
                                                        <button type="button" class="btn btn-sm btn-primary"
                                                            data-record_id="0"
                                                            data-original-title="<?php echo $this->lang->line('add_assessment') ?>"
                                                            data-action="add" data-bs-toggle="modal"
                                                ...
                                                <div class="table-responsive mailbox-messages overflow-visible-lg">
                                                    ...
                                                    <table class=" nowrap table  example">
                                                        <thead>
                                                            <tr>
                                                                <th width="10%">
                                                                    <?php echo $this->lang->line('assessment'); ?></th>
                                                                <th width="20%">
                                                                    <?php echo $this->lang->line('assessment_description'); ?>
                                                                </th>
                                                                <th width="65%">
                                                                    <?php echo $this->lang->line('assessment_type'); ?>
                                                                </th>
                                                                <th width="5%">
                                                                        ...
                                                                        <table class="table table-bordered table-hover">
                                                                            <thead>
                                                                                <tr>
                                                                                    ...
                                                                                    <th><?php echo $this->lang->line('maximum_marks'); ?>
                                                                                    </th>
                                                                                    <th><?php echo $this->lang->line('passing_percentage'); ?>
                                                                                    </th>
                                                                            ...
                                                                            <tbody>
                                                                                <?php foreach ($value['data'] as $datakey => $datavalue) { ?>
                                                                                    <tr>
                                                                                        <td><?php echo $datavalue['name']; ?>
                                                                                        </td>
                                                                                        <td><?php echo $datavalue['code']; ?>
                                                                                        </td>
                                                                                        <td><?php echo $datavalue['maximum_marks']; ?>
                                                                                        </td>
                                                                                        <td><?php echo $datavalue['pass_percentage']; ?>
                                                                                        </td>
                                                                                        <td width="50%">
                                                                                            <?php echo $datavalue['description']; ?>
                                                                                        </td>
                                                                                        <td></td>
                                                                                    </tr>
                                                                                <?php } ?>
                                                                    ...
                                                                    <td>
                                                                        <?php if ($this->rbac->hasPrivilege('cbse_exam_assessment', 'can_edit')) { ?>
                                                                            <button type="button"
                                                                                ...
                                                                                data-action="update" data-bs-toggle="modal"
                                                                                data-bs-toggle="#myModal"
                                                                                data-original-title="<?php echo $this->lang->line('edit_assessment'); ?>"
                                                                                title="<?php echo $this->lang->line('edit_assessment'); ?>"
                                                                                autocomplete="off"><i
                                                                                    class="fa fa-pencil"></i></button>
                                                                        <?php } ?>
                                                                        <?php if ($this->rbac->hasPrivilege('cbse_exam_assessment', 'can_delete')) { ?>
                                                                            <a data-id="<?php echo $value['id'] ?>"
                                                                                class="btn btn-default btn-xs deleteassessment"
