    ...
    <div class="col-md-4">
     ...
     <div class="col-md-4">
         <div class="form-group">
                            ...
                            <input autofocus="" id="date" name="date" value="<?php echo set_value('date',$this->customlib->dateformat($result['date'])); ?>" placeholder="" type="text" class="form-control date-picker" />
