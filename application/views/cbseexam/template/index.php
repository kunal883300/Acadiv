                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <div class="box-header ptbnull d-flex justify-content-between align-items-center">
                                                        <h5 class="box-title titlefix"><?php echo $this->lang->line('template_list'); ?></h5>
                                                        <hr>
...
<div id="viewTemplateModal" class="modal modalmark" role="dialog" aria-hidden="true" style="display: none;">
    <div class="modal-dialog modal-xl">
        <!-- Modal content-->
        <div class="modal-content">
            <div class="modal-header">
            <h5 class="modal-title"><?php echo $this->lang->line('template'); ?></h5>
                <button type="button" class="close" data-bs-dismiss="modal" autocomplete="off"><span aria-hidden="true" class="fs-3">&times;</span></button>
...
<div id="editModal" class="modal fade " role="dialog">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
            <h5 class="modal-title"> <?php echo $this->lang->line('edit_template'); ?> </h5>
                <button type="button" class="close" data-bs-dismiss="modal"><span aria-hidden="true" class="fs-3">&times;</span></button>
...
<div id="linkexamModal" class="modal fade" role="dialog">
    <div class="modal-dialog modal-xl">
        ...
        <div class="modal-content">
            <div class="modal-header">
            <h5 class="modal-title"><?php echo $this->lang->line('link_exam'); ?></h5>
                <button type="button" class="close" data-bs-dismiss="modal"><span aria-hidden="true" class="fs-3">&times;</span></button>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <label for="exampleInputEmail1"><?php echo $this->lang->line('marksheet_type') ?></label><small class="text-danger"> *</small>
