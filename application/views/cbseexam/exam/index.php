                                                ...
                                                <div class="col">
                                                    <div class="box-header ptbnull d-flex justify-content-between align-items-center">
                                                        ...
                                                        <?php if ($this->rbac->hasPrivilege('visitor_book', 'can_add')) { ?>
                                                            <button type="button" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#addExamModal" autocomplete="off"><i class="fa fa-plus"></i> <?php echo $this->lang->line('add') ?></button>
                                                        <?php } ?>
                                                    </div><!-- /.box-header -->
                                                    <hr>
                                                </div>
...
<div id="addExamModal" class="modal " role="dialog">
    <div class="modal-dialog modal-dialog2 modal-lg">
        <div class="modal-content">
            ...
            <h5 class="modal-title" id="modal-title"><?php echo $this->lang->line('add_exam'); ?></h5>
                ...
                <form role="form" id="add_exam_form" method="post" enctype="multipart/form-data" action="">
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="exampleInputEmail1"><?php echo $this->lang->line('exam_name'); ?></label> <small class="text-danger"> *</small>
                        ...
                        <div class="row">
                            <div class="col-md-4 col-lg-4 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <label><?php echo $this->lang->line('term'); ?></label><small class="text-danger"> *</small>
                        ...
                        <div class="row">
                            <div class="col-md-4 col-lg-4 col-sm-6">
                                <div class="form-group">
                                    <label><?php echo $this->lang->line('assessment'); ?></label><small class="text-danger"> *</small>
                            ...
                            <div class="col-md-4 col-lg-4 col-sm-6">
                                <div class="form-group">
                                    <label><?php echo $this->lang->line('grade'); ?></label><small class="text-danger"> *</small>
