                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <div class="box-header ptbnull d-flex justify-content-between align-items-center">
                                                        <h5 class="box-title titlefix"><?php echo $this->lang->line("assign_observation_list"); ?></h5>
                                                        <?php if ($this->rbac->hasPrivilege('visitor_book', 'can_add')) { ?>
                                                            <button type="button" class="btn btn-sm btn-primary" data-record_id="0" data-original-title="<?php echo $this->lang->line('add_observation_term') ?>" data-action="add" data-bs-toggle="modal" data-bs-target="#myModal" autocomplete="off"><i class="fa fa-plus"></i> <?php echo $this->lang->line('add') ?></button>
                                                        <?php } ?>
                                                    </div><!-- /.box-header -->
                                                    <hr>
                                                </div>
                                            ...
                                            <div class="card card-bordered h-100 shadow-sm">
                                                <div class="card-inner">
                                                    <div class="table-responsive mailbox-messages overflow-visible-lg">
                                                        ...
                                                        <?php } ?>
                                                        <table class="example nowrap table" data-export-title="<?php echo $this->lang->line('assign_observation_list') ?>">
                                                            <thead>
                                                                <tr>
...
<div id="assignModal" class="modal fade " role="dialog">
    <div class="modal-dialog modal-dialog2 modal-xl">
        <div class="modal-content">
            <div class="modal-header">
            <h5 class="modal-title" id="modal-title"><?php echo $this->lang->line('assign_marks'); ?></h5>
...
<script type="text/javascript">
    ...
    function edit(cbse_observation_parameter_id, class_id) {
        ...
        $.ajax({
            ...
            type: "POST",
            data: {
                cbse_observation_parameter_id: cbse_observation_parameter_id,
                class_id: class_id
            },
            dataType: 'json',
            beforeSend: function() {
        ...
        $('.deleteobservation').click(function() {
            ...
            if (confirm('<?php echo $this->lang->line('delete_confirm'); ?>')) {
                $.ajax({
                    ...
                    type: "POST",
                    data: {
                        observation_parameter_id: observation_parameter_id,
                        class_id: class_id
                    },
                    dataType: 'json',
                    success: function(res) {
