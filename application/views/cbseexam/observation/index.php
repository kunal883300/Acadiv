                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <div class="box-header ptbnull d-flex justify-content-between align-items-center">
                                                    <h5 class="box-title titlefix"><?php echo $this->lang->line('observation_list'); ?></h5>
                                                    <hr>
                                                    <?php if ($this->rbac->hasPrivilege('visitor_book', 'can_add')) { ?>
                                                        <button type="button" class="btn btn-sm btn-primary" data-record_id="0" data-original-title="<?php echo $this->lang->line('add_observation') ?>" data-action="add" data-bs-toggle="modal" data-bs-target="#myModal" autocomplete="off"><i class="fa fa-plus"></i> <?php echo $this->lang->line('add') ?></button>
                                                    <?php } ?>
                                                </div><!-- /.box-header -->
                                                <hr>
                                            </div>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="white-space-nowrap">
                                                                <?php if ($this->rbac->hasPrivilege('cbse_exam_observation', 'can_edit')) { ?>
                                                                    ...
                                                                    <button type="button" data-record_id="<?php echo $value['id']; ?>" class="btn btn-icon btn-sm btn-white btn-dim btn-outline-primary p-1" data-action="update" data-bs-toggle="modal" data-bs-target="#myModal" data-original-title="<?php echo $this->lang->line('edit_observation') ?>" title="<?php echo $this->lang->line('edit_observation') ?>" autocomplete="off">
                                                                    <em class="ni ni-edit"></em> </button>

                                                                <?php }
                                                                if ($this->rbac->hasPrivilege('cbse_exam_observation', 'can_delete')) { ?>

                                                                   <a href="<?php echo site_url('cbseexam/observation/delete/' . $value['id']); ?>" data-id="<?php echo $value['id'] ?>" onclick="return confirm('<?php echo $this->lang->line('are_you_sure_want_to_delete'); ?>');" class="btn btn-icon btn-sm btn-white btn-dim btn-outline-danger p-1" data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>">
                                                                    <em class="ni ni-cross"></em> </a>
    ...
    <div class="modal-dialog modal-dialog2 modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modal-title"><?php echo $this->lang->line('add'); ?></h5>
