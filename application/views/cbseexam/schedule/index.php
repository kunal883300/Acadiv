                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                         ...
                         <div class="col-md-4">
                             <div class="form-group">
                            <label><?php echo $this->lang->line('exam_grade'); ?></label><small class="text-danger"> *</small>
                         <select class="form-control" name="exam" >
                             <option value="" > <?php echo $this->lang->line('select')?> </option>
                             <?php 
                         ...
                         <div class="col-md-4">
                             <div class="form-group">
                            <label><?php echo $this->lang->line('exam_assessments'); ?></label><small class="text-danger"> *</small>
                         <select class="form-control" name="exam" >
                             <option value="" > <?php echo $this->lang->line('select')?> </option>
                             <?php 
                    ...
                    <div class="row">
                        <div class="col-md-4">
                             <div class="form-group">
                            <label><?php echo $this->lang->line('overall_pass_percentage'); ?></label><small class="text-danger"> *</small>
