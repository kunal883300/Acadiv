                                                ...
                                                <div class="col">
                                                    <div
                                                        ...
                                                        <h5 class="box-title titlefix">
                                                            <?php echo $this->lang->line('exam_grade_list'); ?></h5>
                                                        <?php if ($this->rbac->hasPrivilege('visitor_book', 'can_add')) { ?>
                                                            <button type="button" class="btn btn-sm btn-primary"
                                                                data-record_id="0" data-action="add" data-bs-toggle="modal"
                                                                data-originaltitle="<?php echo $this->lang->line('add_grade') ?>"
                                                                data-bs-target="#myModal" autocomplete="off"><i
                                                                    class="fa fa-plus"></i>
                                            ...
                                            <div class="card card-bordered h-100 shadow-sm">
                                                <div class="card-inner">
                                                    <div class="download_label">
                                                        <?php echo $this->lang->line('exam_grade_list'); ?></div>
                                                    <div class="table-responsive mailbox-messages overflow-visible-lg">
                                                        ...
                                                        <table class=" nowrap table example">
                                                            <thead>
                                                                <tr>
                                                                    <th width="10%">
                                                                        <?php echo $this->lang->line('grade_title'); ?>
                                                                    </th>
                                                                    <th width="20%">
                                                                    ...
                                                                    <th width="5%" class="text text-right noExport">
                                                                ...
                                                                foreach ($result as $key => $value) {
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="mailbox-name">
                                                                            <table
                                                                                class="table table-bordered table-hover table-last-right">
                                                                                <thead>
                                                                                    <tr>
                                                                                        <th><?php echo $this->lang->line('grade'); ?>
                                                                                        </th>
                                                                                        <th><?php echo $this->lang->line('maximum_percentage'); ?>
                                                                                        </th>
                                                                                        <th><?php echo $this->lang->line('minimum_percentage'); ?>
                                                                                        </th>
                                                                                        <th><?php echo $this->lang->line('remark'); ?>
                                                                                        </th>
                                                                                    </tr>
                                                                                </thead>
                                                                                <tbody>
                                                                                    ...
                                                                                    foreach ($value['data'] as $datakey => $datavalue) {
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td><?php echo $datavalue['name']; ?>
                                                                                            </td>
                                                                                            <td><?php echo $datavalue['maximum_percentage']; ?>
                                                                                            </td>
                                                                                            <td><?php echo $datavalue['minimum_percentage']; ?>
                                                                                            </td>
                                                                                            <td><?php echo $datavalue['description']; ?>
                                                                                            </td>
                                                                                        </tr>
                                                                                        <?php
                                                                                    }
                                                                        ...
                                                                        <td class="white-space-nowrap">
                                                                            ...
                                                                            <?php if ($this->rbac->hasPrivilege('cbse_exam_grade', 'can_edit')) { ?>
                                                                                <span data-bs-toggle="tooltip">
                                                                                    <button type="button"
                                                                                        data-record_id="<?php echo $value['id']; ?>"
                                                                                        class="btn btn-default btn-xs"
                                                                                        data-action="update"
                                                                                        data-originaltitle="<?php echo $this->lang->line('edit_grade'); ?>"
                                                                                        data-bs-toggle="modal"
                                                                                        data-bs-target="#myModal"
                                                                                        data-original-title="<?php echo $this->lang->line('edit_grade'); ?>"
                                                                                        title="<?php echo $this->lang->line('edit_grade'); ?>"
                                                                                        autocomplete="off"><i
                                                                                            class="fa fa-pencil"></i></button></span>
                                                                            <?php }
                                                                            if ($this->rbac->hasPrivilege('cbse_exam_grade', 'can_delete')) { ?>
                                                                                <a data-id="<?php echo $value['id'] ?>"
                                                                                    class="btn btn-default btn-xs deletegrade"
