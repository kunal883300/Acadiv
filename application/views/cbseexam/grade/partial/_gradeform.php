...
?>
              <div class="form-group">
                        <label><?php echo $this->lang->line('grade_title'); ?></label><small class="text-danger"> *</small>
                    ...
                    <div class="row">
                        <div class="col-md-2">
                            <div>
                                <label for="exampleInputEmail1"><?php echo $this->lang->line('grade'); ?></label> <small class="text-danger"> *</small>
                            </div>
                        </div>
                      
                        <div class="col-md-3">
                            <div>
                                <label for="exampleInputEmail1"><?php echo $this->lang->line('maximum_percentage'); ?></label> <small class="text-danger"> *</small>
                            </div>
                        </div>  
                          <div class="col-md-3">
                            <div>
                                <label for="exampleInputEmail1"><?php echo $this->lang->line('minimum_percentage'); ?></label><small class="text-danger"> *</small>
                            </div>
                        </div>        
                        <div class="col-md-3">
                            <div>
