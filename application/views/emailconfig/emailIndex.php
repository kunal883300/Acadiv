								...
								<div class="row gy-5">
									<div class="col-md-12">
										<div class="box-header with-border">
											<h5 class="box-title"><i class="fa fa-envelope"></i> <?php echo $this->lang->line('email_setting'); ?></h5>
											<hr>
										</div>
										<form id="form1" action="<?php echo base_url() ?>emailconfig/index" name="employeeform" class="form-horizontal form-label-left" method="post" accept-charset="utf-8">
											...
											<div class="row">
												...
												<div class="is_disabled" id="smtp_box">
											   ...
											   <option value="<?php echo $smtp_auth_key?>" <?php echo set_select('smtp_security', $smtp_auth_key, (set_value('auth_key', $emaillist->smtp_auth) == $smtp_auth_key ) ? TRUE : FALSE ); ?> ><?php echo $smtp_auth_value;?></option>
												...
												<div class="is_disabled_ses" id="ses_box">
											...
											<div class="box-footer">
											   <div class="row">
													...
													if ($this->rbac->hasPrivilege('email_setting', 'can_edit')) {
														...
														<button type="submit" class="btn btn-info btnleftinfo my-2"><?php echo $this->lang->line('save'); ?></button>
														<?php
													}
													?>
												</div>
						...
						<div class="">
							<form id="sendform" action="<?php echo base_url() ?>emailconfig/test_mail"   name="employeeform" class="form-horizontal form-label-left" method="post" accept-charset="utf-8"> 
								<div class="">
									...
									<div class="col-md-12">
										<div class="form-group">
											<label for="pwd"><?php echo $this->lang->line('email'); ?> </label><small class="text-danger"> *</small>  
...
<script type="text/javascript">
    $(document).ready(function () {
		<?php $display = (set_value('email_type', $emaillist->email_type) != "smtp") ? 'hide' : '' ?>
		<?php $display_ses = (set_value('email_type', $emaillist->email_type) != "aws_ses") ? 'hide' : '' ?>
		
		<?php if($display == 'hide'){ ?>
			$('#smtp_box').hide();
		<?php }	?>
		<?php if($display_ses == 'hide'){ ?>
			$('#ses_box').hide();
		<?php }	?>
