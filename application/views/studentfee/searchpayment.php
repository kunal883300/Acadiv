...
<div class="nk-content">
    ...
    <div class="form-group">
        <div class="col-sm-12">
            <label><?php echo $this->lang->line('payment_id'); ?></label>
            <small class="text-danger"> *</small>
            <input autofocus="" id="paymentid" name="paymentid" placeholder="" type="text" class="form-control" value="<?php echo set_value('paymentid'); ?>" style="padding-right: 20px;" />
            <span class="text-danger"><?php echo form_error('paymentid'); ?></span>
        </div>
    </div>
    <div class="form-group align-text-top">
        <div class="col-sm-12">
            <button type="submit" name="search" value="search_filter" class="btn btn-primary btn-sm checkbox-toggle mmius15 smallbtn28" style="margin-left: 20px;"><i class="fa fa-search" style="margin-right: 5px;"></i> <?php echo $this->lang->line('search'); ?></button>
        </div>
    </div>
</form>
