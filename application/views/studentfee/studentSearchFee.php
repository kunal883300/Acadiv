            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h5 class="box-title"> <?php echo $this->lang->line(
                            "select_criteria"
                        ); ?></h5>
                        <hr>
                    </div>
                    <div class="card card-bordered h-100  " >
                        <div class="card-inner">
                    <form class="studentsearchfee" action="<?php echo site_url(
...
<?php echo validation_errors(); ?>
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton" style="max-height: 300px; overflow-y: auto; padding:8px;">
                                                <li>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" <?php if (isset($select_all) && $select_all == "on") { echo "checked"; } ?> id="select_all">
                                                ...
                                                <?php foreach ($feesessiongrouplist as $feecategory) { ?>
                                                    <li class="dropdown-header"><h6><?php echo $feecategory->group_name; ?></h6></li>
                                                    <?php if (!empty($feecategory->feetypes)) {
                                                        foreach ($feecategory->feetypes as $fee_key => $fee_value) {
                                                            if (!empty($fee_value->type)) { ?>
                                                                <li>
                                                                    <div class="form-check">
                                                                        <input class="form-check-input" type="checkbox" value="<?php echo $feecategory->id . "-" . $fee_value->id; ?>" name="feegroup[]" <?php echo set_checkbox("feegroup[]", $feecategory->id . "-" . $fee_value->id); ?>>
    ...
    set_value("class_id") == $class["id"]
) {
    echo "selected=selected";
} ?>><?php echo $class["class"]; ?></option>
                                                        <?php } ?>
                                        </select>
                                        <span class="text-danger"><?php echo form_error(
                                            "class_id"
                                        ); ?></span>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <button type="submit" id="search_filter" class="btn btn-sm btn-primary pull-right my-2"><i class="fa fa-search"></i> <?php echo $this->lang->line(
                                            "search"
                                        ); ?></button>
                                    </div>
                                </div>
                    ...
                    <?php if (isset($student_remain_fees)) { ?>
                        <div class="" id="duefee">
                            ...
                            <div class="box-header ptbnull my-3">
                                <h5 class="box-title titlefix"></i> <?php echo $this->lang->line(
                                    "student_list"
                                ); ?></h5>
                                <hr>
                            </div>
                                ...
                                <table class=" nowrap table example">
                                    <thead>
                                        <tr>
                                            ...
                                            <th width="30%"><?php echo $this->lang->line(
                                                "fees_group"
                                            ); ?></th>
                                        ...
                                        <?php if (
                                            ...
                                            foreach (
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo $this->customlib->getFullName(
                                                        $student["firstname"],
                                                        $student["middlename"],
                                                        $student["lastname"],
                                                    ...
                                                    <td class="text text-right">
                                                        ...
                                                        ) { ?><a href="<?php echo base_url(); ?>studentfee/addfee/<?php echo $student[
    "student_session_id"
]; ?>" class="btn btn-info btn-xs">
                                                            <?php echo $currency_symbol; ?> <?php echo $this->lang->line(
     "add_fees"
 ); ?>
                                                            </a>
                                                <?php } ?>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        var date_format = '<?php echo $result = strtr(
