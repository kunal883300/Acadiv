...
if ((isset($search_type)) && ($search_type == $key)) {
    ...
    ?>><?php echo $search ?></option>
                            ...
                            <div class="col-sm-3 col-md-3" >
                                <div class="form-group">
                                    <label><?php echo $this->lang->line('attendance_type'); ?></label><small class="text-danger"> *</small>
...
?>
                    ...
                    <div class="">
                        ...
                        <div class="box-header ptbnull">
                            <br>
                            <h5 class="box-title titlefix"><i class="fa fa-money"></i> <?php echo $this->lang->line('student_attendance_type_report'); ?> </h5>
                            <hr>
                        </div>
