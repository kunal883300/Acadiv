                    ...
                    <form id='form1' action="<?php echo site_url('attendencereports/daywiseattendancereport') ?>" method="post" accept-charset="utf-8">
                        <div class="box-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <button type="submit" name="search" value="search" class="btn btn-primary btn-sm pull-right mx-3 my-3 checkbox-toggle"><i class="fa fa-search"></i> <?php echo $this->lang->line('search'); ?></button>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="box-header with-border">
                                    <div class="row">
                                        <div class="col-md-12 col-sm-12">
                                            <br>
                                            <h5 class="box-title"><i class=""></i> <?php echo $this->lang->line('student_day_wise_attendance_report'); ?> </h5>
                                            <hr>
                                        </div>
