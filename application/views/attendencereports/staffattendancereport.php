                    ...
                    <form id='form1' action="<?php echo site_url('attendencereports/staffattendancereport') ?>" method="post" accept-charset="utf-8">
                        <div class="box-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1"><?php echo $this->lang->line('month'); ?></label><small class="text-danger"> *</small>
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <button type="submit" name="search" value="search" class="btn btn-primary btn-sm pull-right my-3 mx-3 checkbox-toggle"><i class="fa fa-search"></i> <?php echo $this->lang->line('search'); ?></button>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="box-header with-border">
                                <div class="row">
                                    <div class="col-md-4 col-sm-4">
                                        <h5 class="box-title"><i class="fa fa-users"></i> <?php echo $this->lang->line('staff_attendance_report'); ?></h5>
                                    </div>
                            ...
                            <div class="box-body table-responsive">
                                ...
                                ?>
                                    ...
                                    <div> <?php echo
                                            ...
                                            ?></div>
                                    <table class="table  table-hover  xyz">
                                        <thead>
                                            <tr>
                                                <th>
