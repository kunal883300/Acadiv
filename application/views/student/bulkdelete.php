                        ...
                        <div class="card-inner">
                            <div class="col-md-12">
                                <div class="box box-primary">
                                            ...
                                            <div class="card-inner">
                                                <?php if ($this->session->flashdata('msg')) { ?>
                                                    <div class="alert alert-success">
                                                        ...
                                                        <form role="form"
                                                        action="<?php echo site_url('student/bulkdelete') ?>"
                                                        method="post" class="">
                                                        <div class="row ">
                                    ...
                                    <div class="box-body pt0 my-2">
                                        <div class="row ">
                                            <div class="col-md-12 col-sm-12">
                                                <form class="mt10"
                                                    action="<?php echo site_url('student/ajax_delete') ?>" method="POST"
                                                    id="deletebulk">
                                                    <?php
                                                    if (isset($resultlist)) {
                                                        ?>
                                                        <div class="checkbox bordertop pt15">
                                                            <label><input type="checkbox" name="checkAll">
                                                                <b><?php echo $this->lang->line('select_all'); ?></b>
                                                            </label>
                                                            <?php
                                                            if (!empty($resultlist)) {
                                                                ?>
                                                        ...
                                                        <div class="table-responsive pt15 clearboth">
                                                            <div class="download_label">
                                                                <?php echo $this->lang->line('bulk_delete'); ?></div>
                                                            <table
                                                                    ...
                                                                    if (empty($resultlist)) {
                                                                        ...
                                                                        foreach ($resultlist as $student) {
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                ?></td>
                                                                                <td><?php echo $this->lang->line(strtolower($student['gender'])); ?>
                                                                                </td>
                                                                                <?php if ($sch_setting->category) { ?>
