						...
						<div class="nk-block-head">
							<div class="nk-block-between">
								<div class="nk-block-head-content">
									<h4 class="nk-block-title"><em class="icon ni ni-user-add"></em><span><?php echo $this->lang->line('student'); ?> <?php echo $this->lang->line('admission'); ?> </span></h4>
								</div>
								
								<div class="pull-left">
									<?php if ($this->rbac->hasPrivilege('import_student', 'can_view')) {?>
									<a class="btn btn-sm btn-primary" href="<?php echo site_url('student/import') ?>" autocomplete="off"><em class="icon ni ni-plus-circle"></em><span> <?php echo $this->lang->line('import_student'); ?></span></a>
									<?php } ?>
									
									<a target="_blank" class="btn btn-sm btn-primary" href="<?php echo site_url('student/download_form') ?>" autocomplete="off"><em class="icon ni ni-plus-circle"></em><span> <?php echo $this->lang->line('download_admission_form'); ?></span></a>
										...
										<form id="form1" action="<?php echo site_url('student/create') ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8" enctype="multipart/form-data">
															...
															<div class="form-group">
																...
																<select  id="class_id" name="class_id" class="form-control"  >
																	...
																	<option value="<?php echo $class['id'] ?>"<?php
																		...
																		else if(isset($enquiry_details) && ($enquiry_details['class_id'] == $class['id'])){
																			echo "selected=selected";
																		}
													...
													<div class="row">
														<div class="col-md-3 mb-3">
															<div class="form-group">
																...
																<input id="firstname" name="firstname" placeholder="" type="text" class="form-control"  value="<?php if(isset($enquiry_details['name'])){ echo $enquiry_details['name']; } else { echo set_value('firstname'); } ?>" />
													...
													<div class="row">
														...
														<div class="col-md-3">
															<div class="form-group">
																...
																<input id="mobileno" name="mobileno" placeholder="" type="text" class="form-control"  value="<?php if(isset($enquiry_details['contact'])){ echo set_value('mobileno',$enquiry_details['contact']); } ?>" />
														...
														<div class="col-md-3">
															<div class="form-group">
																...
																<input id="email" name="email" placeholder="" type="text" class="form-control"  value="<?php if(isset($enquiry_details['email'])){ echo set_value('email',$enquiry_details['email']); } ?>" />
													...
													<div class="row">
														...
														<div class="col-md-3  my-3">
															<div class="form-group">
																...
																<input id="admission_date" name="admission_date" placeholder="" type="text" class="form-control date-picker"  value="<?php echo set_value('admission_date', date($this->customlib->getSchoolDateFormat())); ?>"  />
														...
														<?php
															...
															if ($sch_setting->is_blood_group) {
																?>
														<div class="col-md-2 col-xs-12 my-3 ">
															<div class="form-group">
														...
														<?php
															...
															<div class="form-group">
																...
																<select class="form-control" rows="3" placeholder="" name="location">
																	<option value=""><?php echo $this->lang->line('select') ?></option>
																	<?php foreach ($locationsList as $bgkey => $bgvalue) {
																		?>
																	<option value="<?php echo $bgvalue['id'] ?>"><?php echo $bgvalue['locations'] ?></option>
																	<?php }?>
																</select>
													...
													<div class="row">
														...
														<div class="col-md-3 col-xs-12">
															<div class="form-group">
																...
																<?php ?>
																<input type="text" id="measure_date" value="<?php echo set_value('measure_date', date($this->customlib->getSchoolDateFormat())); ?>" name="measure_date" class="form-control date-picker">
												...
												<div class="row gy-2">
													...
													<div class="col-md-4">
														<div class="form-group">
															...
															<select class="form-select js-select2" id="transport_feemaster_id" name="transport_feemaster_id[]" multiple="multiple" >
																<?php
												...
												<div class="around10">
													...
													<div class="row">
														<div class="form-group col-md-12">
															...
															<input type="radio" name="guardian_is" <?php
																echo set_value('guardian_is') == "father" ? "checked" : "checked";
													...
													<div class="row">
														...
														<div class="col-md-6">
															...
															<textarea id="guardian_address" name="guardian_address" placeholder="" class="form-control" rows="2"><?php if(isset($enquiry_details['address'])){ echo set_value('guardian_address',$enquiry_details['address']); } ?></textarea>
											...
											<div id="accordion" class="accordion">
											  <div class="accordion-item">
												  ...
												  <button type="submit" class="btn btn-info pull-right mt-2" id="addloader"><?php echo $this->lang->line('save'); ?></button>
											  </div>
											</div>
										</form>
									</div>
