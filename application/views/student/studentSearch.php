                                ...
                                <div class="col-md-12">
                                    <div class="box box-primary">
                                        ...
                                        <div class="box-body">
                                            ...
                                            <div class="row">
                                                <form role="form"
                                                    action="<?php echo site_url('student/searchvalidation') ?>"
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <div class="form-group">
                                                                        <button type="submit" name="search"
                                                                            value="search_filter"
                                                                            class="btn btn-primary btn-sm pull-right checkbox-toggle my-2"><i
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="row">
                                                                <div class="col-sm-12">
                                                                    <div class="form-group">
                                                                        <label>
                                                                            <?php echo $this->lang->line('search_by_keyword'); ?> <small class="text-danger">(All Students Detail)</small>
                                                                        </label>
                                                                        <input type="text" name="search_text"
                                                                            id="search_text" class="form-control"
                                                                            value="<?php echo set_value('search_text'); ?>"
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <div class="form-group">
                                                                        <button type="submit" name="search"
                                                                            value="search_full"
                                                                            class="btn btn-primary pull-right btn-sm checkbox-toggle my-2"><i
                                                                                class="fa fa-search"></i>
                                                                            <?php echo $this->lang->line('search'); ?>
                                                                        </button>
                                                                    </div>
                                        ...
                                        <div class="nav-tabs-custom border0 navnoshadow my-2">
                                            <div class="box-header ptbnull"></div>
                                            <ul class="nav nav-tabs mt-n3">
                                                <li class="active nav-item"><a class="nav-link active" href="#tab_1"
                                                        data-bs-toggle="tab" aria-expanded="true"><i
                                                            class="fa fa-list"></i> &nbsp
                                                        <?php echo $this->lang->line('list_view'); ?>
                                                    </a></li>
                                                <li class="nav-item"><a class="nav-link" href="#tab_2"
                                                        data-bs-toggle="tab" aria-expanded="false"><i
                                                            class="fa fa-newspaper-o"></i> &nbsp
                                                        <?php echo $this->lang->line('details_view'); ?>
                                                    </a></li>
                                            </ul>
                                            <div class="tab-content">
                                                <div class="tab-pane active table-responsive no-padding overflow-visible-lg"
                                                    id="tab_1">
                                                    <table class=" nowrap table student-list "
                                                        data-export-title="">
                                                        <thead>
                                                            <tr>
                                                                <th>
                                                                ...
                                                                <div class="slide-row">
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-xs-6 col-md-6">
                                                                                <address>
                                                                                    ...
                                                                                    <?php echo $student['admission_no'] ?><br />
                                                                                    <b>
                                                                                        <?php echo $this->lang->line('date_of_birth'); ?>:
                                                                                        ...
                                                                                        <?php echo $this->lang->line(strtolower($student['gender'])) ?><br>
                                                                                </address>
                                                                            </div>
                                                                            <div class="col-xs-6 col-md-6">
                                                                                <b>
                                                                                ...
                                                                                <?php echo $student['samagra_id'] ?><br>
                                                                                <?php if ($sch_setting->guardian_name) { ?>
                                                                                    <b>
                                                                                        <?php echo $this->lang->line('guardian_name'); ?>:&nbsp;
                                                                                    </b>
                                                                                    <?php echo $student['guardian_name'] ?><br>
                                                                                <?php }
                                                                                if ($sch_setting->guardian_name) { ?>
                                                                                    <b>
                                                                                        <?php echo $this->lang->line('guardian_phone'); ?>:
                                                                                    </b> <abbr title="Phone"><i
                                                                                            class="fa fa-phone-square"></i>&nbsp;</abbr>
                                                                    ...
                                                                    <div class="slide-footer">
                                                                        <span class="pull-right buttons">
																			<a href="<?php echo base_url(); ?>student/view/<?php echo $student['id'] ?>" class="btn btn-icon btn-sm btn-white btn-dim btn-outline-info p-1" data-toggle="tooltip" aria-label="View" data-bs-original-title="View">
																				<em class="ni ni-eye"></em>
																			</a>
                                                                            <?php
                                                                            if ($this->rbac->hasPrivilege('student', 'can_edit')) {
                                                                                ?>
																				<a href="<?php echo base_url(); ?>student/edit/<?php echo $student['id'] ?>" class="btn btn-icon btn-sm btn-white btn-dim btn-outline-info p-1" data-toggle="tooltip" aria-label="View" data-bs-original-title="View">
																					<em class="ni ni-eye"></em>
																				</a>
                                                                                <?php
                                                                            }
