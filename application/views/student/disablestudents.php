                                    ...
                                    <div class="col-md-12">
                                        <div class="box box-primary">
                                            ...
                                            <div class="box-body">
                                                    ...
                                                    <div class="col-md-6">
                                                        <form role="form" action="<?php echo site_url('student/disablestudentslist') ?>" method="post" class="">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <div class="form-group">
                                                                        <button type="submit" name="search" value="search_filter" class="btn btn-primary btn-sm pull-center my-2 checkbox-toggle "><i class="fa fa-search"></i> <?php echo $this->lang->line('search'); ?></button>
                                                                    </div>
                                                                </div>
                                                            </div><!--./row-->
                                                            </form>
                                                ...
                                                if (isset($resultlist)) {
                                                ?>
                                                    <div class="nav-tabs-custom border0 my-2">
                                                        <ul class="nav nav-tabs mt-n3">
                                                            <li class="active nav-item"><a class="nav-link"  href="#tab_1" data-bs-toggle="tab" aria-expanded="true"> <?php echo $this->lang->line('list_view'); ?></a></li>
                                                            <li class="active nav-item"><a  class="nav-link" href="#tab_2" data-bs-toggle="tab" aria-expanded="false"><?php echo $this->lang->line('details_view'); ?></a></li>
                                                        </ul>
