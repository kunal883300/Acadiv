						...
						<div class="nk-block-head">
							<div class="nk-block-between">
								<div class="nk-block-head-content">
									<h4 class="nk-block-title"><em class="icon ni ni-user-add"></em><span><?php echo $this->lang->line('edit_student'); ?></span></h4>
								</div>
							</div>
						</div><!-- .nk-block-head -->
						<div class="nk-block">
								...
								<div class="col-md-12">
									<div class="box box-primary">
										<form id="form1" action="<?php echo site_url("student/edit/" . $id) ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8" enctype="multipart/form-data">
											<div class="mb-3">
												<h5><?php echo $this->lang->line('student'); ?> <?php echo $this->lang->line('admission'); ?> </h5>
												<div class="gy-2">
													...
													<div class="row">
														...
														<div class="col-md-3 mb-3">
															<div class="form-group">
																<label for="exampleInputEmail1" class="form-label"><?php echo $this->lang->line('admission_no'); ?></label> <small class="text-danger"> *</small>
														...
														<div class="col-md-3">
															<div class="form-group">
																<label for="exampleInputEmail1" class="form-label"><?php echo $this->lang->line('roll_number'); ?></label>
													...
													<div class="row">
														<div class="col-md-3 mb-3">
															<div class="form-group">
																<label for="exampleInputEmail1" class="form-label"><?php echo $this->lang->line('first_name'); ?></label><small class="text-danger"> *</small>
														...
														<div class="col-md-3">
															<div class="form-group">
																<label for="exampleInputEmail1" class="form-label"><?php echo $this->lang->line('middle_name'); ?></label>
														...
														<div class="col-md-3">
															<div class="form-group">
																<label for="exampleInputEmail1" class="form-label"><?php echo $this->lang->line('last_name'); ?></label>
														...
														<div class="col-md-3">
															<div class="form-group">
																...
																<?php
																	...
																	?>
																<input id="dob" name="dob" placeholder="" type="text" class="form-control date-picker"  value="<?php echo set_value('dob', $dob) ?>" />
													...
													<div class="row">
														...
														<div class="col-md-2">
															<div class="form-group">
																<label for="exampleInputEmail1" class="form-label"><?php echo $this->lang->line('category'); ?></label>
														...
														<div class="col-md-2">
															<div class="form-group">
																<label for="exampleInputEmail1" class="form-label"><?php echo $this->lang->line('religion'); ?></label>
														...
														<div class="col-md-2">
															<div class="form-group">
																<label for="exampleInputEmail1" class="form-label"><?php echo $this->lang->line('caste'); ?></label>
														...
														<div class="col-md-3">
															<div class="form-group">
																<label for="exampleInputEmail1" class="form-label"><?php echo $this->lang->line('mobile_number'); ?></label>
														...
														<div class="col-md-3">
															<div class="form-group">
																<label for="exampleInputEmail1" class="form-label"><?php echo $this->lang->line('email'); ?></label>
													...
													<div class="row">
														...
														<div class="col-md-3">
															<div class="form-group">
																<label for="exampleInputEmail1" class="form-label"><?php echo $this->lang->line('admission_date'); ?></label>
																<input id="admission_date" name="admission_date" placeholder="" type="text" class="form-control date-picker"  value="<?php echo set_value('admission_date', $admission_date) ?>"  />
														...
														<div class="col-md-3 my-3">
															<div class="form-group">
																<label for="exampleInputFile"><?php echo $this->lang->line('student_photo'); ?><br><small class="text-danger">JPG/PNG/JPEG file (File size limit is 1 MB)</small></label>
																<input class="filestyle form-control" type='file' name='file' id="file" size='20' capture="camera" />
															</div>
														...
														<div class="col-md-2 col-xs-12 ">
															<div class="form-group">
																<label for="exampleInputEmail1" class="form-label"><?php echo $this->lang->line('blood_group'); ?></label>
																<?php
																	?>
														...
														<div class="col-md-2 col-xs-12">
															<div class="form-group">
																<label for="exampleInputEmail1" class="form-label"><?php echo $this->lang->line('house') ?></label>
														...
														<?php
															...
															<div class="col-md-2 col-xs-12">
															<div class="form-group">
																<label for="exampleInputEmail1" class="form-label"><?php echo $this->lang->line('locations') ?></label>
																<select class="form-control" rows="3" placeholder="" name="location">
																	<option value=""><?php echo $this->lang->line('select') ?></option>
																	<?php foreach ($locationList as $hkey => $hvalue) {
																	?>
																	<option value="<?php echo $hvalue["id"] ?>" <?php
																	if ($hvalue["id"] == $student["location_id"]) {
																		echo "selected";
																	}
																	?> ><?php echo $hvalue["locations"] ?></option>
																	<?php }?>
																</select>
													...
													<div class="row">
														...
														<div class="col-md-3 col-xs-12">
															<div class="form-group">
																<label for="exampleInputEmail1" class="form-label"><?php echo $this->lang->line('height'); ?></label>
																<?php ?>
														...
														<div class="col-md-3 col-xs-12">
															<div class="form-group">
																<label for="exampleInputEmail1" class="form-label"><?php echo $this->lang->line('weight'); ?></label>
																<?php ?>
														...
														<div class="col-md-3 col-xs-12">
															<div class="form-group">
																<label for="exampleInputEmail1" class="form-label"><?php echo $this->lang->line('measurement_date'); ?></label>
																<?php ?>
																<input id="measure_date" name="measure_date" placeholder="" type="text" class="form-control date-picker"  value="<?php echo set_value('measure_date', $measurement_date); ?>" readonly="readonly"/>
														...
														<div class="col-md-3" style="display:none;">
															<div class="form-group">
																<label for="exampleInputEmail1" class="form-label"><?php echo $this->lang->line('fees_discount'); ?></label>
														...
														<div class="col-md-3">
															<div class="row">
																<div class="col-md-6">
																	<button type="button" class="btn btn-sm mysiblings anchorbtn my-4 "><em class="icon ni ni-plus-round-fill"></em> <?php echo $this->lang->line('add_sibling'); ?></button>
																</div>
																<div class="col-md-6">
    ...
    ?>
                                <div class="tshadow mb25 bozero sibling_div relative">
                                    ...
                                    <div class="box-tools sibbtnposition">
                                        <button type="button" class="btn btn-danger btn-sm remove_sibling"><?php echo $this->lang->line('remove_sibling'); ?>
                                        </button>
                                    </div>
                                    <div class="around10">
                                        <div class="row">
											...
											if (empty($siblings)) {
                                                    ...
                                                    <div class="card">
                                                        <div class="card-body">
                                                            <div class="row">
                                                                <div class="col-md-2">
																	<img width="130" height="130" class="round5" src="<?php
															if (!empty($sibling_value->image)) {
                                                                    ...
                                                                    <!-- <img width="115" height="115" class="round5"
                                                                        src="<?php echo $image ?>" alt="No Image"> -->
                                                                </div>
                                                                <div class="col-md-10">
                                                                    <table class="table mb0 font13">
                                                                        <tbody>
                                                                            <tr>
                                                                                ...
                                                                                <td class="bozero">
																				<h4><?php echo $this->customlib->getFullname($sibling_value->firstname, $sibling_value->middlename, $sibling_value->lastname, $sch_setting->middlename, $sch_setting->lastname) ?>       </h4>                     </td>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <?php } ?>
                                                                                <td><?php echo $sibling_value->admission_no; ?>
                                                                                </td>
                                                                            ...
                                                                            <tr>
                                                                                <?php if ($sch_setting->staff_epf_no) { ?>
                                                                                    ...
                                                                                    <td><?php echo $sibling_value->class; ?></td>
                                                                                <?php } ?>
                                                                            ...
                                                                            <tr>
                                                                                <?php if ($sch_setting->staff_epf_no) { ?>
                                                                                    ...
                                                                                    <td><?php echo $sibling_value->section; ?></td>
                                                                                <?php } ?>
								...
								?>
											...
											<div class="mb-3">
												...
												<div class="row gy-2">
													<div class="col-md-4">
														<div class="form-group">
															<label for="exampleInputEmail1" class="form-label"><?php echo $this->lang->line('route_list'); ?></label>
													...
													<div class="col-md-4">
														<div class="form-group">
															<label for="exampleInputEmail1" class="form-label"><?php echo $this->lang->line('pickup_point'); ?></label>
													...
													<div class="col-md-4">
														<div class="form-group">
															<label for="exampleInputEmail1" class="form-label"><?php echo $this->lang->line('fees_month'); ?></label>

															<!-- "Select All" Button -->
															<button type="button" id="selectAllBtn" class="btn btn-primary btn-sm mb-2">Select All</button>
															<button type="button" id="deselectAllBtn" class="btn btn-secondary btn-sm mb-2">Deselect All</button>

															<select id="transport_feemaster_id" class="form-select js-select2" name="transport_feemaster_id[]" multiple="multiple">
																<?php foreach ($transport_fees as $key => $value) { ?>
																	<option <?php echo set_select('transport_feemaster_id[]', $value['id'], (set_value($value['id'], $value['student_transport_fee_id']) > 0) ? true : false); ?> value="<?php echo $value['id']; ?>"> 
																		<?php echo $this->lang->line(strtolower($value['month'])); ?>
																	</option>
																<?php } ?>
															</select>
											...
											<div class="mb-3">
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															<label for="exampleInputEmail1" class="form-label"><?php echo $this->lang->line('hostel'); ?></label>
													...
													<div class="col-md-6">
														<div class="form-group">
															<label for="exampleInputEmail1" class="form-label"><?php echo $this->lang->line('room_no'); ?></label>
											...
											<div class="mb-3">
												<h5>
													...
													<span class="total_fees_alloted pull-right">
													<?php
														$view_total_fees = 0;
														...
														<div class="table-responsive">
															<table class="table table-bordered">
																<tbody>
																	...
																	<tr>
																		<td colspan="3">
																				<div class="card card-inner card-bordered p-2">
																					<div class="accordion accordion-s3">
																						<div class="panel-heading accordion-item">
																							<h6 class="overflow-hidden">
																								<a href="#" class="accordion-head collapsed" style="display:inline;" data-bs-toggle="collapse" data-bs-target="#collapse_fees_<?php echo $feesessiongroup_value->id ?>"><span class="accordion-icon"></span></a>
																								<input class="fee_group_chk vertical-middle" type="checkbox" name="fee_session_group_id[]" value="<?php echo $feesessiongroup_value->id; ?>" <?php echo set_checkbox('fee_session_group_id[]', $feesessiongroup_value->id, ($feesessiongroup_value->student_fees_master_id > 0) ? true : false); ?>>
																								<span class="font14"><?php echo $feesessiongroup_value->group_name; ?></span></a>
																								<span class="pull-right fee_group_total" data-amount="<?php echo ($total_fees); ?>"><?php echo amountFormat($total_fees); ?></span>
																							</h6>
																						</div>
																						<div id="collapse_fees_<?php echo $feesessiongroup_value->id ?>" class="accordion-body collapse mt-1">
																							<table class="table ">
																								<thead>
																									<tr class="">
																										<th class=""><?php echo $this->lang->line('fees_type'); ?></th>
																										<th class="due_date bmedium font14"><?php echo $this->lang->line('due_date'); ?></th>
																										<th class="tools bmedium font14"><?php echo $this->lang->line('amount'); ?> (<?php echo $currency_symbol; ?>)</th>
																									</tr>
																								</thead>
																								<tbody>
																									<?php
																										foreach ($feesessiongroup_value->feetypes as $fee_type_key => $fee_type_value) {
																													?>
																									<tr class="">
																										<td class=""><?php echo $fee_type_value->type . " (" . $fee_type_value->code . ")" ?></td>
																										<td class="due_date"><i class="fa fa-calendar"></i> <?php
											...
											<?php if (($sch_setting->father_name) || ($sch_setting->father_phone) || ($sch_setting->father_occupation) || ($sch_setting->father_pic) || ($sch_setting->mother_name) || ($sch_setting->mother_phone) || ($sch_setting->mother_occupation) || ($sch_setting->mother_pic) || ($sch_setting->guardian_name) || ($sch_setting->guardian_occupation) || ($sch_setting->guardian_relation) || ($sch_setting->guardian_phone) || ($sch_setting->guardian_email) || ($sch_setting->guardian_pic) || ($sch_setting->guardian_address)) {
												?>
											<div class="mb-3">
												<h5 ><?php echo $this->lang->line('parent_guardian_detail'); ?></h5>
												<div class="around10">
													<div class="row">
														...
														<div class="col-md-3">
															<div class="form-group">
																<label for="exampleInputEmail1" class="form-label"><?php echo $this->lang->line('father_phone'); ?></label>
														...
														<div class="col-md-3">
															<div class="form-group">
																<label for="exampleInputEmail1" class="form-label"><?php echo $this->lang->line('father_occupation'); ?></label>
														...
														<div class="col-md-3">
															<div class="form-group">
																<label for="exampleInputFile" class="form-label"><?php echo $this->lang->line('father_photo'); ?></label>
													...
													<div class="row">
														...
														<div class="col-md-3">
															<div class="form-group">
																<label for="exampleInputEmail1" class="form-label"><?php echo $this->lang->line('mother_phone'); ?></label>
														...
														<div class="col-md-3">
															<div class="form-group">
																<label for="exampleInputEmail1" class="form-label"><?php echo $this->lang->line('mother_occupation'); ?></label>
													...
													<div class="row">
														<div class="form-group col-md-12">
															<label class="form-label"><?php echo $this->lang->line('if_guardian_is'); ?><small class="text-danger"> *</small>&nbsp;&nbsp;&nbsp;</label>
													...
													<div class="row">
														<div class="col-md-6">
															<div class="row">
																...
																<div class="col-md-6">
																	<div class="form-group">
																		<label for="exampleInputEmail1" class="form-label"><?php echo $this->lang->line('guardian_name'); ?></label>
																...
																<div class="col-md-6">
																	<div class="form-group">
																		<label for="exampleInputEmail1" class="form-label"><?php echo $this->lang->line('guardian_relation'); ?></label>
															...
															<div class="row">
																...
																<div class="col-md-6">
																	<div class="form-group">
																		<label for="exampleInputEmail1" class="form-label"><?php echo $this->lang->line('guardian_phone'); ?></label>
																...
																<div class="col-md-6">
																	<div class="form-group">
																		<label for="exampleInputEmail1" class="form-label"><?php echo $this->lang->line('guardian_occupation'); ?></label>
														...
														<div class="col-md-3">
															<div class="form-group">
																<label for="exampleInputEmail1" class="form-label"><?php echo $this->lang->line('guardian_email'); ?></label>
														...
														<div class="col-md-6">
															<label for="exampleInputEmail1" class="form-label"><?php echo $this->lang->line('guardian_address'); ?></label>
											...
											<?php }?>
												<div class="box-body">
													<div class="mb-3">
														<h5 ><?php echo $this->lang->line('student_address_details'); ?></h5>
														<div class="row around10">
															...
															<div class="col-md-6">
																...
																<div class="form-group">
																	<label for="exampleInputEmail1" class="form-label"><?php echo $this->lang->line('current_address'); ?></label>
															...
															<div class="col-md-6">
																...
																<div class="form-group">
																	<label for="exampleInputEmail1" class="form-label"><?php echo $this->lang->line('permanent_address'); ?></label>
													...
													<div class="mb-3">
														<h5><?php echo $this->lang->line('miscellaneous_details'); ?>
														</h5>
														<div class="row around10">
														...
														<div class="row around10">
															...
															<div class="col-md-6">
																<div class="form-group">
																	<label for="exampleInputEmail1" class="form-label"><?php echo $this->lang->line('previous_school_details'); ?></label>
															...
															<div class="col-md-6">
																<div class="form-group">
																	<label for="exampleInputEmail1" class="form-label"><?php echo $this->lang->line('note'); ?></label>
													...
													<button type="submit" class="btn btn-sm btn-info pull-right mt-2" id="addloader"><?php echo $this->lang->line('save'); ?></button>
												</div>
										</form>
									</div>
								</div>
...
<div class="modal fade zoom" id="mySiblingModal" tabindex="-1">
...
<script type="text/javascript">
    ...
    $('#selectAllBtn').click(function() {
        $('#transport_feemaster_id > option').prop('selected', true).trigger('change');
    });

    // Handle "Deselect All" button click
    $('#deselectAllBtn').click(function() {
        $('#transport_feemaster_id > option').prop('selected', false).trigger('change');
    });
});
	$(document).ready(function () {
