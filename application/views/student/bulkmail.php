...
?>
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <button type="submit" name="search" value="search_filter" class="btn btn-primary btn-sm pull-right my-3 mx-3 checkbox-toggle"><i class="fa fa-search"></i> <?php echo $this->lang->line('search'); ?></button>
                                    </div>
                                </div>
                            </form>
                        </div>
    ...
    ?>
                                    <div class="row">
                                        <div class="col-md-12 col-sm-12">
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    <label><?php echo $this->lang->line('message_to'); ?> <small class="text-danger"> *</small></label>
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    <label><?php echo $this->lang->line('notification_type'); ?> <small class="text-danger"> *</small></label>
