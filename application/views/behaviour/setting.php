            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    <div class="box-header ptbnull">
                        <h5 class="box-title titlefix"> <?php echo $this->lang->line('setting'); ?></h5>
                        <hr>
                        ...
                        <form role="form" id="student_guardian_form" method="post" enctype="multipart/form-data">
                            ...
                            <div class="box-footer">
                                ...
                                if ($this->rbac->hasPrivilege('behaviour_records_setting', 'can_edit')) {
                                    ?>
                                    <button type="button" class="btn btn-info pull-left edit_student_guardian my-2" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> <?php echo $this->lang->line('processing'); ?>"> <?php echo $this->lang->line('save'); ?></button>
                                    <?php
                                }
                                ?>
