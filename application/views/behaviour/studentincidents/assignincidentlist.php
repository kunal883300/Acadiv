...
<div class="nk-content">
                                ...
                                <div class="col-md-12">
                                    <div class="box box-primary">
                                        <div class="box-header with-border">
                                            <h5 class="box-title"><?php echo $this->lang->line('select_criteria'); ?>
                                            </h5>
                                            <hr>
                                        </div>
                                        <div class="box-body">
                                            <div class="card card-bordered h-100 shadow-none  ">
                                                <div class="card-inner">
                                                    <form data-bs-target="<?php echo site_url('behaviour/studentincidents/search') ?>" method="post" class="class_search_form">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-sm-12">
                                                                        <div class="form-group">
                                                                            <button type="submit" class="btn btn-primary btn-sm pull-right my-2" name="class_search" data-loading-text="<?php echo $this->lang->line('please_wait'); ?>" value=""><i class="fa fa-search"></i>
                                        ...
                                        <div class="my-3">
                                            ...
                                            <div class="box-header ptbnull">
                                                <h5 class="box-title titlefix">
                                                    <?php echo $this->lang->line('assign_incident_list'); ?></h5>
                                                <hr>
                                                            ...
                                                            <table class="table table-striped table-bordered table-hover assign-incident-list" data-export-title="<?php echo $this->lang->line('assign_incident_list'); ?>">
                                                                <thead>
                                                                    <tr>
                                                                        ...
                                                                        <th class="text-right">
                                                                            <?php echo $this->lang->line('total_points'); ?>
                                                                        </th>
                                                                        <th class="text-right noExport">
                                                                            <?php echo $this->lang->line('data-bs-target'); ?>
                                                                        </th>
                                                                    </tr>
                                                                </thead>
                                                                <tbody>
    ...
    <div class="modal fade" id="assignstudentmodel" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static">
                                                ...
                                                <?php foreach ($incidentlist as $value) { ?>
                                                    <div class="behaviour-item">
                                                        <div class="d-flex justify-content-between">
                                                            <h5 class="timeline-header bolds mt0 mb0">
                                                                <?php echo $value['title']; ?> </h5>
                                                            <div class="point-md"><span class="bmedium"><?php echo $this->lang->line('point'); ?>:
                                                                    <?php echo $value['point']; ?></span><input type="checkBox" name="incident_id[]" value="<?php echo $value['id']; ?>">
                                                            </div>
                                                        </div>
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="modal-title"><?php echo $this->lang->line('view_assigned_incidents'); ?>
                    </h4>
        ...
        (function($) {
            ...
            $(document).ready(function() {
                $(document).on('submit', '.class_search_form', function(e) {
                    ...
                    var form = $(this);
                    var url = form.attr('data-bs-target');
            ...
            $(document).on("click", ".viewassignedincidents", function() {
                $('#viewassignedincidents').modal('show');
                var student_id = $(this).attr('data-student-id');
                $('#student_id').val(student_id);
