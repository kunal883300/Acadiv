                                    ...
                                    <div class="box removeboxmius">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-sm-12">
                                                                        <div class="form-group">
                                                                            <button type="submit" class="btn btn-primary btn-sm pull-right my-2" name="class_search" data-loading-text="<?php echo $this->lang->line('please_wait'); ?>" value=""><i class="fa fa-search"></i> <?php echo $this->lang->line('search'); ?></button>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                        ...
                                        <div class="">
                                            ...
                                            <div class="box-header ptbnull my-3">
                                                <h5 class="box-title titlefix"> <?php echo $this->lang->line('student_incident_list'); ?></h5>
                                                <hr>
