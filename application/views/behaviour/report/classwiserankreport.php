...
<div class="nk-content">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box removeboxmius my-3">
                    
                    <div class="box-header with-border">
                        <h5 class="box-title"><i class="fa fa-search"></i> <?php echo $this->lang->line('class_wise_rank_report'); ?></h5>
                        <hr>
                    </div>
                    <div class="box-body">
    ...
    <div class="modal-dialog modal-dialogfullwidth" role="document">
        <div class="modal-content modal-media-content mt35">
            <div class="modal-header modal-media-header d-flex justify-content-between">
                <div>
                    <h5 class="box-title"><?php echo $this->lang->line('assigned_incident'); ?></h5>
