                                ...
                                <div class="col-md-12">
                                    <div class="box removeboxmius">
                                        ...
                                        <div class="box-header with-border my-3 ">
                                            <h5 class="box-title"><i class="fa fa-search"></i>
                                        ...
                                        <div class="box-body">
                                            <div class="card card-bordered h-90 ">
                                                <div class="card-inner">
                                                    <form
                                                        action="<?php echo site_url('behaviour/report/studentranksearch') ?>"
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <select name="session_id"
                                                                                ...
                                                                                <option value="current_session">
                                                                                    <?php echo $this->lang->line('current_session_points'); ?>
                                                                                </option>
                                                                                <option value="overall">
                                                                                    <?php echo $this->lang->line('all_session_points'); ?>
                                                                                </option>
                                                                            </select>
                                                                            <span class="text-danger">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <select name="type" id="type"
                                                                                ...
                                                                                <option value="lessthanequal">
                                                                                    <?php echo $this->lang->line('lesser_than_or_equal'); ?>
                                                                                </option>
                                                                                <option value="greaterthanequal">
                                                                                    <?php echo $this->lang->line('greater_than_or_equal'); ?>
                                                                                </option>
                                                                            </select>
                                                                            <span class="text-danger">
                                        ...
                                        <div class="">
                                            ...
                                            <div class="box-header ptbnull my-3">
                                                <h5 class="box-title titlefix"><i class="fa fa-users"></i>
                                                    <?php echo $this->lang->line('student_behaviour_rank_list'); ?>
                                                </h5>
                                                <hr>
                                            ...
                                            <div class="box-body">
                                                <div class="table-responsive">
                                                    ...
                                                    <table
                                                        class="table table-striped table-bordered table-hover student-assign-list"
                                                        data-export-title="<?php echo $this->lang->line('student_behaviour_rank_list'); ?>">
                                                        <thead>
                                                            <tr>
                                                                <th>
    ...
    <div class="modal-dialog modal-dialogfullwidth" role="document">
        <div class="modal-content modal-media-content mt35">
            <div class="modal-header modal-media-header">
                <h4 class="box-title">
                    <?php echo $this->lang->line('assigned_incident'); ?>
                </h4>
            ...
            <div class="scroll-area">
                <div class="modal-body pt0 pb0 relative">
                    <div class="box-body table-responsive">
                        <table
                            class="table table-striped table-bordered table-hover student-point-list incident-list-table"
                            data-export-title="<?php echo $this->lang->line('assigned_incident'); ?>">
                            <thead>
                                <tr>
                                    <th>
                                    ...
                                    <th>
                                        <?php echo $this->lang->line('assign_by') ?>
                                    </th>
                                </tr>
                            </thead>
                            <tbody>
