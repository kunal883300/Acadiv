    ...
    public function sendSMS($send_to, $detail, $template_id, $template = '')
    {
        ...
        if (!empty($sms_detail)) {
            if ($sms_detail->type == 'clickatell') {
                ...
                // Replace these with your 2Factor.in API credentials
                $apiKey = $sms_detail->password;  // API key from 2Factor.in
                ...
                // Template name
                //$templateName = 'YOUR_TEMPLATE_NAME';  // Replace with your actual template name
                ...
                curl_setopt($ch, CURLOPT_POSTFIELDS, http_build_query(array(
                    ...
                    'from' => $from,
                    'msg' => $msg,
                   // 'templatename' => $templateName,  // Include the template name
                )));
                ...
                if (curl_errno($ch)) {
                    ...
                    if (isset($responseData['Status']) && $responseData['Status'] == 'Success') {
                        ...
                        if (isset($responseData['Details'])) {
                            echo 'Error: ' . $responseData['Details'];
                        }
                        return false;
                    }
                }
