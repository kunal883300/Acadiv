...
class Dispatch_model extends MY_Model
{
    ...
    public function image_delete($id, $img_name)
    {
        ...
        $this->session->set_flashdata('msg', '<div class="alert alert-success">' . $this->lang->line('delete_message') . '<button class="close" data-bs-dismiss="alert"></button></div>');
    ...
    public function delete($id)
    {
        ...
        $controller_name = $this->uri->segment(2);
        $this->session->set_flashdata('msg', '<div class="alert alert-success alert-icon alert-dismissible"><em class="icon nni-check-circle"></em>  ' . $this->lang->line('delete_message') . '<button class="close" data-bs-dismiss="alert"></button></div>');
