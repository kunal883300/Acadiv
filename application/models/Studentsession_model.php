...
class Studentsession_model extends CI_Model
{
    ...
    {
        $this->db->select('students.admission_no,students.roll_no,students.image,student_session.session_id, student_session.class_id, student_session.section_id,student_session.id,student_session.student_id,classes.class,sections.section,
