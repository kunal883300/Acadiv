...
class Batchsubject_model extends CI_Model
{
    ...
    public function getExamSubjects($id = null)
    {
        ...
        $this->db->select('exam_group_class_batch_exam_subjects.*,subjects.name as `subject_name`,subjects.code as `subject_code`')->from('exam_group_class_batch_exam_subjects');
