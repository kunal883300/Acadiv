...
class Setting_model extends MY_Model {
	...
	// Assigning static values to folder_path and base_url
	if(getenv("APP_ENV") == "production"){
		$data['base_url'] = 'https://'.$subdomain.'.acadiv.in/schooldata/'.$subdomain.'/';
		$data['folder_path'] = '/var/www/acadiv-school/schooldata/'.$subdomain.'/';
	}
