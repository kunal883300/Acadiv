...
function side_menu_list_by_id($menu_id,$list = -1)
{

    $CI = &get_instance();
    $CI->load->model('sidebarmenu_model');
    $result = $CI->sidebarmenu_model->getMenuwithSubmenusById($menu_id,$list);
    return $result;

}

function getSubmenusByMenuId($menu_id,$list = -1)
{

    $CI = &get_instance();
    $CI->load->model('sidebarmenu_model');
    $result = $CI->sidebarmenu_model->getSubmenusByMenuId($menu_id,$list);
    return $result;
